...
UELocationInformationRetrievalAPI_getLocationInfo(apiClient_t *apiClient, char * ueId , char * supported_features )
{
    ...
    // create the path
    long sizeOfPath = strlen("/{ueId}/registrations/location")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/{ueId}/registrations/location");
    ...
    cJSON *UELocationInformationRetrievalAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    location_info_t *elementToReturn = location_info_parseFromJSON(UELocationInformationRetrievalAPIlocalVarJSON);
    cJSON_Delete(UELocationInformationRetrievalAPIlocalVarJSON);
