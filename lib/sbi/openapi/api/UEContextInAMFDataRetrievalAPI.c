...
//
ue_context_in_amf_data_t*
UEContextInAMFDataRetrievalAPI_getUeCtxInAmfData(apiClient_t *apiClient, char * supi , char * supported_features )
{
    ...
    // create the path
    long sizeOfPath = strlen("/{supi}/ue-context-in-amf-data")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/{supi}/ue-context-in-amf-data");
    ...
    cJSON *UEContextInAMFDataRetrievalAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ue_context_in_amf_data_t *elementToReturn = ue_context_in_amf_data_parseFromJSON(UEContextInAMFDataRetrievalAPIlocalVarJSON);
    cJSON_Delete(UEContextInAMFDataRetrievalAPIlocalVarJSON);
