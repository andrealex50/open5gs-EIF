...
CAGACKDocumentAPI_queryCagAck(apiClient_t *apiClient, char * ueId , char * supported_features )
{
    ...
    cJSON *CAGACKDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    cag_ack_data_t *elementToReturn = cag_ack_data_parseFromJSON(CAGACKDocumentAPIlocalVarJSON);
    cJSON_Delete(CAGACKDocumentAPIlocalVarJSON);
