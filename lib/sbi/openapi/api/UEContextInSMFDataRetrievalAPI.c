...
UEContextInSMFDataRetrievalAPI_getUeCtxInSmfData(apiClient_t *apiClient, char * supi , char * supported_features )
{
    ...
    // create the path
    long sizeOfPath = strlen("/{supi}/ue-context-in-smf-data")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/{supi}/ue-context-in-smf-data");
    ...
    cJSON *UEContextInSMFDataRetrievalAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ue_context_in_smf_data_t *elementToReturn = ue_context_in_smf_data_parseFromJSON(UEContextInSMFDataRetrievalAPIlocalVarJSON);
    cJSON_Delete(UEContextInSMFDataRetrievalAPIlocalVarJSON);
