...
#include <stdio.h>
#include <ctype.h>
#include "ServiceSpecificAuthorizationInfoDocumentAPI.h"
...
ServiceSpecificAuthorizationInfoDocumentAPI_createServiceSpecificAuthorizationInfo(apiClient_t *apiClient, char * ueId , service_type_t * serviceType , service_specific_authorization_info_t * service_specific_authorization_info )
{
    ...
    // create the path
    long sizeOfPath = strlen("/subscription-data/{ueId}/context-data/service-specific-authorizations/{serviceType}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/subscription-data/{ueId}/context-data/service-specific-authorizations/{serviceType}");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_service_specific_authorization_info = NULL;
    if (service_specific_authorization_info != NULL)
    {
        //string
        localVarSingleItemJSON_service_specific_authorization_info = service_specific_authorization_info_convertToJSON(service_specific_authorization_info);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_service_specific_authorization_info);
    }
    ...
    cJSON *ServiceSpecificAuthorizationInfoDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    service_specific_authorization_info_t *elementToReturn = service_specific_authorization_info_parseFromJSON(ServiceSpecificAuthorizationInfoDocumentAPIlocalVarJSON);
    cJSON_Delete(ServiceSpecificAuthorizationInfoDocumentAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_service_specific_authorization_info) {
        cJSON_Delete(localVarSingleItemJSON_service_specific_authorization_info);
        localVarSingleItemJSON_service_specific_authorization_info = NULL;
    }
...
ServiceSpecificAuthorizationInfoDocumentAPI_modifyServiceSpecificAuthorizationInfo(apiClient_t *apiClient, char * ueId , service_type_t * serviceType , list_t * patch_item , char * supported_features )
{
    ...
    //nonprimitive not container
    cJSON *ServiceSpecificAuthorizationInfoDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    patch_result_t *elementToReturn = patch_result_parseFromJSON(ServiceSpecificAuthorizationInfoDocumentAPIlocalVarJSON);
    cJSON_Delete(ServiceSpecificAuthorizationInfoDocumentAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
