...
AMF3GPPAccessRegistrationDocumentAPI_amfContext3gpp(apiClient_t *apiClient, char * ueId , list_t * patch_item , char * supported_features )
{
    ...
    // create the path
    long sizeOfPath = strlen("/subscription-data/{ueId}/context-data/amf-3gpp-access")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/subscription-data/{ueId}/context-data/amf-3gpp-access");
    ...
    cJSON *AMF3GPPAccessRegistrationDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    patch_result_t *elementToReturn = patch_result_parseFromJSON(AMF3GPPAccessRegistrationDocumentAPIlocalVarJSON);
    cJSON_Delete(AMF3GPPAccessRegistrationDocumentAPIlocalVarJSON);
...
AMF3GPPAccessRegistrationDocumentAPI_createAmfContext3gpp(apiClient_t *apiClient, char * ueId , amf3_gpp_access_registration_t * amf3_gpp_access_registration )
{
    ...
    //nonprimitive not container
    cJSON *AMF3GPPAccessRegistrationDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    amf3_gpp_access_registration_t *elementToReturn = amf3_gpp_access_registration_parseFromJSON(AMF3GPPAccessRegistrationDocumentAPIlocalVarJSON);
    cJSON_Delete(AMF3GPPAccessRegistrationDocumentAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
