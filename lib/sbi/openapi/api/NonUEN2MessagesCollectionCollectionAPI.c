...
NonUEN2MessagesCollectionCollectionAPI_nonUeN2MessageTransfer(apiClient_t *apiClient, n2_information_transfer_req_data_t * n2_information_transfer_req_data )
{
    ...
    {
        //string
        localVarSingleItemJSON_n2_information_transfer_req_data = n2_information_transfer_req_data_convertToJSON(n2_information_transfer_req_data);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_n2_information_transfer_req_data);
    }
    ...
    cJSON *NonUEN2MessagesCollectionCollectionAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    n2_information_transfer_rsp_data_t *elementToReturn = n2_information_transfer_rsp_data_parseFromJSON(NonUEN2MessagesCollectionCollectionAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_n2_information_transfer_req_data) {
        cJSON_Delete(localVarSingleItemJSON_n2_information_transfer_req_data);
