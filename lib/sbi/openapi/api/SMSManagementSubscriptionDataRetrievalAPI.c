...
SMSManagementSubscriptionDataRetrievalAPI_getSmsMngtData(apiClient_t *apiClient, char * supi , char * supported_features , plmn_id_t * plmn_id , char * If_None_Match , char * If_Modified_Since )
{
    ...
    // create the path
    long sizeOfPath = strlen("/{supi}/sms-mng-data")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/{supi}/sms-mng-data");
    ...
    cJSON *SMSManagementSubscriptionDataRetrievalAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    sms_management_subscription_data_t *elementToReturn = sms_management_subscription_data_parseFromJSON(SMSManagementSubscriptionDataRetrievalAPIlocalVarJSON);
    cJSON_Delete(SMSManagementSubscriptionDataRetrievalAPIlocalVarJSON);
