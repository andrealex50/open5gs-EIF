...
LCSBroadcastAssistanceSubscriptionDataAPI_queryLcsBcaData(apiClient_t *apiClient, char * ueId , char * servingPlmnId , char * supported_features , char * If_None_Match , char * If_Modified_Since )
{
    ...
    // create the path
    long sizeOfPath = strlen("/subscription-data/{ueId}/{servingPlmnId}/provisioned-data/lcs-bca-data")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/subscription-data/{ueId}/{servingPlmnId}/provisioned-data/lcs-bca-data");
    ...
    cJSON *LCSBroadcastAssistanceSubscriptionDataAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    lcs_broadcast_assistance_types_data_t *elementToReturn = lcs_broadcast_assistance_types_data_parseFromJSON(LCSBroadcastAssistanceSubscriptionDataAPIlocalVarJSON);
    cJSON_Delete(LCSBroadcastAssistanceSubscriptionDataAPIlocalVarJSON);
