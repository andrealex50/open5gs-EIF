...
Modify5GVnGroupAPI_modify5GVnGroup(apiClient_t *apiClient, char * externalGroupId , list_t * patch_item , char * supported_features )
{
    ...
    cJSON *Modify5GVnGroupAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    patch_result_t *elementToReturn = patch_result_parseFromJSON(Modify5GVnGroupAPIlocalVarJSON);
    cJSON_Delete(Modify5GVnGroupAPIlocalVarJSON);
