...
HSSEventSubscriptionInfoDocumentAPI_createHSSSubscriptions(apiClient_t *apiClient, char * ueId , char * subsId , hss_subscription_info_t * hss_subscription_info )
{
    ...
    // create the path
    long sizeOfPath = strlen("/subscription-data/{ueId}/context-data/ee-subscriptions/{subsId}/hss-subscriptions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/subscription-data/{ueId}/context-data/ee-subscriptions/{subsId}/hss-subscriptions");
    ...
    cJSON *HSSEventSubscriptionInfoDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    hss_subscription_info_t *elementToReturn = hss_subscription_info_parseFromJSON(HSSEventSubscriptionInfoDocumentAPIlocalVarJSON);
    cJSON_Delete(HSSEventSubscriptionInfoDocumentAPIlocalVarJSON);
...
HSSEventSubscriptionInfoDocumentAPI_getHssSubscriptionInfo(apiClient_t *apiClient, char * ueId , char * subsId )
{
    ...
    //nonprimitive not container
    cJSON *HSSEventSubscriptionInfoDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    smf_subscription_info_t *elementToReturn = smf_subscription_info_parseFromJSON(HSSEventSubscriptionInfoDocumentAPIlocalVarJSON);
    cJSON_Delete(HSSEventSubscriptionInfoDocumentAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
HSSEventSubscriptionInfoDocumentAPI_modifyHssGroupSubscriptions(apiClient_t *apiClient, char * externalGroupId , char * subsId , list_t * patch_item , char * supported_features )
{
    ...
    //nonprimitive not container
    cJSON *HSSEventSubscriptionInfoDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    patch_result_t *elementToReturn = patch_result_parseFromJSON(HSSEventSubscriptionInfoDocumentAPIlocalVarJSON);
    cJSON_Delete(HSSEventSubscriptionInfoDocumentAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
