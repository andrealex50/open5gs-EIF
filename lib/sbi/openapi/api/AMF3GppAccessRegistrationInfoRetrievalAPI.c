...
AMF3GppAccessRegistrationInfoRetrievalAPI_get3GppRegistration(apiClient_t *apiClient, char * ueId , char * supported_features )
{
    ...
    cJSON *AMF3GppAccessRegistrationInfoRetrievalAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    amf3_gpp_access_registration_t *elementToReturn = amf3_gpp_access_registration_parseFromJSON(AMF3GppAccessRegistrationInfoRetrievalAPIlocalVarJSON);
    cJSON_Delete(AMF3GppAccessRegistrationInfoRetrievalAPIlocalVarJSON);
