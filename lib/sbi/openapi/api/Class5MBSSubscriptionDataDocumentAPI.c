...
#include <stdio.h>
#include <ctype.h>
#include "Class5MBSSubscriptionDataDocumentAPI.h"
...
Class5MBSSubscriptionDataDocumentAPI_query5mbsData(apiClient_t *apiClient, char * ueId , char * supported_features , char * If_None_Match , char * If_Modified_Since )
{
    ...
    // create the path
    long sizeOfPath = strlen("/subscription-data/{ueId}/5mbs-data")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/subscription-data/{ueId}/5mbs-data");
    ...
    cJSON *Class5MBSSubscriptionDataDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    mbs_subscription_data_1_t *elementToReturn = mbs_subscription_data_1_parseFromJSON(Class5MBSSubscriptionDataDocumentAPIlocalVarJSON);
    cJSON_Delete(Class5MBSSubscriptionDataDocumentAPIlocalVarJSON);
