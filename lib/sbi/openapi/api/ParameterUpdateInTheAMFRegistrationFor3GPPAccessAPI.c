...
ParameterUpdateInTheAMFRegistrationFor3GPPAccessAPI_update3GppRegistration(apiClient_t *apiClient, char * ueId , amf3_gpp_access_registration_modification_t * amf3_gpp_access_registration_modification , char * supported_features )
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_amf3_gpp_access_registration_modification = NULL;
    if (amf3_gpp_access_registration_modification != NULL)
    {
        //string
        localVarSingleItemJSON_amf3_gpp_access_registration_modification = amf3_gpp_access_registration_modification_convertToJSON(amf3_gpp_access_registration_modification);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_amf3_gpp_access_registration_modification);
    }
    ...
    cJSON *ParameterUpdateInTheAMFRegistrationFor3GPPAccessAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    patch_result_t *elementToReturn = patch_result_parseFromJSON(ParameterUpdateInTheAMFRegistrationFor3GPPAccessAPIlocalVarJSON);
    cJSON_Delete(ParameterUpdateInTheAMFRegistrationFor3GPPAccessAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_amf3_gpp_access_registration_modification) {
        cJSON_Delete(localVarSingleItemJSON_amf3_gpp_access_registration_modification);
        localVarSingleItemJSON_amf3_gpp_access_registration_modification = NULL;
    }
