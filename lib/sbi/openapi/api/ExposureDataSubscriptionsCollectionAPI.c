...
ExposureDataSubscriptionsCollectionAPI_createIndividualExposureDataSubscription(apiClient_t *apiClient, exposure_data_subscription_t * exposure_data_subscription )
{
    ...
    // create the path
    long sizeOfPath = strlen("/exposure-data/subs-to-notify")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/exposure-data/subs-to-notify");
    ...
    cJSON *ExposureDataSubscriptionsCollectionAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    exposure_data_subscription_t *elementToReturn = exposure_data_subscription_parseFromJSON(ExposureDataSubscriptionsCollectionAPIlocalVarJSON);
    cJSON_Delete(ExposureDataSubscriptionsCollectionAPIlocalVarJSON);
