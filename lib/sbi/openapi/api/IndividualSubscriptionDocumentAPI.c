...
IndividualSubscriptionDocumentAPI_aMFStatusChangeSubscribeModfy(apiClient_t *apiClient, char * subscriptionId , namf_subscription_data_t * namf_subscription_data )
{
    ...
    cJSON *IndividualSubscriptionDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    namf_subscription_data_t *elementToReturn = namf_subscription_data_parseFromJSON(IndividualSubscriptionDocumentAPIlocalVarJSON);
