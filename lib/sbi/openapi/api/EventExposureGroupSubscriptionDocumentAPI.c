...
EventExposureGroupSubscriptionDocumentAPI_modifyEeGroupSubscription(apiClient_t *apiClient, char * ueGroupId , char * subsId , list_t * patch_item , char * supported_features )
{
    ...
    // create the path
    long sizeOfPath = strlen("/subscription-data/group-data/{ueGroupId}/ee-subscriptions/{subsId}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/subscription-data/group-data/{ueGroupId}/ee-subscriptions/{subsId}");
    ...
    cJSON *EventExposureGroupSubscriptionDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    patch_result_t *elementToReturn = patch_result_parseFromJSON(EventExposureGroupSubscriptionDocumentAPIlocalVarJSON);
    cJSON_Delete(EventExposureGroupSubscriptionDocumentAPIlocalVarJSON);
...
EventExposureGroupSubscriptionDocumentAPI_queryEeGroupSubscription(apiClient_t *apiClient, char * ueGroupId , char * subsId )
{
    ...
    //nonprimitive not container
    cJSON *EventExposureGroupSubscriptionDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    object_t *elementToReturn = object_parseFromJSON(EventExposureGroupSubscriptionDocumentAPIlocalVarJSON);
    cJSON_Delete(EventExposureGroupSubscriptionDocumentAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
