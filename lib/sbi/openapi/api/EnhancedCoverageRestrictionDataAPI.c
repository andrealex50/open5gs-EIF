...
EnhancedCoverageRestrictionDataAPI_queryCoverageRestrictionData(apiClient_t *apiClient, char * ueId , char * supported_features , char * If_None_Match , char * If_Modified_Since )
{
    ...
    // create the path
    long sizeOfPath = strlen("/subscription-data/{ueId}/coverage-restriction-data")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/subscription-data/{ueId}/coverage-restriction-data");
    ...
    cJSON *EnhancedCoverageRestrictionDataAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    enhanced_coverage_restriction_data_t *elementToReturn = enhanced_coverage_restriction_data_parseFromJSON(EnhancedCoverageRestrictionDataAPIlocalVarJSON);
    cJSON_Delete(EnhancedCoverageRestrictionDataAPIlocalVarJSON);
