...
V2XSubscriptionDataRetrievalAPI_getV2xData(apiClient_t *apiClient, char * supi , char * supported_features , char * If_None_Match , char * If_Modified_Since )
{
    ...
    // create the path
    long sizeOfPath = strlen("/{supi}/v2x-data")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/{supi}/v2x-data");
    ...
    cJSON *V2XSubscriptionDataRetrievalAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v2x_subscription_data_t *elementToReturn = v2x_subscription_data_parseFromJSON(V2XSubscriptionDataRetrievalAPIlocalVarJSON);
    cJSON_Delete(V2XSubscriptionDataRetrievalAPIlocalVarJSON);
