...
#include <stdio.h>
#include <ctype.h>
#include "ParameterUpdateInTheSMFRegistrationAPI.h"
...
ParameterUpdateInTheSMFRegistrationAPI_updateSmfRegistration(apiClient_t *apiClient, char * ueId , int pduSessionId , smf_registration_modification_t * smf_registration_modification , char * supported_features )
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_smf_registration_modification = NULL;
    if (smf_registration_modification != NULL)
    {
        //string
        localVarSingleItemJSON_smf_registration_modification = smf_registration_modification_convertToJSON(smf_registration_modification);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_smf_registration_modification);
    }
    ...
    cJSON *ParameterUpdateInTheSMFRegistrationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    patch_result_t *elementToReturn = patch_result_parseFromJSON(ParameterUpdateInTheSMFRegistrationAPIlocalVarJSON);
    cJSON_Delete(ParameterUpdateInTheSMFRegistrationAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_smf_registration_modification) {
        cJSON_Delete(localVarSingleItemJSON_smf_registration_modification);
        localVarSingleItemJSON_smf_registration_modification = NULL;
    }
