...
//
void
ProvidingAcknowledgementOfUEParametersUpdateAPI_upuAck(apiClient_t *apiClient, char * supi , acknowledge_info_t * acknowledge_info )
{
    ...
    // create the path
    long sizeOfPath = strlen("/{supi}/am-data/upu-ack")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/{supi}/am-data/upu-ack");
