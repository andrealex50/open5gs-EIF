...
AccessAndMobilityPolicyDataDocumentAPI_readAccessAndMobilityPolicyData(apiClient_t *apiClient, char * ueId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/policy-data/ues/{ueId}/am-data")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/policy-data/ues/{ueId}/am-data");
    ...
    cJSON *AccessAndMobilityPolicyDataDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    am_policy_data_t *elementToReturn = am_policy_data_parseFromJSON(AccessAndMobilityPolicyDataDocumentAPIlocalVarJSON);
    cJSON_Delete(AccessAndMobilityPolicyDataDocumentAPIlocalVarJSON);
