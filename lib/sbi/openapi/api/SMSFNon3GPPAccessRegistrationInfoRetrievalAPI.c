...
SMSFNon3GPPAccessRegistrationInfoRetrievalAPI_getNon3GppSmsfRegistration(apiClient_t *apiClient, char * ueId , char * supported_features )
{
    ...
    // create the path
    long sizeOfPath = strlen("/{ueId}/registrations/smsf-non-3gpp-access")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/{ueId}/registrations/smsf-non-3gpp-access");
    ...
    cJSON *SMSFNon3GPPAccessRegistrationInfoRetrievalAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    smsf_registration_t *elementToReturn = smsf_registration_parseFromJSON(SMSFNon3GPPAccessRegistrationInfoRetrievalAPIlocalVarJSON);
    cJSON_Delete(SMSFNon3GPPAccessRegistrationInfoRetrievalAPIlocalVarJSON);
