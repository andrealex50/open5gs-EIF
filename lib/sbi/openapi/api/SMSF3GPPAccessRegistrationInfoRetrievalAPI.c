...
//
smsf_registration_t*
SMSF3GPPAccessRegistrationInfoRetrievalAPI_get3GppSmsfRegistration(apiClient_t *apiClient, char * ueId , char * supported_features )
{
    ...
    cJSON *SMSF3GPPAccessRegistrationInfoRetrievalAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    smsf_registration_t *elementToReturn = smsf_registration_parseFromJSON(SMSF3GPPAccessRegistrationInfoRetrievalAPIlocalVarJSON);
    cJSON_Delete(SMSF3GPPAccessRegistrationInfoRetrievalAPIlocalVarJSON);
