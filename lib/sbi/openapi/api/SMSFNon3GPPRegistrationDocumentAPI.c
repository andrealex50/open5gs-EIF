...
SMSFNon3GPPRegistrationDocumentAPI_createSmsfContextNon3gpp(apiClient_t *apiClient, char * ueId , smsf_registration_t * smsf_registration )
{
    ...
    // create the path
    long sizeOfPath = strlen("/subscription-data/{ueId}/context-data/smsf-non-3gpp-access")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/subscription-data/{ueId}/context-data/smsf-non-3gpp-access");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_smsf_registration = NULL;
    if (smsf_registration != NULL)
    {
        //string
        localVarSingleItemJSON_smsf_registration = smsf_registration_convertToJSON(smsf_registration);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_smsf_registration);
    }
    ...
    cJSON *SMSFNon3GPPRegistrationDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    smsf_registration_t *elementToReturn = smsf_registration_parseFromJSON(SMSFNon3GPPRegistrationDocumentAPIlocalVarJSON);
    cJSON_Delete(SMSFNon3GPPRegistrationDocumentAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_smsf_registration) {
        cJSON_Delete(localVarSingleItemJSON_smsf_registration);
        localVarSingleItemJSON_smsf_registration = NULL;
    }
