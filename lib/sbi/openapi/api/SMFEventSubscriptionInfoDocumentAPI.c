...
SMFEventSubscriptionInfoDocumentAPI_createSMFSubscriptions(apiClient_t *apiClient, char * ueId , char * subsId , smf_subscription_info_t * smf_subscription_info )
{
    ...
    // create the path
    long sizeOfPath = strlen("/subscription-data/{ueId}/context-data/ee-subscriptions/{subsId}/smf-subscriptions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/subscription-data/{ueId}/context-data/ee-subscriptions/{subsId}/smf-subscriptions");
    ...
    cJSON *SMFEventSubscriptionInfoDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    smf_subscription_info_t *elementToReturn = smf_subscription_info_parseFromJSON(SMFEventSubscriptionInfoDocumentAPIlocalVarJSON);
    cJSON_Delete(SMFEventSubscriptionInfoDocumentAPIlocalVarJSON);
...
SMFEventSubscriptionInfoDocumentAPI_modifySmfGroupSubscriptions(apiClient_t *apiClient, char * ueGroupId , char * subsId , list_t * patch_item , char * supported_features )
{
    ...
    //nonprimitive not container
    cJSON *SMFEventSubscriptionInfoDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    patch_result_t *elementToReturn = patch_result_parseFromJSON(SMFEventSubscriptionInfoDocumentAPIlocalVarJSON);
    cJSON_Delete(SMFEventSubscriptionInfoDocumentAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
