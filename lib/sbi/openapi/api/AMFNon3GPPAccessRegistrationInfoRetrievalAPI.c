...
AMFNon3GPPAccessRegistrationInfoRetrievalAPI_getNon3GppRegistration(apiClient_t *apiClient, char * ueId , char * supported_features )
{
    ...
    cJSON *AMFNon3GPPAccessRegistrationInfoRetrievalAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    amf_non3_gpp_access_registration_t *elementToReturn = amf_non3_gpp_access_registration_parseFromJSON(AMFNon3GPPAccessRegistrationInfoRetrievalAPIlocalVarJSON);
    cJSON_Delete(AMFNon3GPPAccessRegistrationInfoRetrievalAPIlocalVarJSON);
