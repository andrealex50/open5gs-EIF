...
#include <stdio.h>
#include <ctype.h>
#include "AMFGroupSubscriptionInfoDocumentAPI.h"
...
AMFGroupSubscriptionInfoDocumentAPI_createAmfGroupSubscriptions(apiClient_t *apiClient, char * ueGroupId , char * subsId , list_t * amf_subscription_info )
{
    ...
    //    printf("%s\n","Generic Error");
    //}
    cJSON *AMFGroupSubscriptionInfoDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(AMFGroupSubscriptionInfoDocumentAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, AMFGroupSubscriptionInfoDocumentAPIlocalVarJSON)
    {
    ...
    cJSON_Delete( AMFGroupSubscriptionInfoDocumentAPIlocalVarJSON);
