...
IndividualAuthEventDocumentAPI_queryIndividualAuthenticationStatus(apiClient_t *apiClient, char * ueId , char * servingNetworkName , list_t * fields , char * supported_features )
{
    ...
    cJSON *IndividualAuthEventDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    auth_event_t *elementToReturn = auth_event_parseFromJSON(IndividualAuthEventDocumentAPIlocalVarJSON);
    cJSON_Delete(IndividualAuthEventDocumentAPIlocalVarJSON);
