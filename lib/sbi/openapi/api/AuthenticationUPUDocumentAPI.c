...
AuthenticationUPUDocumentAPI_createAuthenticationUPU(apiClient_t *apiClient, char * ueId , upu_data_t * upu_data , char * supported_features )
{
    ...
    // create the path
    long sizeOfPath = strlen("/subscription-data/{ueId}/ue-update-confirmation-data/upu-data")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/subscription-data/{ueId}/ue-update-confirmation-data/upu-data");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_upu_data = NULL;
    if (upu_data != NULL)
    {
        //string
        localVarSingleItemJSON_upu_data = upu_data_convertToJSON(upu_data);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_upu_data);
    }
    ...
    if (localVarSingleItemJSON_upu_data) {
        cJSON_Delete(localVarSingleItemJSON_upu_data);
        localVarSingleItemJSON_upu_data = NULL;
    }
...
AuthenticationUPUDocumentAPI_queryAuthUPU(apiClient_t *apiClient, char * ueId , char * supported_features )
{
    ...
    cJSON *AuthenticationUPUDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    upu_data_t *elementToReturn = upu_data_parseFromJSON(AuthenticationUPUDocumentAPIlocalVarJSON);
    cJSON_Delete(AuthenticationUPUDocumentAPIlocalVarJSON);
