...
ParameterUpdateInTheAMFRegistrationForNon3GPPAccessAPI_updateNon3GppRegistration(apiClient_t *apiClient, char * ueId , amf_non3_gpp_access_registration_modification_t * amf_non3_gpp_access_registration_modification , char * supported_features )
{
    ...
    // create the path
    long sizeOfPath = strlen("/{ueId}/registrations/amf-non-3gpp-access")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/{ueId}/registrations/amf-non-3gpp-access");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_amf_non3_gpp_access_registration_modification = NULL;
    if (amf_non3_gpp_access_registration_modification != NULL)
    {
        //string
        localVarSingleItemJSON_amf_non3_gpp_access_registration_modification = amf_non3_gpp_access_registration_modification_convertToJSON(amf_non3_gpp_access_registration_modification);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_amf_non3_gpp_access_registration_modification);
    }
    ...
    cJSON *ParameterUpdateInTheAMFRegistrationForNon3GPPAccessAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    patch_result_t *elementToReturn = patch_result_parseFromJSON(ParameterUpdateInTheAMFRegistrationForNon3GPPAccessAPIlocalVarJSON);
    cJSON_Delete(ParameterUpdateInTheAMFRegistrationForNon3GPPAccessAPIlocalVarJSON);
    ...
    if (localVarSingleItemJSON_amf_non3_gpp_access_registration_modification) {
        cJSON_Delete(localVarSingleItemJSON_amf_non3_gpp_access_registration_modification);
        localVarSingleItemJSON_amf_non3_gpp_access_registration_modification = NULL;
    }
