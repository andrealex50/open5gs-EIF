...
#include <stdio.h>
#include <ctype.h>
#include "RetrieveTheRoamingInformationOfThe5GCEPCDomainsDocumentAPI.h"
...
RetrieveTheRoamingInformationOfThe5GCEPCDomainsDocumentAPI_queryPeiInformation(apiClient_t *apiClient, char * ueId )
{
    ...
    cJSON *RetrieveTheRoamingInformationOfThe5GCEPCDomainsDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    pei_update_info_t *elementToReturn = pei_update_info_parseFromJSON(RetrieveTheRoamingInformationOfThe5GCEPCDomainsDocumentAPIlocalVarJSON);
    cJSON_Delete(RetrieveTheRoamingInformationOfThe5GCEPCDomainsDocumentAPIlocalVarJSON);
