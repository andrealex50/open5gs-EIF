...
EventsSubscriptionDocumentAPI_deleteEventsSubsc(apiClient_t *apiClient, char * appSessionId )
{
    ...
    // create the path
    long sizeOfPath = strlen("/app-sessions/{appSessionId}/events-subscription")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/app-sessions/{appSessionId}/events-subscription");
    ...
    //    printf("%s\n","The deletion of the of the Events Subscription sub-resource is confirmed without returning additional data.");
    //}
    // uncomment below to debug the error response
...
EventsSubscriptionDocumentAPI_updateEventsSubsc(apiClient_t *apiClient, char * appSessionId , events_subsc_req_data_t * events_subsc_req_data )
{
    ...
    //    printf("%s\n","The creation of the Events Subscription resource is confirmed and its representation is returned.");
    //}
    // uncomment below to debug the error response
    //if (apiClient->response_code == 200) {
    //    printf("%s\n","The modification of the Events Subscription resource is confirmed its representation is returned.");
    //}
    // uncomment below to debug the error response
    //if (apiClient->response_code == 204) {
    //    printf("%s\n","The modification of the Events Subscription subresource is confirmed without returning additional data.");
    //}
    // uncomment below to debug the error response
    //if (apiClient->response_code == 307) {
    //    printf("%s\n","Temporary Redirect");
    ...
    cJSON *EventsSubscriptionDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    events_subsc_put_data_t *elementToReturn = events_subsc_put_data_parseFromJSON(EventsSubscriptionDocumentAPIlocalVarJSON);
    cJSON_Delete(EventsSubscriptionDocumentAPIlocalVarJSON);
