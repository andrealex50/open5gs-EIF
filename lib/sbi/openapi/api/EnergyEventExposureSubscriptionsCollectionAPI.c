...
#include <stdio.h>
#include <ctype.h>
#include "EnergyEventExposureSubscriptionsCollectionAPI.h"
...
EnergyEventExposureSubscriptionsCollectionAPI_createEnergyEESubsc(apiClient_t *apiClient, energy_ee_subsc_t * energy_ee_subsc )
{
    ...
    //    printf("%s\n","Created. The Energy Event Exposure Subscription is successfully created and a representation of the created Individual Energy Event Exposure Subscription resource shall be returned. ");
    //}
    // uncomment below to debug the error response
    ...
    cJSON *EnergyEventExposureSubscriptionsCollectionAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    energy_ee_subsc_t *elementToReturn = energy_ee_subsc_parseFromJSON(EnergyEventExposureSubscriptionsCollectionAPIlocalVarJSON);
    cJSON_Delete(EnergyEventExposureSubscriptionsCollectionAPIlocalVarJSON);
...
EnergyEventExposureSubscriptionsCollectionAPI_getEnergyEESubscs(apiClient_t *apiClient)
{
    ...
    //    printf("%s\n","OK. All the active Individual Energy Event Exposure Subscription resource(s) managed by the EIF are returned. If there are no active Individual Energy Event Exposure Subscription resource(s) at the EIF, an empty array is returned. ");
    //}
    // uncomment below to debug the error response
    ...
    //}
    cJSON *EnergyEventExposureSubscriptionsCollectionAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    if(!cJSON_IsArray(EnergyEventExposureSubscriptionsCollectionAPIlocalVarJSON)) {
        return 0;//nonprimitive container
    }
    list_t *elementToReturn = list_createList();
    cJSON *VarJSON;
    cJSON_ArrayForEach(VarJSON, EnergyEventExposureSubscriptionsCollectionAPIlocalVarJSON)
    {
