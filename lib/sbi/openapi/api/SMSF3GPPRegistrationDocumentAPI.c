...
SMSF3GPPRegistrationDocumentAPI_createSmsfContext3gpp(apiClient_t *apiClient, char * ueId , smsf_registration_t * smsf_registration )
{
    ...
    // create the path
    long sizeOfPath = strlen("/subscription-data/{ueId}/context-data/smsf-3gpp-access")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/subscription-data/{ueId}/context-data/smsf-3gpp-access");
    ...
    cJSON *SMSF3GPPRegistrationDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    smsf_registration_t *elementToReturn = smsf_registration_parseFromJSON(SMSF3GPPRegistrationDocumentAPIlocalVarJSON);
    cJSON_Delete(SMSF3GPPRegistrationDocumentAPIlocalVarJSON);
