...
//
void
IndividualUeContextDocumentAPI_cancelRelocateUEContext(apiClient_t *apiClient, char * ueContextId , ue_context_cancel_relocate_data_t * jsonData , binary_t* binaryDataGtpcMessage )
{
    ...
    // create the path
    long sizeOfPath = strlen("/ue-contexts/{ueContextId}/cancel-relocate")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/ue-contexts/{ueContextId}/cancel-relocate");


    // Path Params
    long sizeOfPathParams_ueContextId = strlen(ueContextId)+3 + strlen("{ ueContextId }");
    if(ueContextId == NULL) {
        goto end;
    }
    char* localVarToReplace_ueContextId = malloc(sizeOfPathParams_ueContextId);
    sprintf(localVarToReplace_ueContextId, "{%s}", "ueContextId");

    localVarPath = strReplace(localVarPath, localVarToReplace_ueContextId, ueContextId);
    ...
    if (binaryDataGtpcMessage != NULL)
    {
        ...
        keyPairForm_binaryDataGtpcMessage = keyValuePair_create(keyForm_binaryDataGtpcMessage, &valueForm_binaryDataGtpcMessage);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataGtpcMessage); //file adding
    }
...
IndividualUeContextDocumentAPI_createUEContext(apiClient_t *apiClient, char * ueContextId , ue_context_create_data_t * jsonData , binary_t* binaryDataN2Information , binary_t* binaryDataN2InformationExt1 , binary_t* binaryDataN2InformationExt2 , binary_t* binaryDataN2InformationExt3 , binary_t* binaryDataN2InformationExt4 , binary_t* binaryDataN2InformationExt5 , binary_t* binaryDataN2InformationExt6 , binary_t* binaryDataN2InformationExt7 , binary_t* binaryDataN2InformationExt8 , binary_t* binaryDataN2InformationExt9 , binary_t* binaryDataN2InformationExt10 , binary_t* binaryDataN2InformationExt11 , binary_t* binaryDataN2InformationExt12 , binary_t* binaryDataN2InformationExt13 , binary_t* binaryDataN2InformationExt14 , binary_t* binaryDataN2InformationExt15 , binary_t* binaryDataN2InformationExt16 , binary_t* binaryDataN2InformationExt17 )
{
    ...
    {
        keyForm_binaryDataN2Information = strdup("binaryDataN2Information");
        valueForm_binaryDataN2Information = binaryDataN2Information;
        keyPairForm_binaryDataN2Information = keyValuePair_create(keyForm_binaryDataN2Information, &valueForm_binaryDataN2Information);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2Information); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt1 = strdup("binaryDataN2InformationExt1");
        valueForm_binaryDataN2InformationExt1 = binaryDataN2InformationExt1;
        keyPairForm_binaryDataN2InformationExt1 = keyValuePair_create(keyForm_binaryDataN2InformationExt1, &valueForm_binaryDataN2InformationExt1);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt1); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt2 = strdup("binaryDataN2InformationExt2");
        valueForm_binaryDataN2InformationExt2 = binaryDataN2InformationExt2;
        keyPairForm_binaryDataN2InformationExt2 = keyValuePair_create(keyForm_binaryDataN2InformationExt2, &valueForm_binaryDataN2InformationExt2);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt2); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt3 = strdup("binaryDataN2InformationExt3");
        valueForm_binaryDataN2InformationExt3 = binaryDataN2InformationExt3;
        keyPairForm_binaryDataN2InformationExt3 = keyValuePair_create(keyForm_binaryDataN2InformationExt3, &valueForm_binaryDataN2InformationExt3);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt3); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt4 = strdup("binaryDataN2InformationExt4");
        valueForm_binaryDataN2InformationExt4 = binaryDataN2InformationExt4;
        keyPairForm_binaryDataN2InformationExt4 = keyValuePair_create(keyForm_binaryDataN2InformationExt4, &valueForm_binaryDataN2InformationExt4);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt4); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt5 = strdup("binaryDataN2InformationExt5");
        valueForm_binaryDataN2InformationExt5 = binaryDataN2InformationExt5;
        keyPairForm_binaryDataN2InformationExt5 = keyValuePair_create(keyForm_binaryDataN2InformationExt5, &valueForm_binaryDataN2InformationExt5);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt5); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt6 = strdup("binaryDataN2InformationExt6");
        valueForm_binaryDataN2InformationExt6 = binaryDataN2InformationExt6;
        keyPairForm_binaryDataN2InformationExt6 = keyValuePair_create(keyForm_binaryDataN2InformationExt6, &valueForm_binaryDataN2InformationExt6);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt6); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt7 = strdup("binaryDataN2InformationExt7");
        valueForm_binaryDataN2InformationExt7 = binaryDataN2InformationExt7;
        keyPairForm_binaryDataN2InformationExt7 = keyValuePair_create(keyForm_binaryDataN2InformationExt7, &valueForm_binaryDataN2InformationExt7);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt7); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt8 = strdup("binaryDataN2InformationExt8");
        valueForm_binaryDataN2InformationExt8 = binaryDataN2InformationExt8;
        keyPairForm_binaryDataN2InformationExt8 = keyValuePair_create(keyForm_binaryDataN2InformationExt8, &valueForm_binaryDataN2InformationExt8);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt8); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt9 = strdup("binaryDataN2InformationExt9");
        valueForm_binaryDataN2InformationExt9 = binaryDataN2InformationExt9;
        keyPairForm_binaryDataN2InformationExt9 = keyValuePair_create(keyForm_binaryDataN2InformationExt9, &valueForm_binaryDataN2InformationExt9);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt9); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt10 = strdup("binaryDataN2InformationExt10");
        valueForm_binaryDataN2InformationExt10 = binaryDataN2InformationExt10;
        keyPairForm_binaryDataN2InformationExt10 = keyValuePair_create(keyForm_binaryDataN2InformationExt10, &valueForm_binaryDataN2InformationExt10);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt10); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt11 = strdup("binaryDataN2InformationExt11");
        valueForm_binaryDataN2InformationExt11 = binaryDataN2InformationExt11;
        keyPairForm_binaryDataN2InformationExt11 = keyValuePair_create(keyForm_binaryDataN2InformationExt11, &valueForm_binaryDataN2InformationExt11);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt11); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt12 = strdup("binaryDataN2InformationExt12");
        valueForm_binaryDataN2InformationExt12 = binaryDataN2InformationExt12;
        keyPairForm_binaryDataN2InformationExt12 = keyValuePair_create(keyForm_binaryDataN2InformationExt12, &valueForm_binaryDataN2InformationExt12);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt12); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt13 = strdup("binaryDataN2InformationExt13");
        valueForm_binaryDataN2InformationExt13 = binaryDataN2InformationExt13;
        keyPairForm_binaryDataN2InformationExt13 = keyValuePair_create(keyForm_binaryDataN2InformationExt13, &valueForm_binaryDataN2InformationExt13);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt13); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt14 = strdup("binaryDataN2InformationExt14");
        valueForm_binaryDataN2InformationExt14 = binaryDataN2InformationExt14;
        keyPairForm_binaryDataN2InformationExt14 = keyValuePair_create(keyForm_binaryDataN2InformationExt14, &valueForm_binaryDataN2InformationExt14);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt14); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt15 = strdup("binaryDataN2InformationExt15");
        valueForm_binaryDataN2InformationExt15 = binaryDataN2InformationExt15;
        keyPairForm_binaryDataN2InformationExt15 = keyValuePair_create(keyForm_binaryDataN2InformationExt15, &valueForm_binaryDataN2InformationExt15);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt15); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt16 = strdup("binaryDataN2InformationExt16");
        valueForm_binaryDataN2InformationExt16 = binaryDataN2InformationExt16;
        keyPairForm_binaryDataN2InformationExt16 = keyValuePair_create(keyForm_binaryDataN2InformationExt16, &valueForm_binaryDataN2InformationExt16);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt16); //file adding
    }
    ...
    {
        keyForm_binaryDataN2InformationExt17 = strdup("binaryDataN2InformationExt17");
        valueForm_binaryDataN2InformationExt17 = binaryDataN2InformationExt17;
        keyPairForm_binaryDataN2InformationExt17 = keyValuePair_create(keyForm_binaryDataN2InformationExt17, &valueForm_binaryDataN2InformationExt17);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataN2InformationExt17); //file adding
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    ...
    cJSON *IndividualUeContextDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ue_context_created_data_t *elementToReturn = ue_context_created_data_parseFromJSON(IndividualUeContextDocumentAPIlocalVarJSON);
...
//
assigned_ebi_data_t*
IndividualUeContextDocumentAPI_eBIAssignment(apiClient_t *apiClient, char * ueContextId , assign_ebi_data_t * assign_ebi_data )
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    ...
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/ue-contexts/{ueContextId}/assign-ebi");
    ...
    {
        //string
        localVarSingleItemJSON_assign_ebi_data = assign_ebi_data_convertToJSON(assign_ebi_data);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_assign_ebi_data);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/problem+json"); //produces
    ...
    //nonprimitive not container
    cJSON *IndividualUeContextDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    assigned_ebi_data_t *elementToReturn = assigned_ebi_data_parseFromJSON(IndividualUeContextDocumentAPIlocalVarJSON);
    cJSON_Delete(IndividualUeContextDocumentAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
IndividualUeContextDocumentAPI_registrationStatusUpdate(apiClient_t *apiClient, char * ueContextId , ue_reg_status_update_req_data_t * ue_reg_status_update_req_data )
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/ue-contexts/{ueContextId}/transfer-update")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/ue-contexts/{ueContextId}/transfer-update");
    ...
    {
        //string
        localVarSingleItemJSON_ue_reg_status_update_req_data = ue_reg_status_update_req_data_convertToJSON(ue_reg_status_update_req_data);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ue_reg_status_update_req_data);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/problem+json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //nonprimitive not container
    cJSON *IndividualUeContextDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ue_reg_status_update_rsp_data_t *elementToReturn = ue_reg_status_update_rsp_data_parseFromJSON(IndividualUeContextDocumentAPIlocalVarJSON);
    cJSON_Delete(IndividualUeContextDocumentAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    if (localVarSingleItemJSON_ue_reg_status_update_req_data) {
        cJSON_Delete(localVarSingleItemJSON_ue_reg_status_update_req_data);
...
//
void
IndividualUeContextDocumentAPI_releaseUEContext(apiClient_t *apiClient, char * ueContextId , ue_context_release_t * ue_context_release )
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/ue-contexts/{ueContextId}/release");
    ...
    {
        //string
        localVarSingleItemJSON_ue_context_release = ue_context_release_convertToJSON(ue_context_release);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ue_context_release);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/problem+json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
...
IndividualUeContextDocumentAPI_relocateUEContext(apiClient_t *apiClient, char * ueContextId , ue_context_relocate_data_t * jsonData , binary_t* binaryDataForwardRelocationRequest , binary_t* binaryDataN2Information , binary_t* binaryDataN2InformationExt1 , binary_t* binaryDataN2InformationExt2 , binary_t* binaryDataN2InformationExt3 , binary_t* binaryDataN2InformationExt4 , binary_t* binaryDataN2InformationExt5 , binary_t* binaryDataN2InformationExt6 , binary_t* binaryDataN2InformationExt7 , binary_t* binaryDataN2InformationExt8 , binary_t* binaryDataN2InformationExt9 , binary_t* binaryDataN2InformationExt10 , binary_t* binaryDataN2InformationExt11 , binary_t* binaryDataN2InformationExt12 , binary_t* binaryDataN2InformationExt13 , binary_t* binaryDataN2InformationExt14 , binary_t* binaryDataN2InformationExt15 , binary_t* binaryDataN2InformationExt16 )
{
    ...
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/ue-contexts/{ueContextId}/relocate");
    ...
    {
        keyForm_binaryDataForwardRelocationRequest = strdup("binaryDataForwardRelocationRequest");
        valueForm_binaryDataForwardRelocationRequest = binaryDataForwardRelocationRequest;
        keyPairForm_binaryDataForwardRelocationRequest = keyValuePair_create(keyForm_binaryDataForwardRelocationRequest, &valueForm_binaryDataForwardRelocationRequest);
        list_addElement(localVarFormParameters,keyPairForm_binaryDataForwardRelocationRequest); //file adding
    }
    ...
    //nonprimitive not container
    cJSON *IndividualUeContextDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ue_context_relocated_data_t *elementToReturn = ue_context_relocated_data_parseFromJSON(IndividualUeContextDocumentAPIlocalVarJSON);
    cJSON_Delete(IndividualUeContextDocumentAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
IndividualUeContextDocumentAPI_uEContextTransfer(apiClient_t *apiClient, char * ueContextId , ue_context_transfer_req_data_t * ue_context_transfer_req_data )
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/ue-contexts/{ueContextId}/transfer");
    ...
    {
        //string
        localVarSingleItemJSON_ue_context_transfer_req_data = ue_context_transfer_req_data_convertToJSON(ue_context_transfer_req_data);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ue_context_transfer_req_data);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"multipart/related"); //produces
    list_addElement(localVarHeaderType,"application/problem+json"); //produces
    ...
    //nonprimitive not container
    cJSON *IndividualUeContextDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ue_context_transfer_rsp_data_t *elementToReturn = ue_context_transfer_rsp_data_parseFromJSON(IndividualUeContextDocumentAPIlocalVarJSON);
    cJSON_Delete(IndividualUeContextDocumentAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
