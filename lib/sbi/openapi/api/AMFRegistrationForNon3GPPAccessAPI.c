...
AMFRegistrationForNon3GPPAccessAPI_non3GppRegistration(apiClient_t *apiClient, char * ueId , amf_non3_gpp_access_registration_t * amf_non3_gpp_access_registration )
{
    ...
    cJSON *AMFRegistrationForNon3GPPAccessAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    amf_non3_gpp_access_registration_t *elementToReturn = amf_non3_gpp_access_registration_parseFromJSON(AMFRegistrationForNon3GPPAccessAPIlocalVarJSON);
    cJSON_Delete(AMFRegistrationForNon3GPPAccessAPIlocalVarJSON);
