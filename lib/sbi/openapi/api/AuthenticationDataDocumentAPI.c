...
AuthenticationDataDocumentAPI_queryAuthSubsData(apiClient_t *apiClient, char * ueId , char * supported_features )
{
    ...
    // create the path
    long sizeOfPath = strlen("/subscription-data/{ueId}/authentication-data/authentication-subscription")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/subscription-data/{ueId}/authentication-data/authentication-subscription");
    ...
    cJSON *AuthenticationDataDocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    authentication_subscription_t *elementToReturn = authentication_subscription_parseFromJSON(AuthenticationDataDocumentAPIlocalVarJSON);
    cJSON_Delete(AuthenticationDataDocumentAPIlocalVarJSON);
