...
IPSMGWRegistrationAPI_ipSmGwRegistration(apiClient_t *apiClient, char * ueId , ip_sm_gw_registration_t * ip_sm_gw_registration )
{
    ...
    cJSON *IPSMGWRegistrationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ip_sm_gw_registration_t *elementToReturn = ip_sm_gw_registration_parseFromJSON(IPSMGWRegistrationAPIlocalVarJSON);
    cJSON_Delete(IPSMGWRegistrationAPIlocalVarJSON);
