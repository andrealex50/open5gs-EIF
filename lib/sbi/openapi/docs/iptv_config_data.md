...
**inter_group_id** | **any_type_t \*** | Identifies a group of users. | [optional] 
...
**af_app_id** | **char \*** |  | 
**multi_acc_ctrls** | **list_t*** | Identifies a list of multicast address access control information. Any string value can be used as a key of the map.  | 
