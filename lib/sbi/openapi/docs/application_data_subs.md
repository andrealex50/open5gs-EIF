...
**data_filters** | [**list_t**](data_filter.md) \* |  | [optional] 
**expiry** | **char \*** | string with format &#39;date-time&#39; as defined in OpenAPI. | [optional] 
**imm_rep** | **int** | Immediate reporting indication. | [optional] 
**am_influ_entries** | [**list_t**](am_influ_data.md) \* | The AM Influence Data entries stored in the UDR that match a subscription. | [optional] 
