...
**events_subsc_sets** | **list_t*** | Contains the set(s) of Energy Event Exposure subscription related details. The key of the map shall be set to the value of the \&quot;subscSetId\&quot; attribute of the corresponding map value encoded using the EnergyEeSubscSet data structure.  | 
