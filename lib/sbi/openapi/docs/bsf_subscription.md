...
------------ | ------------- | ------------- | -------------
**events** | [**list_t**](bsf_event.md) \* | Contain te subscribed events. | 
**notif_uri** | **char \*** | String providing an URI formatted according to RFC 3986. | 
**notif_corre_id** | **char \*** | Notification Correlation ID assigned by the NF service consumer. | 
...
**snssai_dnn_pairs** | [**snssai_dnn_pair_t**](snssai_dnn_pair.md) \* |  | [optional] 
**add_snssai_dnn_pairs** | [**list_t**](snssai_dnn_pair.md) \* | Represents the additional S-NSSAI and DNN pair(s) for which the binding event report(s) shall apply.  | [optional] 
