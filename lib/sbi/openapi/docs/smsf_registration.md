...
------------ | ------------- | ------------- | -------------
**smsf_instance_id** | **char \*** | String uniquely identifying a NF instance. The format of the NF Instance ID shall be a  Universally Unique Identifier (UUID) version 4, as described in IETF RFC 4122.   | 
...
**smsf_map_address** | **char \*** |  | [optional] 
**smsf_diameter_address** | [**network_node_diameter_address_t**](network_node_diameter_address.md) \* |  | [optional] 
...
**smsf_sbi_sup_ind** | **int** |  | [optional] [default to false]
