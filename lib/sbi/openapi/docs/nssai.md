...
**default_single_nssais** | [**list_t**](snssai.md) \* |  | 
**single_nssais** | [**list_t**](snssai.md) \* |  | [optional] 
**provisioning_time** | **char \*** | string with format &#39;date-time&#39; as defined in OpenAPI. | [optional] 
**additional_snssai_data** | **list_t*** | A map(list of key-value pairs) where singleNssai serves as key of AdditionalSnssaiData | [optional] 
**suppress_nssrg_ind** | **int** |  | [optional] 
