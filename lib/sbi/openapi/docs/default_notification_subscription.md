...
**versions** | **list_t \*** |  | [optional] 
**binding** | **char \*** |  | [optional] 
**accepted_encoding** | **char \*** |  | [optional] 
...
**service_info_list** | **list_t*** | A map of service specific information. The name of the corresponding service (as specified in ServiceName data type) is the key.  | [optional] 
