...
------------ | ------------- | ------------- | -------------
**dnns** | **list_t \*** | Each element identifies a DNN. | [optional] 
**snssais** | [**list_t**](snssai.md) \* | Each element identifies a slice. | [optional] 
**internal_group_ids** | **list_t \*** | Each element identifies a group of users. | [optional] 
**supis** | **list_t \*** | Each element identifies the user. | [optional] 
