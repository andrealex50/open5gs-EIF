...
------------ | ------------- | ------------- | -------------
**application_id** | **char \*** | String providing an application identifier. | 
**pfds** | [**list_t**](pfd_content.md) \* |  | 
**caching_time** | **char \*** | string with format &#39;date-time&#39; as defined in OpenAPI. | [optional] 
...
**allowed_delay** | **int** | indicating a time in seconds. | [optional] 
