...
**subscribed_snssai_infos** | **list_t*** | A map(list of key-value pairs) where singleNssai serves as key of SnssaiInfo | [optional] 
**shared_snssai_infos_id** | **char \*** |  | [optional] 
