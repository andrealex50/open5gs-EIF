...
**pcf_ip_end_points** | [**list_t**](ip_end_point.md) \* | IP end points of the PCF hosting the Npcf_AmPolicyAuthorization service. | [optional] 
...
**ipv6_prefixes** | **list_t \*** | The IPv6 Address Prefixes of the served UE. | [optional] 
**mac_addrs** | **list_t \*** | The MAC Addresses of the served UE. | [optional] 
