# energy_ee_subsc_set_t

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**event** | **energy_ee_event_t \*** |  | 
**subsc_set_id** | **char \*** |  | 
...
**flow_descs** | **list_t \*** |  | [optional] 
**rep_period** | **int** | Indicates a time interval in seconds. | [optional] 
**rep_time_win** | [**time_window_t**](time_window.md) \* |  | [optional] 
**enrg_rep_thres** | [**energy_info_t**](energy_info.md) \* |  | [optional] 
**rep_period_thres** | **int** | Indicates a time interval in seconds. | [optional] 
