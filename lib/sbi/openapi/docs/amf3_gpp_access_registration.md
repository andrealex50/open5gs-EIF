...
**initial_registration_ind** | **int** |  | [optional] 
**emergency_registration_ind** | **int** |  | [optional] 
**guami** | [**guami_t**](guami.md) \* |  | 
**backup_amf_info** | [**list_t**](backup_amf_info.md) \* |  | [optional] 
**dr_flag** | **int** |  | [optional] 
**rat_type** | **rat_type_t \*** |  | 
...
**ue_srvcc_capability** | **int** |  | [optional] 
...
**ue_reachable_ind** | **ue_reachable_ind_t \*** |  | [optional] 
...
**ue_mint_capability** | **int** |  | [optional] 
