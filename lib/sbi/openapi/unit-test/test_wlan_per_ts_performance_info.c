...
wlan_per_ts_performance_info_t* instantiate_wlan_per_ts_performance_info(int include_optional);
...
wlan_per_ts_performance_info_t* instantiate_wlan_per_ts_performance_info(int include_optional) {
  ...
  if (include_optional) {
    wlan_per_ts_performance_info = wlan_per_ts_performance_info_create(
...
void test_wlan_per_ts_performance_info(int include_optional) {
    wlan_per_ts_performance_info_t* wlan_per_ts_performance_info_1 = instantiate_wlan_per_ts_performance_info(include_optional);

	cJSON* jsonwlan_per_ts_performance_info_1 = wlan_per_ts_performance_info_convertToJSON(wlan_per_ts_performance_info_1);
	printf("wlan_per_ts_performance_info :\n%s\n", cJSON_Print(jsonwlan_per_ts_performance_info_1));
	wlan_per_ts_performance_info_t* wlan_per_ts_performance_info_2 = wlan_per_ts_performance_info_parseFromJSON(jsonwlan_per_ts_performance_info_1);
	cJSON* jsonwlan_per_ts_performance_info_2 = wlan_per_ts_performance_info_convertToJSON(wlan_per_ts_performance_info_2);
