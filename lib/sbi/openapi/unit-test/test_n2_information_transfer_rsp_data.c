...
n2_information_transfer_rsp_data_t* instantiate_n2_information_transfer_rsp_data(int include_optional);

#include "test_pws_response_data.c"


n2_information_transfer_rsp_data_t* instantiate_n2_information_transfer_rsp_data(int include_optional) {
  n2_information_transfer_rsp_data_t* n2_information_transfer_rsp_data = NULL;
  if (include_optional) {
    n2_information_transfer_rsp_data = n2_information_transfer_rsp_data_create(
...
void test_n2_information_transfer_rsp_data(int include_optional) {
    n2_information_transfer_rsp_data_t* n2_information_transfer_rsp_data_1 = instantiate_n2_information_transfer_rsp_data(include_optional);

	cJSON* jsonn2_information_transfer_rsp_data_1 = n2_information_transfer_rsp_data_convertToJSON(n2_information_transfer_rsp_data_1);
	printf("n2_information_transfer_rsp_data :\n%s\n", cJSON_Print(jsonn2_information_transfer_rsp_data_1));
	n2_information_transfer_rsp_data_t* n2_information_transfer_rsp_data_2 = n2_information_transfer_rsp_data_parseFromJSON(jsonn2_information_transfer_rsp_data_1);
	cJSON* jsonn2_information_transfer_rsp_data_2 = n2_information_transfer_rsp_data_convertToJSON(n2_information_transfer_rsp_data_2);
