...
traffic_characterization_t* instantiate_traffic_characterization(int include_optional);
...
void test_traffic_characterization(int include_optional) {
    traffic_characterization_t* traffic_characterization_1 = instantiate_traffic_characterization(include_optional);

	cJSON* jsontraffic_characterization_1 = traffic_characterization_convertToJSON(traffic_characterization_1);
	printf("traffic_characterization :\n%s\n", cJSON_Print(jsontraffic_characterization_1));
	traffic_characterization_t* traffic_characterization_2 = traffic_characterization_parseFromJSON(jsontraffic_characterization_1);
	cJSON* jsontraffic_characterization_2 = traffic_characterization_convertToJSON(traffic_characterization_2);
