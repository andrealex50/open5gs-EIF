...
void test_geographic_area(int include_optional) {
    geographic_area_t* geographic_area_1 = instantiate_geographic_area(include_optional);

	cJSON* jsongeographic_area_1 = geographic_area_convertToJSON(geographic_area_1);
	printf("geographic_area :\n%s\n", cJSON_Print(jsongeographic_area_1));
	geographic_area_t* geographic_area_2 = geographic_area_parseFromJSON(jsongeographic_area_1);
	cJSON* jsongeographic_area_2 = geographic_area_convertToJSON(geographic_area_2);
