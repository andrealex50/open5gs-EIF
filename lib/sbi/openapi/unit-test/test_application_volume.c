...
void test_application_volume(int include_optional) {
    application_volume_t* application_volume_1 = instantiate_application_volume(include_optional);

	cJSON* jsonapplication_volume_1 = application_volume_convertToJSON(application_volume_1);
	printf("application_volume :\n%s\n", cJSON_Print(jsonapplication_volume_1));
	application_volume_t* application_volume_2 = application_volume_parseFromJSON(jsonapplication_volume_1);
	cJSON* jsonapplication_volume_2 = application_volume_convertToJSON(application_volume_2);
