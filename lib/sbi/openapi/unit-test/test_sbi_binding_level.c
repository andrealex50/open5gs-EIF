...
void test_sbi_binding_level(int include_optional) {
    sbi_binding_level_t* sbi_binding_level_1 = instantiate_sbi_binding_level(include_optional);

	cJSON* jsonsbi_binding_level_1 = sbi_binding_level_convertToJSON(sbi_binding_level_1);
	printf("sbi_binding_level :\n%s\n", cJSON_Print(jsonsbi_binding_level_1));
	sbi_binding_level_t* sbi_binding_level_2 = sbi_binding_level_parseFromJSON(jsonsbi_binding_level_1);
	cJSON* jsonsbi_binding_level_2 = sbi_binding_level_convertToJSON(sbi_binding_level_2);
