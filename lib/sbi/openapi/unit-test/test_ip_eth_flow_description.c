...
ip_eth_flow_description_t* instantiate_ip_eth_flow_description(int include_optional);
...
void test_ip_eth_flow_description(int include_optional) {
    ip_eth_flow_description_t* ip_eth_flow_description_1 = instantiate_ip_eth_flow_description(include_optional);

	cJSON* jsonip_eth_flow_description_1 = ip_eth_flow_description_convertToJSON(ip_eth_flow_description_1);
	printf("ip_eth_flow_description :\n%s\n", cJSON_Print(jsonip_eth_flow_description_1));
	ip_eth_flow_description_t* ip_eth_flow_description_2 = ip_eth_flow_description_parseFromJSON(jsonip_eth_flow_description_1);
	cJSON* jsonip_eth_flow_description_2 = ip_eth_flow_description_convertToJSON(ip_eth_flow_description_2);
