...
void test_network_area_info_1(int include_optional) {
    network_area_info_1_t* network_area_info_1_1 = instantiate_network_area_info_1(include_optional);

	cJSON* jsonnetwork_area_info_1_1 = network_area_info_1_convertToJSON(network_area_info_1_1);
	printf("network_area_info_1 :\n%s\n", cJSON_Print(jsonnetwork_area_info_1_1));
	network_area_info_1_t* network_area_info_1_2 = network_area_info_1_parseFromJSON(jsonnetwork_area_info_1_1);
	cJSON* jsonnetwork_area_info_1_2 = network_area_info_1_convertToJSON(network_area_info_1_2);
