...
void test_location_filter(int include_optional) {
    location_filter_t* location_filter_1 = instantiate_location_filter(include_optional);

	cJSON* jsonlocation_filter_1 = location_filter_convertToJSON(location_filter_1);
	printf("location_filter :\n%s\n", cJSON_Print(jsonlocation_filter_1));
	location_filter_t* location_filter_2 = location_filter_parseFromJSON(jsonlocation_filter_1);
	cJSON* jsonlocation_filter_2 = location_filter_convertToJSON(location_filter_2);
