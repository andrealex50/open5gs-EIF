...
void test_analytics_subset(int include_optional) {
    analytics_subset_t* analytics_subset_1 = instantiate_analytics_subset(include_optional);

	cJSON* jsonanalytics_subset_1 = analytics_subset_convertToJSON(analytics_subset_1);
	printf("analytics_subset :\n%s\n", cJSON_Print(jsonanalytics_subset_1));
	analytics_subset_t* analytics_subset_2 = analytics_subset_parseFromJSON(jsonanalytics_subset_1);
	cJSON* jsonanalytics_subset_2 = analytics_subset_convertToJSON(analytics_subset_2);
