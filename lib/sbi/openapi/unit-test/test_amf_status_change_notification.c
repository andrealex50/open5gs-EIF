...
amf_status_change_notification_t* instantiate_amf_status_change_notification(int include_optional);
...
amf_status_change_notification_t* instantiate_amf_status_change_notification(int include_optional) {
  ...
  if (include_optional) {
    amf_status_change_notification = amf_status_change_notification_create(
      list_createList()
    );
  } else {
    amf_status_change_notification = amf_status_change_notification_create(
...
void test_amf_status_change_notification(int include_optional) {
    amf_status_change_notification_t* amf_status_change_notification_1 = instantiate_amf_status_change_notification(include_optional);

	cJSON* jsonamf_status_change_notification_1 = amf_status_change_notification_convertToJSON(amf_status_change_notification_1);
	printf("amf_status_change_notification :\n%s\n", cJSON_Print(jsonamf_status_change_notification_1));
	amf_status_change_notification_t* amf_status_change_notification_2 = amf_status_change_notification_parseFromJSON(jsonamf_status_change_notification_1);
	cJSON* jsonamf_status_change_notification_2 = amf_status_change_notification_convertToJSON(amf_status_change_notification_2);
