...
void test_nssai_mapping(int include_optional) {
    nssai_mapping_t* nssai_mapping_1 = instantiate_nssai_mapping(include_optional);

	cJSON* jsonnssai_mapping_1 = nssai_mapping_convertToJSON(nssai_mapping_1);
	printf("nssai_mapping :\n%s\n", cJSON_Print(jsonnssai_mapping_1));
	nssai_mapping_t* nssai_mapping_2 = nssai_mapping_parseFromJSON(jsonnssai_mapping_1);
	cJSON* jsonnssai_mapping_2 = nssai_mapping_convertToJSON(nssai_mapping_2);
	printf("repeating nssai_mapping:\n%s\n", cJSON_Print(jsonnssai_mapping_2));
}
