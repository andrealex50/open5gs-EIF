...
ue_context_create_error_t* instantiate_ue_context_create_error(int include_optional);
...
void test_ue_context_create_error(int include_optional) {
    ue_context_create_error_t* ue_context_create_error_1 = instantiate_ue_context_create_error(include_optional);

	cJSON* jsonue_context_create_error_1 = ue_context_create_error_convertToJSON(ue_context_create_error_1);
	printf("ue_context_create_error :\n%s\n", cJSON_Print(jsonue_context_create_error_1));
	ue_context_create_error_t* ue_context_create_error_2 = ue_context_create_error_parseFromJSON(jsonue_context_create_error_1);
	cJSON* jsonue_context_create_error_2 = ue_context_create_error_convertToJSON(ue_context_create_error_2);
