...
void test_threshold_level(int include_optional) {
    threshold_level_t* threshold_level_1 = instantiate_threshold_level(include_optional);

	cJSON* jsonthreshold_level_1 = threshold_level_convertToJSON(threshold_level_1);
	printf("threshold_level :\n%s\n", cJSON_Print(jsonthreshold_level_1));
	threshold_level_t* threshold_level_2 = threshold_level_parseFromJSON(jsonthreshold_level_1);
	cJSON* jsonthreshold_level_2 = threshold_level_convertToJSON(threshold_level_2);
