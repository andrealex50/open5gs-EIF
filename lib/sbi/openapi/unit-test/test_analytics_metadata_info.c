...
analytics_metadata_info_t* instantiate_analytics_metadata_info(int include_optional);
...
void test_analytics_metadata_info(int include_optional) {
    analytics_metadata_info_t* analytics_metadata_info_1 = instantiate_analytics_metadata_info(include_optional);

	cJSON* jsonanalytics_metadata_info_1 = analytics_metadata_info_convertToJSON(analytics_metadata_info_1);
	printf("analytics_metadata_info :\n%s\n", cJSON_Print(jsonanalytics_metadata_info_1));
	analytics_metadata_info_t* analytics_metadata_info_2 = analytics_metadata_info_parseFromJSON(jsonanalytics_metadata_info_1);
	cJSON* jsonanalytics_metadata_info_2 = analytics_metadata_info_convertToJSON(analytics_metadata_info_2);
