...
consumer_nf_information_t* instantiate_consumer_nf_information(int include_optional);
...
void test_consumer_nf_information(int include_optional) {
    consumer_nf_information_t* consumer_nf_information_1 = instantiate_consumer_nf_information(include_optional);

	cJSON* jsonconsumer_nf_information_1 = consumer_nf_information_convertToJSON(consumer_nf_information_1);
	printf("consumer_nf_information :\n%s\n", cJSON_Print(jsonconsumer_nf_information_1));
	consumer_nf_information_t* consumer_nf_information_2 = consumer_nf_information_parseFromJSON(jsonconsumer_nf_information_1);
	cJSON* jsonconsumer_nf_information_2 = consumer_nf_information_convertToJSON(consumer_nf_information_2);
