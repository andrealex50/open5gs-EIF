...
void test_report_interval_mdt(int include_optional) {
    report_interval_mdt_t* report_interval_mdt_1 = instantiate_report_interval_mdt(include_optional);

	cJSON* jsonreport_interval_mdt_1 = report_interval_mdt_convertToJSON(report_interval_mdt_1);
	printf("report_interval_mdt :\n%s\n", cJSON_Print(jsonreport_interval_mdt_1));
	report_interval_mdt_t* report_interval_mdt_2 = report_interval_mdt_parseFromJSON(jsonreport_interval_mdt_1);
	cJSON* jsonreport_interval_mdt_2 = report_interval_mdt_convertToJSON(report_interval_mdt_2);
