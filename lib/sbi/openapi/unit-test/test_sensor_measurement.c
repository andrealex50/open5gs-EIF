...
void test_sensor_measurement(int include_optional) {
    sensor_measurement_t* sensor_measurement_1 = instantiate_sensor_measurement(include_optional);

	cJSON* jsonsensor_measurement_1 = sensor_measurement_convertToJSON(sensor_measurement_1);
	printf("sensor_measurement :\n%s\n", cJSON_Print(jsonsensor_measurement_1));
	sensor_measurement_t* sensor_measurement_2 = sensor_measurement_parseFromJSON(jsonsensor_measurement_1);
	cJSON* jsonsensor_measurement_2 = sensor_measurement_convertToJSON(sensor_measurement_2);
