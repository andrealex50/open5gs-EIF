...
void test_pc5_flow_bit_rates(int include_optional) {
    pc5_flow_bit_rates_t* pc5_flow_bit_rates_1 = instantiate_pc5_flow_bit_rates(include_optional);

	cJSON* jsonpc5_flow_bit_rates_1 = pc5_flow_bit_rates_convertToJSON(pc5_flow_bit_rates_1);
	printf("pc5_flow_bit_rates :\n%s\n", cJSON_Print(jsonpc5_flow_bit_rates_1));
	pc5_flow_bit_rates_t* pc5_flow_bit_rates_2 = pc5_flow_bit_rates_parseFromJSON(jsonpc5_flow_bit_rates_1);
	cJSON* jsonpc5_flow_bit_rates_2 = pc5_flow_bit_rates_convertToJSON(pc5_flow_bit_rates_2);
