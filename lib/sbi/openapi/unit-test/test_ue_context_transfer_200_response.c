...
ue_context_transfer_200_response_t* instantiate_ue_context_transfer_200_response(int include_optional);

#include "test_ue_context_transfer_rsp_data.c"


ue_context_transfer_200_response_t* instantiate_ue_context_transfer_200_response(int include_optional) {
  ue_context_transfer_200_response_t* ue_context_transfer_200_response = NULL;
  if (include_optional) {
    ue_context_transfer_200_response = ue_context_transfer_200_response_create(
...
void test_ue_context_transfer_200_response(int include_optional) {
    ue_context_transfer_200_response_t* ue_context_transfer_200_response_1 = instantiate_ue_context_transfer_200_response(include_optional);

	cJSON* jsonue_context_transfer_200_response_1 = ue_context_transfer_200_response_convertToJSON(ue_context_transfer_200_response_1);
	printf("ue_context_transfer_200_response :\n%s\n", cJSON_Print(jsonue_context_transfer_200_response_1));
	ue_context_transfer_200_response_t* ue_context_transfer_200_response_2 = ue_context_transfer_200_response_parseFromJSON(jsonue_context_transfer_200_response_1);
	cJSON* jsonue_context_transfer_200_response_2 = ue_context_transfer_200_response_convertToJSON(ue_context_transfer_200_response_2);
