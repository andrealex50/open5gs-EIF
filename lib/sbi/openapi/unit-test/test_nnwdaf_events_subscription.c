...
nnwdaf_events_subscription_t* instantiate_nnwdaf_events_subscription(int include_optional);
...
void test_nnwdaf_events_subscription(int include_optional) {
    nnwdaf_events_subscription_t* nnwdaf_events_subscription_1 = instantiate_nnwdaf_events_subscription(include_optional);

	cJSON* jsonnnwdaf_events_subscription_1 = nnwdaf_events_subscription_convertToJSON(nnwdaf_events_subscription_1);
	printf("nnwdaf_events_subscription :\n%s\n", cJSON_Print(jsonnnwdaf_events_subscription_1));
	nnwdaf_events_subscription_t* nnwdaf_events_subscription_2 = nnwdaf_events_subscription_parseFromJSON(jsonnnwdaf_events_subscription_1);
	cJSON* jsonnnwdaf_events_subscription_2 = nnwdaf_events_subscription_convertToJSON(nnwdaf_events_subscription_2);
