...
dispersion_requirement_t* instantiate_dispersion_requirement(int include_optional);
...
void test_dispersion_requirement(int include_optional) {
    dispersion_requirement_t* dispersion_requirement_1 = instantiate_dispersion_requirement(include_optional);

	cJSON* jsondispersion_requirement_1 = dispersion_requirement_convertToJSON(dispersion_requirement_1);
	printf("dispersion_requirement :\n%s\n", cJSON_Print(jsondispersion_requirement_1));
	dispersion_requirement_t* dispersion_requirement_2 = dispersion_requirement_parseFromJSON(jsondispersion_requirement_1);
	cJSON* jsondispersion_requirement_2 = dispersion_requirement_convertToJSON(dispersion_requirement_2);
