...
circumstance_description_t* instantiate_circumstance_description(int include_optional);
...
void test_circumstance_description(int include_optional) {
    circumstance_description_t* circumstance_description_1 = instantiate_circumstance_description(include_optional);

	cJSON* jsoncircumstance_description_1 = circumstance_description_convertToJSON(circumstance_description_1);
	printf("circumstance_description :\n%s\n", cJSON_Print(jsoncircumstance_description_1));
	circumstance_description_t* circumstance_description_2 = circumstance_description_parseFromJSON(jsoncircumstance_description_1);
	cJSON* jsoncircumstance_description_2 = circumstance_description_convertToJSON(circumstance_description_2);
