...
void test_user_location(int include_optional) {
    user_location_t* user_location_1 = instantiate_user_location(include_optional);

	cJSON* jsonuser_location_1 = user_location_convertToJSON(user_location_1);
	printf("user_location :\n%s\n", cJSON_Print(jsonuser_location_1));
	user_location_t* user_location_2 = user_location_parseFromJSON(jsonuser_location_1);
	cJSON* jsonuser_location_2 = user_location_convertToJSON(user_location_2);
	printf("repeating user_location:\n%s\n", cJSON_Print(jsonuser_location_2));
}
