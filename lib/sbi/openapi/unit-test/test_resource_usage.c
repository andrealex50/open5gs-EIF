...
void test_resource_usage(int include_optional) {
    resource_usage_t* resource_usage_1 = instantiate_resource_usage(include_optional);

	cJSON* jsonresource_usage_1 = resource_usage_convertToJSON(resource_usage_1);
	printf("resource_usage :\n%s\n", cJSON_Print(jsonresource_usage_1));
	resource_usage_t* resource_usage_2 = resource_usage_parseFromJSON(jsonresource_usage_1);
	cJSON* jsonresource_usage_2 = resource_usage_convertToJSON(resource_usage_2);
