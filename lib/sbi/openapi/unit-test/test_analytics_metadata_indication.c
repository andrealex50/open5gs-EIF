...
analytics_metadata_indication_t* instantiate_analytics_metadata_indication(int include_optional);
...
analytics_metadata_indication_t* instantiate_analytics_metadata_indication(int include_optional) {
  ...
  if (include_optional) {
    analytics_metadata_indication = analytics_metadata_indication_create(
...
void test_analytics_metadata_indication(int include_optional) {
    analytics_metadata_indication_t* analytics_metadata_indication_1 = instantiate_analytics_metadata_indication(include_optional);

	cJSON* jsonanalytics_metadata_indication_1 = analytics_metadata_indication_convertToJSON(analytics_metadata_indication_1);
	printf("analytics_metadata_indication :\n%s\n", cJSON_Print(jsonanalytics_metadata_indication_1));
	analytics_metadata_indication_t* analytics_metadata_indication_2 = analytics_metadata_indication_parseFromJSON(jsonanalytics_metadata_indication_1);
	cJSON* jsonanalytics_metadata_indication_2 = analytics_metadata_indication_convertToJSON(analytics_metadata_indication_2);
