...
void test_wireline_area(int include_optional) {
    wireline_area_t* wireline_area_1 = instantiate_wireline_area(include_optional);

	cJSON* jsonwireline_area_1 = wireline_area_convertToJSON(wireline_area_1);
	printf("wireline_area :\n%s\n", cJSON_Print(jsonwireline_area_1));
	wireline_area_t* wireline_area_2 = wireline_area_parseFromJSON(jsonwireline_area_1);
	cJSON* jsonwireline_area_2 = wireline_area_convertToJSON(wireline_area_2);
	printf("repeating wireline_area:\n%s\n", cJSON_Print(jsonwireline_area_2));
}
