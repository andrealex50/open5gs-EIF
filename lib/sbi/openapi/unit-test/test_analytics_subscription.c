...
analytics_subscription_t* instantiate_analytics_subscription(int include_optional);
...
void test_analytics_subscription(int include_optional) {
    analytics_subscription_t* analytics_subscription_1 = instantiate_analytics_subscription(include_optional);

	cJSON* jsonanalytics_subscription_1 = analytics_subscription_convertToJSON(analytics_subscription_1);
	printf("analytics_subscription :\n%s\n", cJSON_Print(jsonanalytics_subscription_1));
	analytics_subscription_t* analytics_subscription_2 = analytics_subscription_parseFromJSON(jsonanalytics_subscription_1);
	cJSON* jsonanalytics_subscription_2 = analytics_subscription_convertToJSON(analytics_subscription_2);
