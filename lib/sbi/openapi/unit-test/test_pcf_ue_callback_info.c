...
void test_pcf_ue_callback_info(int include_optional) {
    pcf_ue_callback_info_t* pcf_ue_callback_info_1 = instantiate_pcf_ue_callback_info(include_optional);

	cJSON* jsonpcf_ue_callback_info_1 = pcf_ue_callback_info_convertToJSON(pcf_ue_callback_info_1);
	printf("pcf_ue_callback_info :\n%s\n", cJSON_Print(jsonpcf_ue_callback_info_1));
	pcf_ue_callback_info_t* pcf_ue_callback_info_2 = pcf_ue_callback_info_parseFromJSON(jsonpcf_ue_callback_info_1);
	cJSON* jsonpcf_ue_callback_info_2 = pcf_ue_callback_info_convertToJSON(pcf_ue_callback_info_2);
