...
void test_npn_access_info(int include_optional) {
    npn_access_info_t* npn_access_info_1 = instantiate_npn_access_info(include_optional);

	cJSON* jsonnpn_access_info_1 = npn_access_info_convertToJSON(npn_access_info_1);
	printf("npn_access_info :\n%s\n", cJSON_Print(jsonnpn_access_info_1));
	npn_access_info_t* npn_access_info_2 = npn_access_info_parseFromJSON(jsonnpn_access_info_1);
	cJSON* jsonnpn_access_info_2 = npn_access_info_convertToJSON(npn_access_info_2);
