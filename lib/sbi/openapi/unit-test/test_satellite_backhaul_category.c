...
satellite_backhaul_category_t* instantiate_satellite_backhaul_category(int include_optional);
...
satellite_backhaul_category_t* instantiate_satellite_backhaul_category(int include_optional) {
  ...
  if (include_optional) {
    satellite_backhaul_category = satellite_backhaul_category_create(
    );
  } else {
    satellite_backhaul_category = satellite_backhaul_category_create(
    );
...
void test_satellite_backhaul_category(int include_optional) {
    satellite_backhaul_category_t* satellite_backhaul_category_1 = instantiate_satellite_backhaul_category(include_optional);

	cJSON* jsonsatellite_backhaul_category_1 = satellite_backhaul_category_convertToJSON(satellite_backhaul_category_1);
	printf("satellite_backhaul_category :\n%s\n", cJSON_Print(jsonsatellite_backhaul_category_1));
	satellite_backhaul_category_t* satellite_backhaul_category_2 = satellite_backhaul_category_parseFromJSON(jsonsatellite_backhaul_category_1);
	cJSON* jsonsatellite_backhaul_category_2 = satellite_backhaul_category_convertToJSON(satellite_backhaul_category_2);
