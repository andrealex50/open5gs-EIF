...
void test_notification_method(int include_optional) {
    notification_method_t* notification_method_1 = instantiate_notification_method(include_optional);

	cJSON* jsonnotification_method_1 = notification_method_convertToJSON(notification_method_1);
	printf("notification_method :\n%s\n", cJSON_Print(jsonnotification_method_1));
	notification_method_t* notification_method_2 = notification_method_parseFromJSON(jsonnotification_method_1);
	cJSON* jsonnotification_method_2 = notification_method_convertToJSON(notification_method_2);
