...
void test_notification_method_1(int include_optional) {
    notification_method_1_t* notification_method_1_1 = instantiate_notification_method_1(include_optional);

	cJSON* jsonnotification_method_1_1 = notification_method_1_convertToJSON(notification_method_1_1);
	printf("notification_method_1 :\n%s\n", cJSON_Print(jsonnotification_method_1_1));
	notification_method_1_t* notification_method_1_2 = notification_method_1_parseFromJSON(jsonnotification_method_1_1);
	cJSON* jsonnotification_method_1_2 = notification_method_1_convertToJSON(notification_method_1_2);
