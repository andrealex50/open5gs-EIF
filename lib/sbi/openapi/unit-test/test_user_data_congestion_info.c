...
user_data_congestion_info_t* instantiate_user_data_congestion_info(int include_optional);
...
void test_user_data_congestion_info(int include_optional) {
    user_data_congestion_info_t* user_data_congestion_info_1 = instantiate_user_data_congestion_info(include_optional);

	cJSON* jsonuser_data_congestion_info_1 = user_data_congestion_info_convertToJSON(user_data_congestion_info_1);
	printf("user_data_congestion_info :\n%s\n", cJSON_Print(jsonuser_data_congestion_info_1));
	user_data_congestion_info_t* user_data_congestion_info_2 = user_data_congestion_info_parseFromJSON(jsonuser_data_congestion_info_1);
	cJSON* jsonuser_data_congestion_info_2 = user_data_congestion_info_convertToJSON(user_data_congestion_info_2);
