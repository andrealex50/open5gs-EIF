...
void test_analytics_metadata(int include_optional) {
    analytics_metadata_t* analytics_metadata_1 = instantiate_analytics_metadata(include_optional);

	cJSON* jsonanalytics_metadata_1 = analytics_metadata_convertToJSON(analytics_metadata_1);
	printf("analytics_metadata :\n%s\n", cJSON_Print(jsonanalytics_metadata_1));
	analytics_metadata_t* analytics_metadata_2 = analytics_metadata_parseFromJSON(jsonanalytics_metadata_1);
	cJSON* jsonanalytics_metadata_2 = analytics_metadata_convertToJSON(analytics_metadata_2);
