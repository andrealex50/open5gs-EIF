...
sess_inact_timer_for_ue_comm_t* instantiate_sess_inact_timer_for_ue_comm(int include_optional);
...
sess_inact_timer_for_ue_comm_t* instantiate_sess_inact_timer_for_ue_comm(int include_optional) {
  ...
  if (include_optional) {
    sess_inact_timer_for_ue_comm = sess_inact_timer_for_ue_comm_create(
      0,
      56
    );
  } else {
...
void test_sess_inact_timer_for_ue_comm(int include_optional) {
    sess_inact_timer_for_ue_comm_t* sess_inact_timer_for_ue_comm_1 = instantiate_sess_inact_timer_for_ue_comm(include_optional);

	cJSON* jsonsess_inact_timer_for_ue_comm_1 = sess_inact_timer_for_ue_comm_convertToJSON(sess_inact_timer_for_ue_comm_1);
	printf("sess_inact_timer_for_ue_comm :\n%s\n", cJSON_Print(jsonsess_inact_timer_for_ue_comm_1));
	sess_inact_timer_for_ue_comm_t* sess_inact_timer_for_ue_comm_2 = sess_inact_timer_for_ue_comm_parseFromJSON(jsonsess_inact_timer_for_ue_comm_1);
	cJSON* jsonsess_inact_timer_for_ue_comm_2 = sess_inact_timer_for_ue_comm_convertToJSON(sess_inact_timer_for_ue_comm_2);
