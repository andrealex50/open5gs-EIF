...
void test_polygon_all_of(int include_optional) {
    polygon_all_of_t* polygon_all_of_1 = instantiate_polygon_all_of(include_optional);

	cJSON* jsonpolygon_all_of_1 = polygon_all_of_convertToJSON(polygon_all_of_1);
	printf("polygon_all_of :\n%s\n", cJSON_Print(jsonpolygon_all_of_1));
	polygon_all_of_t* polygon_all_of_2 = polygon_all_of_parseFromJSON(jsonpolygon_all_of_1);
	cJSON* jsonpolygon_all_of_2 = polygon_all_of_convertToJSON(polygon_all_of_2);
