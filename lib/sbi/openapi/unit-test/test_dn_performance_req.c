...
void test_dn_performance_req(int include_optional) {
    dn_performance_req_t* dn_performance_req_1 = instantiate_dn_performance_req(include_optional);

	cJSON* jsondn_performance_req_1 = dn_performance_req_convertToJSON(dn_performance_req_1);
	printf("dn_performance_req :\n%s\n", cJSON_Print(jsondn_performance_req_1));
	dn_performance_req_t* dn_performance_req_2 = dn_performance_req_parseFromJSON(jsondn_performance_req_1);
	cJSON* jsondn_performance_req_2 = dn_performance_req_convertToJSON(dn_performance_req_2);
