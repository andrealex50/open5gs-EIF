...
void test_pws_information(int include_optional) {
    pws_information_t* pws_information_1 = instantiate_pws_information(include_optional);

	cJSON* jsonpws_information_1 = pws_information_convertToJSON(pws_information_1);
	printf("pws_information :\n%s\n", cJSON_Print(jsonpws_information_1));
	pws_information_t* pws_information_2 = pws_information_parseFromJSON(jsonpws_information_1);
	cJSON* jsonpws_information_2 = pws_information_convertToJSON(pws_information_2);
