...
positioning_method_mdt_t* instantiate_positioning_method_mdt(int include_optional);
...
void test_positioning_method_mdt(int include_optional) {
    positioning_method_mdt_t* positioning_method_mdt_1 = instantiate_positioning_method_mdt(include_optional);

	cJSON* jsonpositioning_method_mdt_1 = positioning_method_mdt_convertToJSON(positioning_method_mdt_1);
	printf("positioning_method_mdt :\n%s\n", cJSON_Print(jsonpositioning_method_mdt_1));
	positioning_method_mdt_t* positioning_method_mdt_2 = positioning_method_mdt_parseFromJSON(jsonpositioning_method_mdt_1);
	cJSON* jsonpositioning_method_mdt_2 = positioning_method_mdt_convertToJSON(positioning_method_mdt_2);
