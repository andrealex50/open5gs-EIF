...
dataset_statistical_property_t* instantiate_dataset_statistical_property(int include_optional);
...
dataset_statistical_property_t* instantiate_dataset_statistical_property(int include_optional) {
  ...
  if (include_optional) {
    dataset_statistical_property = dataset_statistical_property_create(
    );
  } else {
    dataset_statistical_property = dataset_statistical_property_create(
    );
...
void test_dataset_statistical_property(int include_optional) {
    dataset_statistical_property_t* dataset_statistical_property_1 = instantiate_dataset_statistical_property(include_optional);

	cJSON* jsondataset_statistical_property_1 = dataset_statistical_property_convertToJSON(dataset_statistical_property_1);
	printf("dataset_statistical_property :\n%s\n", cJSON_Print(jsondataset_statistical_property_1));
	dataset_statistical_property_t* dataset_statistical_property_2 = dataset_statistical_property_parseFromJSON(jsondataset_statistical_property_1);
	cJSON* jsondataset_statistical_property_2 = dataset_statistical_property_convertToJSON(dataset_statistical_property_2);
