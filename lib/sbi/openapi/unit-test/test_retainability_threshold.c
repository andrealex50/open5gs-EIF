...
retainability_threshold_t* instantiate_retainability_threshold(int include_optional);
...
void test_retainability_threshold(int include_optional) {
    retainability_threshold_t* retainability_threshold_1 = instantiate_retainability_threshold(include_optional);

	cJSON* jsonretainability_threshold_1 = retainability_threshold_convertToJSON(retainability_threshold_1);
	printf("retainability_threshold :\n%s\n", cJSON_Print(jsonretainability_threshold_1));
	retainability_threshold_t* retainability_threshold_2 = retainability_threshold_parseFromJSON(jsonretainability_threshold_1);
	cJSON* jsonretainability_threshold_2 = retainability_threshold_convertToJSON(retainability_threshold_2);
