...
scheduled_communication_type_t* instantiate_scheduled_communication_type(int include_optional);
...
scheduled_communication_type_t* instantiate_scheduled_communication_type(int include_optional) {
  ...
  if (include_optional) {
    scheduled_communication_type = scheduled_communication_type_create(
    );
  } else {
    scheduled_communication_type = scheduled_communication_type_create(
    );
...
void test_scheduled_communication_type(int include_optional) {
    scheduled_communication_type_t* scheduled_communication_type_1 = instantiate_scheduled_communication_type(include_optional);

	cJSON* jsonscheduled_communication_type_1 = scheduled_communication_type_convertToJSON(scheduled_communication_type_1);
	printf("scheduled_communication_type :\n%s\n", cJSON_Print(jsonscheduled_communication_type_1));
	scheduled_communication_type_t* scheduled_communication_type_2 = scheduled_communication_type_parseFromJSON(jsonscheduled_communication_type_1);
	cJSON* jsonscheduled_communication_type_2 = scheduled_communication_type_convertToJSON(scheduled_communication_type_2);
