...
void test_pc5_qos_flow_item(int include_optional) {
    pc5_qos_flow_item_t* pc5_qos_flow_item_1 = instantiate_pc5_qos_flow_item(include_optional);

	cJSON* jsonpc5_qos_flow_item_1 = pc5_qos_flow_item_convertToJSON(pc5_qos_flow_item_1);
	printf("pc5_qos_flow_item :\n%s\n", cJSON_Print(jsonpc5_qos_flow_item_1));
	pc5_qos_flow_item_t* pc5_qos_flow_item_2 = pc5_qos_flow_item_parseFromJSON(jsonpc5_qos_flow_item_1);
	cJSON* jsonpc5_qos_flow_item_2 = pc5_qos_flow_item_convertToJSON(pc5_qos_flow_item_2);
