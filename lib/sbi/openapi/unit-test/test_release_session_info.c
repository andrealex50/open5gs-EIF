...
void test_release_session_info(int include_optional) {
    release_session_info_t* release_session_info_1 = instantiate_release_session_info(include_optional);

	cJSON* jsonrelease_session_info_1 = release_session_info_convertToJSON(release_session_info_1);
	printf("release_session_info :\n%s\n", cJSON_Print(jsonrelease_session_info_1));
	release_session_info_t* release_session_info_2 = release_session_info_parseFromJSON(jsonrelease_session_info_1);
	cJSON* jsonrelease_session_info_2 = release_session_info_convertToJSON(release_session_info_2);
