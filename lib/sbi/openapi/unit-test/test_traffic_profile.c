...
void test_traffic_profile(int include_optional) {
    traffic_profile_t* traffic_profile_1 = instantiate_traffic_profile(include_optional);

	cJSON* jsontraffic_profile_1 = traffic_profile_convertToJSON(traffic_profile_1);
	printf("traffic_profile :\n%s\n", cJSON_Print(jsontraffic_profile_1));
	traffic_profile_t* traffic_profile_2 = traffic_profile_parseFromJSON(jsontraffic_profile_1);
	cJSON* jsontraffic_profile_2 = traffic_profile_convertToJSON(traffic_profile_2);
