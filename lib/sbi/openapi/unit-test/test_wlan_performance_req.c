...
void test_wlan_performance_req(int include_optional) {
    wlan_performance_req_t* wlan_performance_req_1 = instantiate_wlan_performance_req(include_optional);

	cJSON* jsonwlan_performance_req_1 = wlan_performance_req_convertToJSON(wlan_performance_req_1);
	printf("wlan_performance_req :\n%s\n", cJSON_Print(jsonwlan_performance_req_1));
	wlan_performance_req_t* wlan_performance_req_2 = wlan_performance_req_parseFromJSON(jsonwlan_performance_req_1);
	cJSON* jsonwlan_performance_req_2 = wlan_performance_req_convertToJSON(wlan_performance_req_2);
