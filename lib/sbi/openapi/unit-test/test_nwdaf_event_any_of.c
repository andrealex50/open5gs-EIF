...
void test_nwdaf_event_any_of(int include_optional) {
    nwdaf_event_any_of_t* nwdaf_event_any_of_1 = instantiate_nwdaf_event_any_of(include_optional);

	cJSON* jsonnwdaf_event_any_of_1 = nwdaf_event_any_of_convertToJSON(nwdaf_event_any_of_1);
	printf("nwdaf_event_any_of :\n%s\n", cJSON_Print(jsonnwdaf_event_any_of_1));
	nwdaf_event_any_of_t* nwdaf_event_any_of_2 = nwdaf_event_any_of_parseFromJSON(jsonnwdaf_event_any_of_1);
	cJSON* jsonnwdaf_event_any_of_2 = nwdaf_event_any_of_convertToJSON(nwdaf_event_any_of_2);
