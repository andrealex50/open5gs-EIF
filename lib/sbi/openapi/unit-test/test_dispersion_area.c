...
void test_dispersion_area(int include_optional) {
    dispersion_area_t* dispersion_area_1 = instantiate_dispersion_area(include_optional);

	cJSON* jsondispersion_area_1 = dispersion_area_convertToJSON(dispersion_area_1);
	printf("dispersion_area :\n%s\n", cJSON_Print(jsondispersion_area_1));
	dispersion_area_t* dispersion_area_2 = dispersion_area_parseFromJSON(jsondispersion_area_1);
	cJSON* jsondispersion_area_2 = dispersion_area_convertToJSON(dispersion_area_2);
