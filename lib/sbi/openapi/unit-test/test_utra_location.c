...
void test_utra_location(int include_optional) {
    utra_location_t* utra_location_1 = instantiate_utra_location(include_optional);

	cJSON* jsonutra_location_1 = utra_location_convertToJSON(utra_location_1);
	printf("utra_location :\n%s\n", cJSON_Print(jsonutra_location_1));
	utra_location_t* utra_location_2 = utra_location_parseFromJSON(jsonutra_location_1);
	cJSON* jsonutra_location_2 = utra_location_convertToJSON(utra_location_2);
	printf("repeating utra_location:\n%s\n", cJSON_Print(jsonutra_location_2));
}
