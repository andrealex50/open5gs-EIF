...
void test_dispersion_type(int include_optional) {
    dispersion_type_t* dispersion_type_1 = instantiate_dispersion_type(include_optional);

	cJSON* jsondispersion_type_1 = dispersion_type_convertToJSON(dispersion_type_1);
	printf("dispersion_type :\n%s\n", cJSON_Print(jsondispersion_type_1));
	dispersion_type_t* dispersion_type_2 = dispersion_type_parseFromJSON(jsondispersion_type_1);
	cJSON* jsondispersion_type_2 = dispersion_type_convertToJSON(dispersion_type_2);
