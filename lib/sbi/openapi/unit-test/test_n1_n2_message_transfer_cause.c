...
n1_n2_message_transfer_cause_t* instantiate_n1_n2_message_transfer_cause(int include_optional);
...
n1_n2_message_transfer_cause_t* instantiate_n1_n2_message_transfer_cause(int include_optional) {
  ...
  if (include_optional) {
    n1_n2_message_transfer_cause = n1_n2_message_transfer_cause_create(
    );
  } else {
    n1_n2_message_transfer_cause = n1_n2_message_transfer_cause_create(
    );
...
void test_n1_n2_message_transfer_cause(int include_optional) {
    n1_n2_message_transfer_cause_t* n1_n2_message_transfer_cause_1 = instantiate_n1_n2_message_transfer_cause(include_optional);

	cJSON* jsonn1_n2_message_transfer_cause_1 = n1_n2_message_transfer_cause_convertToJSON(n1_n2_message_transfer_cause_1);
	printf("n1_n2_message_transfer_cause :\n%s\n", cJSON_Print(jsonn1_n2_message_transfer_cause_1));
	n1_n2_message_transfer_cause_t* n1_n2_message_transfer_cause_2 = n1_n2_message_transfer_cause_parseFromJSON(jsonn1_n2_message_transfer_cause_1);
	cJSON* jsonn1_n2_message_transfer_cause_2 = n1_n2_message_transfer_cause_convertToJSON(n1_n2_message_transfer_cause_2);
