...
analytics_metadata_any_of_t* instantiate_analytics_metadata_any_of(int include_optional);
...
void test_analytics_metadata_any_of(int include_optional) {
    analytics_metadata_any_of_t* analytics_metadata_any_of_1 = instantiate_analytics_metadata_any_of(include_optional);

	cJSON* jsonanalytics_metadata_any_of_1 = analytics_metadata_any_of_convertToJSON(analytics_metadata_any_of_1);
	printf("analytics_metadata_any_of :\n%s\n", cJSON_Print(jsonanalytics_metadata_any_of_1));
	analytics_metadata_any_of_t* analytics_metadata_any_of_2 = analytics_metadata_any_of_parseFromJSON(jsonanalytics_metadata_any_of_1);
	cJSON* jsonanalytics_metadata_any_of_2 = analytics_metadata_any_of_convertToJSON(analytics_metadata_any_of_2);
