...
dispersion_type_one_of_t* instantiate_dispersion_type_one_of(int include_optional);
...
void test_dispersion_type_one_of(int include_optional) {
    dispersion_type_one_of_t* dispersion_type_one_of_1 = instantiate_dispersion_type_one_of(include_optional);

	cJSON* jsondispersion_type_one_of_1 = dispersion_type_one_of_convertToJSON(dispersion_type_one_of_1);
	printf("dispersion_type_one_of :\n%s\n", cJSON_Print(jsondispersion_type_one_of_1));
	dispersion_type_one_of_t* dispersion_type_one_of_2 = dispersion_type_one_of_parseFromJSON(jsondispersion_type_one_of_1);
	cJSON* jsondispersion_type_one_of_2 = dispersion_type_one_of_convertToJSON(dispersion_type_one_of_2);
