...
void test_preemption_capability(int include_optional) {
    preemption_capability_t* preemption_capability_1 = instantiate_preemption_capability(include_optional);

	cJSON* jsonpreemption_capability_1 = preemption_capability_convertToJSON(preemption_capability_1);
	printf("preemption_capability :\n%s\n", cJSON_Print(jsonpreemption_capability_1));
	preemption_capability_t* preemption_capability_2 = preemption_capability_parseFromJSON(jsonpreemption_capability_1);
	cJSON* jsonpreemption_capability_2 = preemption_capability_convertToJSON(preemption_capability_2);
