...
scheduled_communication_time_t* instantiate_scheduled_communication_time(int include_optional);
...
scheduled_communication_time_t* instantiate_scheduled_communication_time(int include_optional) {
  ...
  if (include_optional) {
    scheduled_communication_time = scheduled_communication_time_create(
      list_createList(),
      "0",
      "0"
    );
...
void test_scheduled_communication_time(int include_optional) {
    scheduled_communication_time_t* scheduled_communication_time_1 = instantiate_scheduled_communication_time(include_optional);

	cJSON* jsonscheduled_communication_time_1 = scheduled_communication_time_convertToJSON(scheduled_communication_time_1);
	printf("scheduled_communication_time :\n%s\n", cJSON_Print(jsonscheduled_communication_time_1));
	scheduled_communication_time_t* scheduled_communication_time_2 = scheduled_communication_time_parseFromJSON(jsonscheduled_communication_time_1);
	cJSON* jsonscheduled_communication_time_2 = scheduled_communication_time_convertToJSON(scheduled_communication_time_2);
