...
void test_amf_event_type(int include_optional) {
    amf_event_type_t* amf_event_type_1 = instantiate_amf_event_type(include_optional);

	cJSON* jsonamf_event_type_1 = amf_event_type_convertToJSON(amf_event_type_1);
	printf("amf_event_type :\n%s\n", cJSON_Print(jsonamf_event_type_1));
	amf_event_type_t* amf_event_type_2 = amf_event_type_parseFromJSON(jsonamf_event_type_1);
	cJSON* jsonamf_event_type_2 = amf_event_type_convertToJSON(amf_event_type_2);
