...
void test_pdu_session_type(int include_optional) {
    pdu_session_type_t* pdu_session_type_1 = instantiate_pdu_session_type(include_optional);

	cJSON* jsonpdu_session_type_1 = pdu_session_type_convertToJSON(pdu_session_type_1);
	printf("pdu_session_type :\n%s\n", cJSON_Print(jsonpdu_session_type_1));
	pdu_session_type_t* pdu_session_type_2 = pdu_session_type_parseFromJSON(jsonpdu_session_type_1);
	cJSON* jsonpdu_session_type_2 = pdu_session_type_convertToJSON(pdu_session_type_2);
