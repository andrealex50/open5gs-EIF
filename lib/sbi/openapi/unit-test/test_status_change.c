...
void test_status_change(int include_optional) {
    status_change_t* status_change_1 = instantiate_status_change(include_optional);

	cJSON* jsonstatus_change_1 = status_change_convertToJSON(status_change_1);
	printf("status_change :\n%s\n", cJSON_Print(jsonstatus_change_1));
	status_change_t* status_change_2 = status_change_parseFromJSON(jsonstatus_change_1);
	cJSON* jsonstatus_change_2 = status_change_convertToJSON(status_change_2);
	printf("repeating status_change:\n%s\n", cJSON_Print(jsonstatus_change_2));
}
