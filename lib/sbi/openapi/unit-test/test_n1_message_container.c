...
void test_n1_message_container(int include_optional) {
    n1_message_container_t* n1_message_container_1 = instantiate_n1_message_container(include_optional);

	cJSON* jsonn1_message_container_1 = n1_message_container_convertToJSON(n1_message_container_1);
	printf("n1_message_container :\n%s\n", cJSON_Print(jsonn1_message_container_1));
	n1_message_container_t* n1_message_container_2 = n1_message_container_parseFromJSON(jsonn1_message_container_1);
	cJSON* jsonn1_message_container_2 = n1_message_container_convertToJSON(n1_message_container_2);
