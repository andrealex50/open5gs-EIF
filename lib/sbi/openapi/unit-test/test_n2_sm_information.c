...
void test_n2_sm_information(int include_optional) {
    n2_sm_information_t* n2_sm_information_1 = instantiate_n2_sm_information(include_optional);

	cJSON* jsonn2_sm_information_1 = n2_sm_information_convertToJSON(n2_sm_information_1);
	printf("n2_sm_information :\n%s\n", cJSON_Print(jsonn2_sm_information_1));
	n2_sm_information_t* n2_sm_information_2 = n2_sm_information_parseFromJSON(jsonn2_sm_information_1);
	cJSON* jsonn2_sm_information_2 = n2_sm_information_convertToJSON(n2_sm_information_2);
