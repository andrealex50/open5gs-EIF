...
void test_geographical_area(int include_optional) {
    geographical_area_t* geographical_area_1 = instantiate_geographical_area(include_optional);

	cJSON* jsongeographical_area_1 = geographical_area_convertToJSON(geographical_area_1);
	printf("geographical_area :\n%s\n", cJSON_Print(jsongeographical_area_1));
	geographical_area_t* geographical_area_2 = geographical_area_parseFromJSON(jsongeographical_area_1);
	cJSON* jsongeographical_area_2 = geographical_area_convertToJSON(geographical_area_2);
