...
n2_information_transfer_error_t* instantiate_n2_information_transfer_error(int include_optional);
...
n2_information_transfer_error_t* instantiate_n2_information_transfer_error(int include_optional) {
  ...
  if (include_optional) {
    n2_information_transfer_error = n2_information_transfer_error_create(
...
void test_n2_information_transfer_error(int include_optional) {
    n2_information_transfer_error_t* n2_information_transfer_error_1 = instantiate_n2_information_transfer_error(include_optional);

	cJSON* jsonn2_information_transfer_error_1 = n2_information_transfer_error_convertToJSON(n2_information_transfer_error_1);
	printf("n2_information_transfer_error :\n%s\n", cJSON_Print(jsonn2_information_transfer_error_1));
	n2_information_transfer_error_t* n2_information_transfer_error_2 = n2_information_transfer_error_parseFromJSON(jsonn2_information_transfer_error_1);
	cJSON* jsonn2_information_transfer_error_2 = n2_information_transfer_error_convertToJSON(n2_information_transfer_error_2);
