...
void test_target_ue_information(int include_optional) {
    target_ue_information_t* target_ue_information_1 = instantiate_target_ue_information(include_optional);

	cJSON* jsontarget_ue_information_1 = target_ue_information_convertToJSON(target_ue_information_1);
	printf("target_ue_information :\n%s\n", cJSON_Print(jsontarget_ue_information_1));
	target_ue_information_t* target_ue_information_2 = target_ue_information_parseFromJSON(jsontarget_ue_information_1);
	cJSON* jsontarget_ue_information_2 = target_ue_information_convertToJSON(target_ue_information_2);
