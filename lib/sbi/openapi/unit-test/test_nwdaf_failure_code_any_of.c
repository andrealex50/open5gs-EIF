...
nwdaf_failure_code_any_of_t* instantiate_nwdaf_failure_code_any_of(int include_optional);
...
void test_nwdaf_failure_code_any_of(int include_optional) {
    nwdaf_failure_code_any_of_t* nwdaf_failure_code_any_of_1 = instantiate_nwdaf_failure_code_any_of(include_optional);

	cJSON* jsonnwdaf_failure_code_any_of_1 = nwdaf_failure_code_any_of_convertToJSON(nwdaf_failure_code_any_of_1);
	printf("nwdaf_failure_code_any_of :\n%s\n", cJSON_Print(jsonnwdaf_failure_code_any_of_1));
	nwdaf_failure_code_any_of_t* nwdaf_failure_code_any_of_2 = nwdaf_failure_code_any_of_parseFromJSON(jsonnwdaf_failure_code_any_of_1);
	cJSON* jsonnwdaf_failure_code_any_of_2 = nwdaf_failure_code_any_of_convertToJSON(nwdaf_failure_code_any_of_2);
