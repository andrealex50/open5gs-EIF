...
void test_accuracy_any_of(int include_optional) {
    accuracy_any_of_t* accuracy_any_of_1 = instantiate_accuracy_any_of(include_optional);

	cJSON* jsonaccuracy_any_of_1 = accuracy_any_of_convertToJSON(accuracy_any_of_1);
	printf("accuracy_any_of :\n%s\n", cJSON_Print(jsonaccuracy_any_of_1));
	accuracy_any_of_t* accuracy_any_of_2 = accuracy_any_of_parseFromJSON(jsonaccuracy_any_of_1);
	cJSON* jsonaccuracy_any_of_2 = accuracy_any_of_convertToJSON(accuracy_any_of_2);
