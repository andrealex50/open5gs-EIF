...
void test_top_application(int include_optional) {
    top_application_t* top_application_1 = instantiate_top_application(include_optional);

	cJSON* jsontop_application_1 = top_application_convertToJSON(top_application_1);
	printf("top_application :\n%s\n", cJSON_Print(jsontop_application_1));
	top_application_t* top_application_2 = top_application_parseFromJSON(jsontop_application_1);
	cJSON* jsontop_application_2 = top_application_convertToJSON(top_application_2);
