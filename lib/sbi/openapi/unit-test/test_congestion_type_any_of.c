...
congestion_type_any_of_t* instantiate_congestion_type_any_of(int include_optional);
...
void test_congestion_type_any_of(int include_optional) {
    congestion_type_any_of_t* congestion_type_any_of_1 = instantiate_congestion_type_any_of(include_optional);

	cJSON* jsoncongestion_type_any_of_1 = congestion_type_any_of_convertToJSON(congestion_type_any_of_1);
	printf("congestion_type_any_of :\n%s\n", cJSON_Print(jsoncongestion_type_any_of_1));
	congestion_type_any_of_t* congestion_type_any_of_2 = congestion_type_any_of_parseFromJSON(jsoncongestion_type_any_of_1);
	cJSON* jsoncongestion_type_any_of_2 = congestion_type_any_of_convertToJSON(congestion_type_any_of_2);
