...
void test_pws_error_data(int include_optional) {
    pws_error_data_t* pws_error_data_1 = instantiate_pws_error_data(include_optional);

	cJSON* jsonpws_error_data_1 = pws_error_data_convertToJSON(pws_error_data_1);
	printf("pws_error_data :\n%s\n", cJSON_Print(jsonpws_error_data_1));
	pws_error_data_t* pws_error_data_2 = pws_error_data_parseFromJSON(jsonpws_error_data_1);
	cJSON* jsonpws_error_data_2 = pws_error_data_convertToJSON(pws_error_data_2);
