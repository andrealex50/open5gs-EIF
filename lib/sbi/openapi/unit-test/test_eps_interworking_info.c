...
void test_eps_interworking_info(int include_optional) {
    eps_interworking_info_t* eps_interworking_info_1 = instantiate_eps_interworking_info(include_optional);

	cJSON* jsoneps_interworking_info_1 = eps_interworking_info_convertToJSON(eps_interworking_info_1);
	printf("eps_interworking_info :\n%s\n", cJSON_Print(jsoneps_interworking_info_1));
	eps_interworking_info_t* eps_interworking_info_2 = eps_interworking_info_parseFromJSON(jsoneps_interworking_info_1);
	cJSON* jsoneps_interworking_info_2 = eps_interworking_info_convertToJSON(eps_interworking_info_2);
