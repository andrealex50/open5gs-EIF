...
n2_info_notification_rsp_data_t* instantiate_n2_info_notification_rsp_data(int include_optional);
...
n2_info_notification_rsp_data_t* instantiate_n2_info_notification_rsp_data(int include_optional) {
  ...
  if (include_optional) {
    n2_info_notification_rsp_data = n2_info_notification_rsp_data_create(
      list_createList()
    );
  } else {
    n2_info_notification_rsp_data = n2_info_notification_rsp_data_create(
...
void test_n2_info_notification_rsp_data(int include_optional) {
    n2_info_notification_rsp_data_t* n2_info_notification_rsp_data_1 = instantiate_n2_info_notification_rsp_data(include_optional);

	cJSON* jsonn2_info_notification_rsp_data_1 = n2_info_notification_rsp_data_convertToJSON(n2_info_notification_rsp_data_1);
	printf("n2_info_notification_rsp_data :\n%s\n", cJSON_Print(jsonn2_info_notification_rsp_data_1));
	n2_info_notification_rsp_data_t* n2_info_notification_rsp_data_2 = n2_info_notification_rsp_data_parseFromJSON(jsonn2_info_notification_rsp_data_1);
	cJSON* jsonn2_info_notification_rsp_data_2 = n2_info_notification_rsp_data_convertToJSON(n2_info_notification_rsp_data_2);
