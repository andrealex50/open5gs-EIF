...
void test_exception_id_any_of(int include_optional) {
    exception_id_any_of_t* exception_id_any_of_1 = instantiate_exception_id_any_of(include_optional);

	cJSON* jsonexception_id_any_of_1 = exception_id_any_of_convertToJSON(exception_id_any_of_1);
	printf("exception_id_any_of :\n%s\n", cJSON_Print(jsonexception_id_any_of_1));
	exception_id_any_of_t* exception_id_any_of_2 = exception_id_any_of_parseFromJSON(jsonexception_id_any_of_1);
	cJSON* jsonexception_id_any_of_2 = exception_id_any_of_convertToJSON(exception_id_any_of_2);
