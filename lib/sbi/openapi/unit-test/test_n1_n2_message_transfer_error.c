...
n1_n2_message_transfer_error_t* instantiate_n1_n2_message_transfer_error(int include_optional);
...
n1_n2_message_transfer_error_t* instantiate_n1_n2_message_transfer_error(int include_optional) {
  ...
  if (include_optional) {
    n1_n2_message_transfer_error = n1_n2_message_transfer_error_create(
...
void test_n1_n2_message_transfer_error(int include_optional) {
    n1_n2_message_transfer_error_t* n1_n2_message_transfer_error_1 = instantiate_n1_n2_message_transfer_error(include_optional);

	cJSON* jsonn1_n2_message_transfer_error_1 = n1_n2_message_transfer_error_convertToJSON(n1_n2_message_transfer_error_1);
	printf("n1_n2_message_transfer_error :\n%s\n", cJSON_Print(jsonn1_n2_message_transfer_error_1));
	n1_n2_message_transfer_error_t* n1_n2_message_transfer_error_2 = n1_n2_message_transfer_error_parseFromJSON(jsonn1_n2_message_transfer_error_1);
	cJSON* jsonn1_n2_message_transfer_error_2 = n1_n2_message_transfer_error_convertToJSON(n1_n2_message_transfer_error_2);
