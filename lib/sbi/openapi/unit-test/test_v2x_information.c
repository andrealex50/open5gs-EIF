...
void test_v2x_information(int include_optional) {
    v2x_information_t* v2x_information_1 = instantiate_v2x_information(include_optional);

	cJSON* jsonv2x_information_1 = v2x_information_convertToJSON(v2x_information_1);
	printf("v2x_information :\n%s\n", cJSON_Print(jsonv2x_information_1));
	v2x_information_t* v2x_information_2 = v2x_information_parseFromJSON(jsonv2x_information_1);
	cJSON* jsonv2x_information_2 = v2x_information_convertToJSON(v2x_information_2);
