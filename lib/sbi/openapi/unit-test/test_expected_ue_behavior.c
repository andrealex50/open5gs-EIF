...
void test_expected_ue_behavior(int include_optional) {
    expected_ue_behavior_t* expected_ue_behavior_1 = instantiate_expected_ue_behavior(include_optional);

	cJSON* jsonexpected_ue_behavior_1 = expected_ue_behavior_convertToJSON(expected_ue_behavior_1);
	printf("expected_ue_behavior :\n%s\n", cJSON_Print(jsonexpected_ue_behavior_1));
	expected_ue_behavior_t* expected_ue_behavior_2 = expected_ue_behavior_parseFromJSON(jsonexpected_ue_behavior_1);
	cJSON* jsonexpected_ue_behavior_2 = expected_ue_behavior_convertToJSON(expected_ue_behavior_2);
