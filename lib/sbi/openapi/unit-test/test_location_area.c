...
void test_location_area(int include_optional) {
    location_area_t* location_area_1 = instantiate_location_area(include_optional);

	cJSON* jsonlocation_area_1 = location_area_convertToJSON(location_area_1);
	printf("location_area :\n%s\n", cJSON_Print(jsonlocation_area_1));
	location_area_t* location_area_2 = location_area_parseFromJSON(jsonlocation_area_1);
	cJSON* jsonlocation_area_2 = location_area_convertToJSON(location_area_2);
	printf("repeating location_area:\n%s\n", cJSON_Print(jsonlocation_area_2));
}
