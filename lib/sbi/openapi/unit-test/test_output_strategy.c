...
void test_output_strategy(int include_optional) {
    output_strategy_t* output_strategy_1 = instantiate_output_strategy(include_optional);

	cJSON* jsonoutput_strategy_1 = output_strategy_convertToJSON(output_strategy_1);
	printf("output_strategy :\n%s\n", cJSON_Print(jsonoutput_strategy_1));
	output_strategy_t* output_strategy_2 = output_strategy_parseFromJSON(jsonoutput_strategy_1);
	cJSON* jsonoutput_strategy_2 = output_strategy_convertToJSON(output_strategy_2);
