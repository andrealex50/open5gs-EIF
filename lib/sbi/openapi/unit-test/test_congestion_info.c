...
void test_congestion_info(int include_optional) {
    congestion_info_t* congestion_info_1 = instantiate_congestion_info(include_optional);

	cJSON* jsoncongestion_info_1 = congestion_info_convertToJSON(congestion_info_1);
	printf("congestion_info :\n%s\n", cJSON_Print(jsoncongestion_info_1));
	congestion_info_t* congestion_info_2 = congestion_info_parseFromJSON(jsoncongestion_info_1);
	cJSON* jsoncongestion_info_2 = congestion_info_convertToJSON(congestion_info_2);
