...
as_time_distribution_param_t* instantiate_as_time_distribution_param(int include_optional);
...
void test_as_time_distribution_param(int include_optional) {
    as_time_distribution_param_t* as_time_distribution_param_1 = instantiate_as_time_distribution_param(include_optional);

	cJSON* jsonas_time_distribution_param_1 = as_time_distribution_param_convertToJSON(as_time_distribution_param_1);
	printf("as_time_distribution_param :\n%s\n", cJSON_Print(jsonas_time_distribution_param_1));
	as_time_distribution_param_t* as_time_distribution_param_2 = as_time_distribution_param_parseFromJSON(jsonas_time_distribution_param_1);
	cJSON* jsonas_time_distribution_param_2 = as_time_distribution_param_convertToJSON(as_time_distribution_param_2);
