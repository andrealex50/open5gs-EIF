...
dispersion_class_one_of_t* instantiate_dispersion_class_one_of(int include_optional);
...
void test_dispersion_class_one_of(int include_optional) {
    dispersion_class_one_of_t* dispersion_class_one_of_1 = instantiate_dispersion_class_one_of(include_optional);

	cJSON* jsondispersion_class_one_of_1 = dispersion_class_one_of_convertToJSON(dispersion_class_one_of_1);
	printf("dispersion_class_one_of :\n%s\n", cJSON_Print(jsondispersion_class_one_of_1));
	dispersion_class_one_of_t* dispersion_class_one_of_2 = dispersion_class_one_of_parseFromJSON(jsondispersion_class_one_of_1);
	cJSON* jsondispersion_class_one_of_2 = dispersion_class_one_of_convertToJSON(dispersion_class_one_of_2);
