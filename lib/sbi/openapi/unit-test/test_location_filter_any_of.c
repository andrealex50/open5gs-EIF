...
location_filter_any_of_t* instantiate_location_filter_any_of(int include_optional);
...
void test_location_filter_any_of(int include_optional) {
    location_filter_any_of_t* location_filter_any_of_1 = instantiate_location_filter_any_of(include_optional);

	cJSON* jsonlocation_filter_any_of_1 = location_filter_any_of_convertToJSON(location_filter_any_of_1);
	printf("location_filter_any_of :\n%s\n", cJSON_Print(jsonlocation_filter_any_of_1));
	location_filter_any_of_t* location_filter_any_of_2 = location_filter_any_of_parseFromJSON(jsonlocation_filter_any_of_1);
	cJSON* jsonlocation_filter_any_of_2 = location_filter_any_of_convertToJSON(location_filter_any_of_2);
