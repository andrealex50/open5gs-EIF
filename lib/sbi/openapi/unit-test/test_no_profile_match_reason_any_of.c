...
no_profile_match_reason_any_of_t* instantiate_no_profile_match_reason_any_of(int include_optional);
...
no_profile_match_reason_any_of_t* instantiate_no_profile_match_reason_any_of(int include_optional) {
  ...
  if (include_optional) {
    no_profile_match_reason_any_of = no_profile_match_reason_any_of_create(
    );
  } else {
    no_profile_match_reason_any_of = no_profile_match_reason_any_of_create(
    );
...
void test_no_profile_match_reason_any_of(int include_optional) {
    no_profile_match_reason_any_of_t* no_profile_match_reason_any_of_1 = instantiate_no_profile_match_reason_any_of(include_optional);

	cJSON* jsonno_profile_match_reason_any_of_1 = no_profile_match_reason_any_of_convertToJSON(no_profile_match_reason_any_of_1);
	printf("no_profile_match_reason_any_of :\n%s\n", cJSON_Print(jsonno_profile_match_reason_any_of_1));
	no_profile_match_reason_any_of_t* no_profile_match_reason_any_of_2 = no_profile_match_reason_any_of_parseFromJSON(jsonno_profile_match_reason_any_of_1);
	cJSON* jsonno_profile_match_reason_any_of_2 = no_profile_match_reason_any_of_convertToJSON(no_profile_match_reason_any_of_2);
