...
n1_n2_message_transfer_req_data_t* instantiate_n1_n2_message_transfer_req_data(int include_optional);
...
n1_n2_message_transfer_req_data_t* instantiate_n1_n2_message_transfer_req_data(int include_optional) {
  n1_n2_message_transfer_req_data_t* n1_n2_message_transfer_req_data = NULL;
  if (include_optional) {
    n1_n2_message_transfer_req_data = n1_n2_message_transfer_req_data_create(
...
void test_n1_n2_message_transfer_req_data(int include_optional) {
    n1_n2_message_transfer_req_data_t* n1_n2_message_transfer_req_data_1 = instantiate_n1_n2_message_transfer_req_data(include_optional);

	cJSON* jsonn1_n2_message_transfer_req_data_1 = n1_n2_message_transfer_req_data_convertToJSON(n1_n2_message_transfer_req_data_1);
	printf("n1_n2_message_transfer_req_data :\n%s\n", cJSON_Print(jsonn1_n2_message_transfer_req_data_1));
	n1_n2_message_transfer_req_data_t* n1_n2_message_transfer_req_data_2 = n1_n2_message_transfer_req_data_parseFromJSON(jsonn1_n2_message_transfer_req_data_1);
	cJSON* jsonn1_n2_message_transfer_req_data_2 = n1_n2_message_transfer_req_data_convertToJSON(n1_n2_message_transfer_req_data_2);
