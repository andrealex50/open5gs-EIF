...
ddd_traffic_descriptor_t* instantiate_ddd_traffic_descriptor(int include_optional);
...
void test_ddd_traffic_descriptor(int include_optional) {
    ddd_traffic_descriptor_t* ddd_traffic_descriptor_1 = instantiate_ddd_traffic_descriptor(include_optional);

	cJSON* jsonddd_traffic_descriptor_1 = ddd_traffic_descriptor_convertToJSON(ddd_traffic_descriptor_1);
	printf("ddd_traffic_descriptor :\n%s\n", cJSON_Print(jsonddd_traffic_descriptor_1));
	ddd_traffic_descriptor_t* ddd_traffic_descriptor_2 = ddd_traffic_descriptor_parseFromJSON(jsonddd_traffic_descriptor_1);
	cJSON* jsonddd_traffic_descriptor_2 = ddd_traffic_descriptor_convertToJSON(ddd_traffic_descriptor_2);
