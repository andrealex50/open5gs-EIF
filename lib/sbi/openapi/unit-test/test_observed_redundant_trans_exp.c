...
observed_redundant_trans_exp_t* instantiate_observed_redundant_trans_exp(int include_optional);
...
observed_redundant_trans_exp_t* instantiate_observed_redundant_trans_exp(int include_optional) {
  ...
  if (include_optional) {
    observed_redundant_trans_exp = observed_redundant_trans_exp_create(
      0,
      1.337,
      0,
      1.337,
...
void test_observed_redundant_trans_exp(int include_optional) {
    observed_redundant_trans_exp_t* observed_redundant_trans_exp_1 = instantiate_observed_redundant_trans_exp(include_optional);

	cJSON* jsonobserved_redundant_trans_exp_1 = observed_redundant_trans_exp_convertToJSON(observed_redundant_trans_exp_1);
	printf("observed_redundant_trans_exp :\n%s\n", cJSON_Print(jsonobserved_redundant_trans_exp_1));
	observed_redundant_trans_exp_t* observed_redundant_trans_exp_2 = observed_redundant_trans_exp_parseFromJSON(jsonobserved_redundant_trans_exp_1);
	cJSON* jsonobserved_redundant_trans_exp_2 = observed_redundant_trans_exp_convertToJSON(observed_redundant_trans_exp_2);
