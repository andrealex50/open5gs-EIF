...
void test_amf_event_area(int include_optional) {
    amf_event_area_t* amf_event_area_1 = instantiate_amf_event_area(include_optional);

	cJSON* jsonamf_event_area_1 = amf_event_area_convertToJSON(amf_event_area_1);
	printf("amf_event_area :\n%s\n", cJSON_Print(jsonamf_event_area_1));
	amf_event_area_t* amf_event_area_2 = amf_event_area_parseFromJSON(jsonamf_event_area_1);
	cJSON* jsonamf_event_area_2 = amf_event_area_convertToJSON(amf_event_area_2);
