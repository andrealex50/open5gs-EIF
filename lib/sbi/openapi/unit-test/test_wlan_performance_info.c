...
void test_wlan_performance_info(int include_optional) {
    wlan_performance_info_t* wlan_performance_info_1 = instantiate_wlan_performance_info(include_optional);

	cJSON* jsonwlan_performance_info_1 = wlan_performance_info_convertToJSON(wlan_performance_info_1);
	printf("wlan_performance_info :\n%s\n", cJSON_Print(jsonwlan_performance_info_1));
	wlan_performance_info_t* wlan_performance_info_2 = wlan_performance_info_parseFromJSON(jsonwlan_performance_info_1);
	cJSON* jsonwlan_performance_info_2 = wlan_performance_info_convertToJSON(wlan_performance_info_2);
