...
void test_abnormal_behaviour(int include_optional) {
    abnormal_behaviour_t* abnormal_behaviour_1 = instantiate_abnormal_behaviour(include_optional);

	cJSON* jsonabnormal_behaviour_1 = abnormal_behaviour_convertToJSON(abnormal_behaviour_1);
	printf("abnormal_behaviour :\n%s\n", cJSON_Print(jsonabnormal_behaviour_1));
	abnormal_behaviour_t* abnormal_behaviour_2 = abnormal_behaviour_parseFromJSON(jsonabnormal_behaviour_1);
	cJSON* jsonabnormal_behaviour_2 = abnormal_behaviour_convertToJSON(abnormal_behaviour_2);
