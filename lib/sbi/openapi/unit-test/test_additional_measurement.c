...
additional_measurement_t* instantiate_additional_measurement(int include_optional);
...
void test_additional_measurement(int include_optional) {
    additional_measurement_t* additional_measurement_1 = instantiate_additional_measurement(include_optional);

	cJSON* jsonadditional_measurement_1 = additional_measurement_convertToJSON(additional_measurement_1);
	printf("additional_measurement :\n%s\n", cJSON_Print(jsonadditional_measurement_1));
	additional_measurement_t* additional_measurement_2 = additional_measurement_parseFromJSON(jsonadditional_measurement_1);
	cJSON* jsonadditional_measurement_2 = additional_measurement_convertToJSON(additional_measurement_2);
