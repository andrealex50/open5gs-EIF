...
void test_assigned_ebi_data(int include_optional) {
    assigned_ebi_data_t* assigned_ebi_data_1 = instantiate_assigned_ebi_data(include_optional);

	cJSON* jsonassigned_ebi_data_1 = assigned_ebi_data_convertToJSON(assigned_ebi_data_1);
	printf("assigned_ebi_data :\n%s\n", cJSON_Print(jsonassigned_ebi_data_1));
	assigned_ebi_data_t* assigned_ebi_data_2 = assigned_ebi_data_parseFromJSON(jsonassigned_ebi_data_1);
	cJSON* jsonassigned_ebi_data_2 = assigned_ebi_data_convertToJSON(assigned_ebi_data_2);
