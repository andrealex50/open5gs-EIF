...
candidate_for_replacement_t* instantiate_candidate_for_replacement(int include_optional);
...
void test_candidate_for_replacement(int include_optional) {
    candidate_for_replacement_t* candidate_for_replacement_1 = instantiate_candidate_for_replacement(include_optional);

	cJSON* jsoncandidate_for_replacement_1 = candidate_for_replacement_convertToJSON(candidate_for_replacement_1);
	printf("candidate_for_replacement :\n%s\n", cJSON_Print(jsoncandidate_for_replacement_1));
	candidate_for_replacement_t* candidate_for_replacement_2 = candidate_for_replacement_parseFromJSON(jsoncandidate_for_replacement_1);
	cJSON* jsoncandidate_for_replacement_2 = candidate_for_replacement_convertToJSON(candidate_for_replacement_2);
