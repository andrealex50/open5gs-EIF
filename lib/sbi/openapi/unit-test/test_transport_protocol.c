...
void test_transport_protocol(int include_optional) {
    transport_protocol_t* transport_protocol_1 = instantiate_transport_protocol(include_optional);

	cJSON* jsontransport_protocol_1 = transport_protocol_convertToJSON(transport_protocol_1);
	printf("transport_protocol :\n%s\n", cJSON_Print(jsontransport_protocol_1));
	transport_protocol_t* transport_protocol_2 = transport_protocol_parseFromJSON(jsontransport_protocol_1);
	cJSON* jsontransport_protocol_2 = transport_protocol_convertToJSON(transport_protocol_2);
