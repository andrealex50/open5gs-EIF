...
void test_ebi_arp_mapping(int include_optional) {
    ebi_arp_mapping_t* ebi_arp_mapping_1 = instantiate_ebi_arp_mapping(include_optional);

	cJSON* jsonebi_arp_mapping_1 = ebi_arp_mapping_convertToJSON(ebi_arp_mapping_1);
	printf("ebi_arp_mapping :\n%s\n", cJSON_Print(jsonebi_arp_mapping_1));
	ebi_arp_mapping_t* ebi_arp_mapping_2 = ebi_arp_mapping_parseFromJSON(jsonebi_arp_mapping_1);
	cJSON* jsonebi_arp_mapping_2 = ebi_arp_mapping_convertToJSON(ebi_arp_mapping_2);
