...
void test_dispersion_class(int include_optional) {
    dispersion_class_t* dispersion_class_1 = instantiate_dispersion_class(include_optional);

	cJSON* jsondispersion_class_1 = dispersion_class_convertToJSON(dispersion_class_1);
	printf("dispersion_class :\n%s\n", cJSON_Print(jsondispersion_class_1));
	dispersion_class_t* dispersion_class_2 = dispersion_class_parseFromJSON(jsondispersion_class_1);
	cJSON* jsondispersion_class_2 = dispersion_class_convertToJSON(dispersion_class_2);
