...
void test_ellipsoid_arc_all_of(int include_optional) {
    ellipsoid_arc_all_of_t* ellipsoid_arc_all_of_1 = instantiate_ellipsoid_arc_all_of(include_optional);

	cJSON* jsonellipsoid_arc_all_of_1 = ellipsoid_arc_all_of_convertToJSON(ellipsoid_arc_all_of_1);
	printf("ellipsoid_arc_all_of :\n%s\n", cJSON_Print(jsonellipsoid_arc_all_of_1));
	ellipsoid_arc_all_of_t* ellipsoid_arc_all_of_2 = ellipsoid_arc_all_of_parseFromJSON(jsonellipsoid_arc_all_of_1);
	cJSON* jsonellipsoid_arc_all_of_2 = ellipsoid_arc_all_of_convertToJSON(ellipsoid_arc_all_of_2);
