...
dn_perf_ordering_criterion_t* instantiate_dn_perf_ordering_criterion(int include_optional);
...
void test_dn_perf_ordering_criterion(int include_optional) {
    dn_perf_ordering_criterion_t* dn_perf_ordering_criterion_1 = instantiate_dn_perf_ordering_criterion(include_optional);

	cJSON* jsondn_perf_ordering_criterion_1 = dn_perf_ordering_criterion_convertToJSON(dn_perf_ordering_criterion_1);
	printf("dn_perf_ordering_criterion :\n%s\n", cJSON_Print(jsondn_perf_ordering_criterion_1));
	dn_perf_ordering_criterion_t* dn_perf_ordering_criterion_2 = dn_perf_ordering_criterion_parseFromJSON(jsondn_perf_ordering_criterion_1);
	cJSON* jsondn_perf_ordering_criterion_2 = dn_perf_ordering_criterion_convertToJSON(dn_perf_ordering_criterion_2);
