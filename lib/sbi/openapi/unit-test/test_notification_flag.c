...
void test_notification_flag(int include_optional) {
    notification_flag_t* notification_flag_1 = instantiate_notification_flag(include_optional);

	cJSON* jsonnotification_flag_1 = notification_flag_convertToJSON(notification_flag_1);
	printf("notification_flag :\n%s\n", cJSON_Print(jsonnotification_flag_1));
	notification_flag_t* notification_flag_2 = notification_flag_parseFromJSON(jsonnotification_flag_1);
	cJSON* jsonnotification_flag_2 = notification_flag_convertToJSON(notification_flag_2);
