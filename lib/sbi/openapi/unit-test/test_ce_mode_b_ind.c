...
void test_ce_mode_b_ind(int include_optional) {
    ce_mode_b_ind_t* ce_mode_b_ind_1 = instantiate_ce_mode_b_ind(include_optional);

	cJSON* jsonce_mode_b_ind_1 = ce_mode_b_ind_convertToJSON(ce_mode_b_ind_1);
	printf("ce_mode_b_ind :\n%s\n", cJSON_Print(jsonce_mode_b_ind_1));
	ce_mode_b_ind_t* ce_mode_b_ind_2 = ce_mode_b_ind_parseFromJSON(jsonce_mode_b_ind_1);
	cJSON* jsonce_mode_b_ind_2 = ce_mode_b_ind_convertToJSON(ce_mode_b_ind_2);
	printf("repeating ce_mode_b_ind:\n%s\n", cJSON_Print(jsonce_mode_b_ind_2));
}
