...
void test_pdu_session_context(int include_optional) {
    pdu_session_context_t* pdu_session_context_1 = instantiate_pdu_session_context(include_optional);

	cJSON* jsonpdu_session_context_1 = pdu_session_context_convertToJSON(pdu_session_context_1);
	printf("pdu_session_context :\n%s\n", cJSON_Print(jsonpdu_session_context_1));
	pdu_session_context_t* pdu_session_context_2 = pdu_session_context_parseFromJSON(jsonpdu_session_context_1);
	cJSON* jsonpdu_session_context_2 = pdu_session_context_convertToJSON(pdu_session_context_2);
