...
void test_ue_type_any_of(int include_optional) {
    ue_type_any_of_t* ue_type_any_of_1 = instantiate_ue_type_any_of(include_optional);

	cJSON* jsonue_type_any_of_1 = ue_type_any_of_convertToJSON(ue_type_any_of_1);
	printf("ue_type_any_of :\n%s\n", cJSON_Print(jsonue_type_any_of_1));
	ue_type_any_of_t* ue_type_any_of_2 = ue_type_any_of_parseFromJSON(jsonue_type_any_of_1);
	cJSON* jsonue_type_any_of_2 = ue_type_any_of_convertToJSON(ue_type_any_of_2);
