...
n2_information_notification_t* instantiate_n2_information_notification(int include_optional);
...
n2_information_notification_t* instantiate_n2_information_notification(int include_optional) {
  ...
  if (include_optional) {
    n2_information_notification = n2_information_notification_create(
      "0",
...
void test_n2_information_notification(int include_optional) {
    n2_information_notification_t* n2_information_notification_1 = instantiate_n2_information_notification(include_optional);

	cJSON* jsonn2_information_notification_1 = n2_information_notification_convertToJSON(n2_information_notification_1);
	printf("n2_information_notification :\n%s\n", cJSON_Print(jsonn2_information_notification_1));
	n2_information_notification_t* n2_information_notification_2 = n2_information_notification_parseFromJSON(jsonn2_information_notification_1);
	cJSON* jsonn2_information_notification_2 = n2_information_notification_convertToJSON(n2_information_notification_2);
