...
void test_ranking_criterion(int include_optional) {
    ranking_criterion_t* ranking_criterion_1 = instantiate_ranking_criterion(include_optional);

	cJSON* jsonranking_criterion_1 = ranking_criterion_convertToJSON(ranking_criterion_1);
	printf("ranking_criterion :\n%s\n", cJSON_Print(jsonranking_criterion_1));
	ranking_criterion_t* ranking_criterion_2 = ranking_criterion_parseFromJSON(jsonranking_criterion_1);
	cJSON* jsonranking_criterion_2 = ranking_criterion_convertToJSON(ranking_criterion_2);
