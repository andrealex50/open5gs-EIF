...
n1_message_notification_t* instantiate_n1_message_notification(int include_optional);
...
void test_n1_message_notification(int include_optional) {
    n1_message_notification_t* n1_message_notification_1 = instantiate_n1_message_notification(include_optional);

	cJSON* jsonn1_message_notification_1 = n1_message_notification_convertToJSON(n1_message_notification_1);
	printf("n1_message_notification :\n%s\n", cJSON_Print(jsonn1_message_notification_1));
	n1_message_notification_t* n1_message_notification_2 = n1_message_notification_parseFromJSON(jsonn1_message_notification_1);
	cJSON* jsonn1_message_notification_2 = n1_message_notification_convertToJSON(n1_message_notification_2);
