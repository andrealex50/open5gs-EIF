...
analytics_subset_any_of_t* instantiate_analytics_subset_any_of(int include_optional);
...
void test_analytics_subset_any_of(int include_optional) {
    analytics_subset_any_of_t* analytics_subset_any_of_1 = instantiate_analytics_subset_any_of(include_optional);

	cJSON* jsonanalytics_subset_any_of_1 = analytics_subset_any_of_convertToJSON(analytics_subset_any_of_1);
	printf("analytics_subset_any_of :\n%s\n", cJSON_Print(jsonanalytics_subset_any_of_1));
	analytics_subset_any_of_t* analytics_subset_any_of_2 = analytics_subset_any_of_parseFromJSON(jsonanalytics_subset_any_of_1);
	cJSON* jsonanalytics_subset_any_of_2 = analytics_subset_any_of_convertToJSON(analytics_subset_any_of_2);
