...
domain_name_protocol_any_of_t* instantiate_domain_name_protocol_any_of(int include_optional);
...
domain_name_protocol_any_of_t* instantiate_domain_name_protocol_any_of(int include_optional) {
  ...
  if (include_optional) {
    domain_name_protocol_any_of = domain_name_protocol_any_of_create(
    );
  } else {
    domain_name_protocol_any_of = domain_name_protocol_any_of_create(
    );
...
void test_domain_name_protocol_any_of(int include_optional) {
    domain_name_protocol_any_of_t* domain_name_protocol_any_of_1 = instantiate_domain_name_protocol_any_of(include_optional);

	cJSON* jsondomain_name_protocol_any_of_1 = domain_name_protocol_any_of_convertToJSON(domain_name_protocol_any_of_1);
	printf("domain_name_protocol_any_of :\n%s\n", cJSON_Print(jsondomain_name_protocol_any_of_1));
	domain_name_protocol_any_of_t* domain_name_protocol_any_of_2 = domain_name_protocol_any_of_parseFromJSON(jsondomain_name_protocol_any_of_1);
	cJSON* jsondomain_name_protocol_any_of_2 = domain_name_protocol_any_of_convertToJSON(domain_name_protocol_any_of_2);
