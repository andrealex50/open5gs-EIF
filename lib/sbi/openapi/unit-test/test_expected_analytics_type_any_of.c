...
expected_analytics_type_any_of_t* instantiate_expected_analytics_type_any_of(int include_optional);
...
expected_analytics_type_any_of_t* instantiate_expected_analytics_type_any_of(int include_optional) {
  ...
  if (include_optional) {
    expected_analytics_type_any_of = expected_analytics_type_any_of_create(
    );
  } else {
    expected_analytics_type_any_of = expected_analytics_type_any_of_create(
    );
...
void test_expected_analytics_type_any_of(int include_optional) {
    expected_analytics_type_any_of_t* expected_analytics_type_any_of_1 = instantiate_expected_analytics_type_any_of(include_optional);

	cJSON* jsonexpected_analytics_type_any_of_1 = expected_analytics_type_any_of_convertToJSON(expected_analytics_type_any_of_1);
	printf("expected_analytics_type_any_of :\n%s\n", cJSON_Print(jsonexpected_analytics_type_any_of_1));
	expected_analytics_type_any_of_t* expected_analytics_type_any_of_2 = expected_analytics_type_any_of_parseFromJSON(jsonexpected_analytics_type_any_of_1);
	cJSON* jsonexpected_analytics_type_any_of_2 = expected_analytics_type_any_of_convertToJSON(expected_analytics_type_any_of_2);
