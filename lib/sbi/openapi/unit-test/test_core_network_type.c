...
void test_core_network_type(int include_optional) {
    core_network_type_t* core_network_type_1 = instantiate_core_network_type(include_optional);

	cJSON* jsoncore_network_type_1 = core_network_type_convertToJSON(core_network_type_1);
	printf("core_network_type :\n%s\n", cJSON_Print(jsoncore_network_type_1));
	core_network_type_t* core_network_type_2 = core_network_type_parseFromJSON(jsoncore_network_type_1);
	cJSON* jsoncore_network_type_2 = core_network_type_convertToJSON(core_network_type_2);
