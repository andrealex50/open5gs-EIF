...
void test_flow_direction(int include_optional) {
    flow_direction_t* flow_direction_1 = instantiate_flow_direction(include_optional);

	cJSON* jsonflow_direction_1 = flow_direction_convertToJSON(flow_direction_1);
	printf("flow_direction :\n%s\n", cJSON_Print(jsonflow_direction_1));
	flow_direction_t* flow_direction_2 = flow_direction_parseFromJSON(jsonflow_direction_1);
	cJSON* jsonflow_direction_2 = flow_direction_convertToJSON(flow_direction_2);
