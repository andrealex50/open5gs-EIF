...
void test_event_notification(int include_optional) {
    event_notification_t* event_notification_1 = instantiate_event_notification(include_optional);

	cJSON* jsonevent_notification_1 = event_notification_convertToJSON(event_notification_1);
	printf("event_notification :\n%s\n", cJSON_Print(jsonevent_notification_1));
	event_notification_t* event_notification_2 = event_notification_parseFromJSON(jsonevent_notification_1);
	cJSON* jsonevent_notification_2 = event_notification_convertToJSON(event_notification_2);
