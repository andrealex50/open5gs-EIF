...
void test_configured_snssai(int include_optional) {
    configured_snssai_t* configured_snssai_1 = instantiate_configured_snssai(include_optional);

	cJSON* jsonconfigured_snssai_1 = configured_snssai_convertToJSON(configured_snssai_1);
	printf("configured_snssai :\n%s\n", cJSON_Print(jsonconfigured_snssai_1));
	configured_snssai_t* configured_snssai_2 = configured_snssai_parseFromJSON(jsonconfigured_snssai_1);
	cJSON* jsonconfigured_snssai_2 = configured_snssai_convertToJSON(configured_snssai_2);
