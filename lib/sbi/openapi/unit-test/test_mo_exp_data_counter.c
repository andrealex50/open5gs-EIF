...
void test_mo_exp_data_counter(int include_optional) {
    mo_exp_data_counter_t* mo_exp_data_counter_1 = instantiate_mo_exp_data_counter(include_optional);

	cJSON* jsonmo_exp_data_counter_1 = mo_exp_data_counter_convertToJSON(mo_exp_data_counter_1);
	printf("mo_exp_data_counter :\n%s\n", cJSON_Print(jsonmo_exp_data_counter_1));
	mo_exp_data_counter_t* mo_exp_data_counter_2 = mo_exp_data_counter_parseFromJSON(jsonmo_exp_data_counter_1);
	cJSON* jsonmo_exp_data_counter_2 = mo_exp_data_counter_convertToJSON(mo_exp_data_counter_2);
