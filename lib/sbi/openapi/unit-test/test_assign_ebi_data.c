...
void test_assign_ebi_data(int include_optional) {
    assign_ebi_data_t* assign_ebi_data_1 = instantiate_assign_ebi_data(include_optional);

	cJSON* jsonassign_ebi_data_1 = assign_ebi_data_convertToJSON(assign_ebi_data_1);
	printf("assign_ebi_data :\n%s\n", cJSON_Print(jsonassign_ebi_data_1));
	assign_ebi_data_t* assign_ebi_data_2 = assign_ebi_data_parseFromJSON(jsonassign_ebi_data_1);
	cJSON* jsonassign_ebi_data_2 = assign_ebi_data_convertToJSON(assign_ebi_data_2);
