...
ext_amf_event_subscription_t* instantiate_ext_amf_event_subscription(int include_optional);
...
ext_amf_event_subscription_t* instantiate_ext_amf_event_subscription(int include_optional) {
  ...
  if (include_optional) {
    ext_amf_event_subscription = ext_amf_event_subscription_create(
      ...
      namf_communication_ext_amf_event_subscription__NRF,
      list_createList(),
      namf_communication_ext_amf_event_subscription__NRF,
      1,
      list_createList(),
...
void test_ext_amf_event_subscription(int include_optional) {
    ext_amf_event_subscription_t* ext_amf_event_subscription_1 = instantiate_ext_amf_event_subscription(include_optional);

	cJSON* jsonext_amf_event_subscription_1 = ext_amf_event_subscription_convertToJSON(ext_amf_event_subscription_1);
	printf("ext_amf_event_subscription :\n%s\n", cJSON_Print(jsonext_amf_event_subscription_1));
	ext_amf_event_subscription_t* ext_amf_event_subscription_2 = ext_amf_event_subscription_parseFromJSON(jsonext_amf_event_subscription_1);
	cJSON* jsonext_amf_event_subscription_2 = ext_amf_event_subscription_convertToJSON(ext_amf_event_subscription_2);
