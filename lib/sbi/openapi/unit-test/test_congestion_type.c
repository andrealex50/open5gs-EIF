...
void test_congestion_type(int include_optional) {
    congestion_type_t* congestion_type_1 = instantiate_congestion_type(include_optional);

	cJSON* jsoncongestion_type_1 = congestion_type_convertToJSON(congestion_type_1);
	printf("congestion_type :\n%s\n", cJSON_Print(jsoncongestion_type_1));
	congestion_type_t* congestion_type_2 = congestion_type_parseFromJSON(jsoncongestion_type_1);
	cJSON* jsoncongestion_type_2 = congestion_type_convertToJSON(congestion_type_2);
