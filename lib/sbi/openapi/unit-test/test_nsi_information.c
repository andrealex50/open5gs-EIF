...
void test_nsi_information(int include_optional) {
    nsi_information_t* nsi_information_1 = instantiate_nsi_information(include_optional);

	cJSON* jsonnsi_information_1 = nsi_information_convertToJSON(nsi_information_1);
	printf("nsi_information :\n%s\n", cJSON_Print(jsonnsi_information_1));
	nsi_information_t* nsi_information_2 = nsi_information_parseFromJSON(jsonnsi_information_1);
	cJSON* jsonnsi_information_2 = nsi_information_convertToJSON(nsi_information_2);
