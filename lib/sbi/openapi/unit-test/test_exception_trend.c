...
void test_exception_trend(int include_optional) {
    exception_trend_t* exception_trend_1 = instantiate_exception_trend(include_optional);

	cJSON* jsonexception_trend_1 = exception_trend_convertToJSON(exception_trend_1);
	printf("exception_trend :\n%s\n", cJSON_Print(jsonexception_trend_1));
	exception_trend_t* exception_trend_2 = exception_trend_parseFromJSON(jsonexception_trend_1);
	cJSON* jsonexception_trend_2 = exception_trend_convertToJSON(exception_trend_2);
