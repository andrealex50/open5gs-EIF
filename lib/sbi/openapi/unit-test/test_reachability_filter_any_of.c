...
reachability_filter_any_of_t* instantiate_reachability_filter_any_of(int include_optional);
...
void test_reachability_filter_any_of(int include_optional) {
    reachability_filter_any_of_t* reachability_filter_any_of_1 = instantiate_reachability_filter_any_of(include_optional);

	cJSON* jsonreachability_filter_any_of_1 = reachability_filter_any_of_convertToJSON(reachability_filter_any_of_1);
	printf("reachability_filter_any_of :\n%s\n", cJSON_Print(jsonreachability_filter_any_of_1));
	reachability_filter_any_of_t* reachability_filter_any_of_2 = reachability_filter_any_of_parseFromJSON(jsonreachability_filter_any_of_1);
	cJSON* jsonreachability_filter_any_of_2 = reachability_filter_any_of_convertToJSON(reachability_filter_any_of_2);
