...
void test_class_criterion(int include_optional) {
    class_criterion_t* class_criterion_1 = instantiate_class_criterion(include_optional);

	cJSON* jsonclass_criterion_1 = class_criterion_convertToJSON(class_criterion_1);
	printf("class_criterion :\n%s\n", cJSON_Print(jsonclass_criterion_1));
	class_criterion_t* class_criterion_2 = class_criterion_parseFromJSON(jsonclass_criterion_1);
	cJSON* jsonclass_criterion_2 = class_criterion_convertToJSON(class_criterion_2);
