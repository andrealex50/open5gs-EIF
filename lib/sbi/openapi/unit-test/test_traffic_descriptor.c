...
void test_traffic_descriptor(int include_optional) {
    traffic_descriptor_t* traffic_descriptor_1 = instantiate_traffic_descriptor(include_optional);

	cJSON* jsontraffic_descriptor_1 = traffic_descriptor_convertToJSON(traffic_descriptor_1);
	printf("traffic_descriptor :\n%s\n", cJSON_Print(jsontraffic_descriptor_1));
	traffic_descriptor_t* traffic_descriptor_2 = traffic_descriptor_parseFromJSON(jsontraffic_descriptor_1);
	cJSON* jsontraffic_descriptor_2 = traffic_descriptor_convertToJSON(traffic_descriptor_2);
