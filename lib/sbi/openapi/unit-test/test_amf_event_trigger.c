...
void test_amf_event_trigger(int include_optional) {
    amf_event_trigger_t* amf_event_trigger_1 = instantiate_amf_event_trigger(include_optional);

	cJSON* jsonamf_event_trigger_1 = amf_event_trigger_convertToJSON(amf_event_trigger_1);
	printf("amf_event_trigger :\n%s\n", cJSON_Print(jsonamf_event_trigger_1));
	amf_event_trigger_t* amf_event_trigger_2 = amf_event_trigger_parseFromJSON(jsonamf_event_trigger_1);
	cJSON* jsonamf_event_trigger_2 = amf_event_trigger_convertToJSON(amf_event_trigger_2);
