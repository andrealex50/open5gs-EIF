...
void test_n2_info_content(int include_optional) {
    n2_info_content_t* n2_info_content_1 = instantiate_n2_info_content(include_optional);

	cJSON* jsonn2_info_content_1 = n2_info_content_convertToJSON(n2_info_content_1);
	printf("n2_info_content :\n%s\n", cJSON_Print(jsonn2_info_content_1));
	n2_info_content_t* n2_info_content_2 = n2_info_content_parseFromJSON(jsonn2_info_content_1);
	cJSON* jsonn2_info_content_2 = n2_info_content_convertToJSON(n2_info_content_2);
