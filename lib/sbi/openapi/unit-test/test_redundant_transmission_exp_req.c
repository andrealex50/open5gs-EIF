...
redundant_transmission_exp_req_t* instantiate_redundant_transmission_exp_req(int include_optional);
...
redundant_transmission_exp_req_t* instantiate_redundant_transmission_exp_req(int include_optional) {
  ...
  if (include_optional) {
    redundant_transmission_exp_req = redundant_transmission_exp_req_create(
      null,
      null
    );
  } else {
...
void test_redundant_transmission_exp_req(int include_optional) {
    redundant_transmission_exp_req_t* redundant_transmission_exp_req_1 = instantiate_redundant_transmission_exp_req(include_optional);

	cJSON* jsonredundant_transmission_exp_req_1 = redundant_transmission_exp_req_convertToJSON(redundant_transmission_exp_req_1);
	printf("redundant_transmission_exp_req :\n%s\n", cJSON_Print(jsonredundant_transmission_exp_req_1));
	redundant_transmission_exp_req_t* redundant_transmission_exp_req_2 = redundant_transmission_exp_req_parseFromJSON(jsonredundant_transmission_exp_req_1);
	cJSON* jsonredundant_transmission_exp_req_2 = redundant_transmission_exp_req_convertToJSON(redundant_transmission_exp_req_2);
