...
point_uncertainty_ellipse_all_of_t* instantiate_point_uncertainty_ellipse_all_of(int include_optional);
...
point_uncertainty_ellipse_all_of_t* instantiate_point_uncertainty_ellipse_all_of(int include_optional) {
  point_uncertainty_ellipse_all_of_t* point_uncertainty_ellipse_all_of = NULL;
  if (include_optional) {
    point_uncertainty_ellipse_all_of = point_uncertainty_ellipse_all_of_create(
...
void test_point_uncertainty_ellipse_all_of(int include_optional) {
    point_uncertainty_ellipse_all_of_t* point_uncertainty_ellipse_all_of_1 = instantiate_point_uncertainty_ellipse_all_of(include_optional);

	cJSON* jsonpoint_uncertainty_ellipse_all_of_1 = point_uncertainty_ellipse_all_of_convertToJSON(point_uncertainty_ellipse_all_of_1);
	printf("point_uncertainty_ellipse_all_of :\n%s\n", cJSON_Print(jsonpoint_uncertainty_ellipse_all_of_1));
	point_uncertainty_ellipse_all_of_t* point_uncertainty_ellipse_all_of_2 = point_uncertainty_ellipse_all_of_parseFromJSON(jsonpoint_uncertainty_ellipse_all_of_1);
	cJSON* jsonpoint_uncertainty_ellipse_all_of_2 = point_uncertainty_ellipse_all_of_convertToJSON(point_uncertainty_ellipse_all_of_2);
