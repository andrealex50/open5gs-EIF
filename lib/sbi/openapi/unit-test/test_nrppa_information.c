...
void test_nrppa_information(int include_optional) {
    nrppa_information_t* nrppa_information_1 = instantiate_nrppa_information(include_optional);

	cJSON* jsonnrppa_information_1 = nrppa_information_convertToJSON(nrppa_information_1);
	printf("nrppa_information :\n%s\n", cJSON_Print(jsonnrppa_information_1));
	nrppa_information_t* nrppa_information_2 = nrppa_information_parseFromJSON(jsonnrppa_information_1);
	cJSON* jsonnrppa_information_2 = nrppa_information_convertToJSON(nrppa_information_2);
