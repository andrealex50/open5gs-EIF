...
void test_partitioning_criteria(int include_optional) {
    partitioning_criteria_t* partitioning_criteria_1 = instantiate_partitioning_criteria(include_optional);

	cJSON* jsonpartitioning_criteria_1 = partitioning_criteria_convertToJSON(partitioning_criteria_1);
	printf("partitioning_criteria :\n%s\n", cJSON_Print(jsonpartitioning_criteria_1));
	partitioning_criteria_t* partitioning_criteria_2 = partitioning_criteria_parseFromJSON(jsonpartitioning_criteria_1);
	cJSON* jsonpartitioning_criteria_2 = partitioning_criteria_convertToJSON(partitioning_criteria_2);
