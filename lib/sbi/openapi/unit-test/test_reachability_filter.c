...
void test_reachability_filter(int include_optional) {
    reachability_filter_t* reachability_filter_1 = instantiate_reachability_filter(include_optional);

	cJSON* jsonreachability_filter_1 = reachability_filter_convertToJSON(reachability_filter_1);
	printf("reachability_filter :\n%s\n", cJSON_Print(jsonreachability_filter_1));
	reachability_filter_t* reachability_filter_2 = reachability_filter_parseFromJSON(jsonreachability_filter_1);
	cJSON* jsonreachability_filter_2 = reachability_filter_convertToJSON(reachability_filter_2);
