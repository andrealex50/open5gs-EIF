...
updp_subscription_data_t* instantiate_updp_subscription_data(int include_optional);
...
void test_updp_subscription_data(int include_optional) {
    updp_subscription_data_t* updp_subscription_data_1 = instantiate_updp_subscription_data(include_optional);

	cJSON* jsonupdp_subscription_data_1 = updp_subscription_data_convertToJSON(updp_subscription_data_1);
	printf("updp_subscription_data :\n%s\n", cJSON_Print(jsonupdp_subscription_data_1));
	updp_subscription_data_t* updp_subscription_data_2 = updp_subscription_data_parseFromJSON(jsonupdp_subscription_data_1);
	cJSON* jsonupdp_subscription_data_2 = updp_subscription_data_convertToJSON(updp_subscription_data_2);
