...
network_perf_requirement_t* instantiate_network_perf_requirement(int include_optional);
...
void test_network_perf_requirement(int include_optional) {
    network_perf_requirement_t* network_perf_requirement_1 = instantiate_network_perf_requirement(include_optional);

	cJSON* jsonnetwork_perf_requirement_1 = network_perf_requirement_convertToJSON(network_perf_requirement_1);
	printf("network_perf_requirement :\n%s\n", cJSON_Print(jsonnetwork_perf_requirement_1));
	network_perf_requirement_t* network_perf_requirement_2 = network_perf_requirement_parseFromJSON(jsonnetwork_perf_requirement_1);
	cJSON* jsonnetwork_perf_requirement_2 = network_perf_requirement_convertToJSON(network_perf_requirement_2);
