...
void test_point_altitude_all_of(int include_optional) {
    point_altitude_all_of_t* point_altitude_all_of_1 = instantiate_point_altitude_all_of(include_optional);

	cJSON* jsonpoint_altitude_all_of_1 = point_altitude_all_of_convertToJSON(point_altitude_all_of_1);
	printf("point_altitude_all_of :\n%s\n", cJSON_Print(jsonpoint_altitude_all_of_1));
	point_altitude_all_of_t* point_altitude_all_of_2 = point_altitude_all_of_parseFromJSON(jsonpoint_altitude_all_of_1);
	cJSON* jsonpoint_altitude_all_of_2 = point_altitude_all_of_convertToJSON(point_altitude_all_of_2);
