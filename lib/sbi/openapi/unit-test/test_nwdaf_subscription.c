...
void test_nwdaf_subscription(int include_optional) {
    nwdaf_subscription_t* nwdaf_subscription_1 = instantiate_nwdaf_subscription(include_optional);

	cJSON* jsonnwdaf_subscription_1 = nwdaf_subscription_convertToJSON(nwdaf_subscription_1);
	printf("nwdaf_subscription :\n%s\n", cJSON_Print(jsonnwdaf_subscription_1));
	nwdaf_subscription_t* nwdaf_subscription_2 = nwdaf_subscription_parseFromJSON(jsonnwdaf_subscription_1);
	cJSON* jsonnwdaf_subscription_2 = nwdaf_subscription_convertToJSON(nwdaf_subscription_2);
