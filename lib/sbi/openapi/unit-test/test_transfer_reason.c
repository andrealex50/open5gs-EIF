...
void test_transfer_reason(int include_optional) {
    transfer_reason_t* transfer_reason_1 = instantiate_transfer_reason(include_optional);

	cJSON* jsontransfer_reason_1 = transfer_reason_convertToJSON(transfer_reason_1);
	printf("transfer_reason :\n%s\n", cJSON_Print(jsontransfer_reason_1));
	transfer_reason_t* transfer_reason_2 = transfer_reason_parseFromJSON(jsontransfer_reason_1);
	cJSON* jsontransfer_reason_2 = transfer_reason_convertToJSON(transfer_reason_2);
