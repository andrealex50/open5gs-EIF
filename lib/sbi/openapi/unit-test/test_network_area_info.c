...
void test_network_area_info(int include_optional) {
    network_area_info_t* network_area_info_1 = instantiate_network_area_info(include_optional);

	cJSON* jsonnetwork_area_info_1 = network_area_info_convertToJSON(network_area_info_1);
	printf("network_area_info :\n%s\n", cJSON_Print(jsonnetwork_area_info_1));
	network_area_info_t* network_area_info_2 = network_area_info_parseFromJSON(jsonnetwork_area_info_1);
	cJSON* jsonnetwork_area_info_2 = network_area_info_convertToJSON(network_area_info_2);
