...
n2_information_transfer_result_t* instantiate_n2_information_transfer_result(int include_optional);
...
n2_information_transfer_result_t* instantiate_n2_information_transfer_result(int include_optional) {
  ...
  if (include_optional) {
    n2_information_transfer_result = n2_information_transfer_result_create(
    );
  } else {
    n2_information_transfer_result = n2_information_transfer_result_create(
    );
...
void test_n2_information_transfer_result(int include_optional) {
    n2_information_transfer_result_t* n2_information_transfer_result_1 = instantiate_n2_information_transfer_result(include_optional);

	cJSON* jsonn2_information_transfer_result_1 = n2_information_transfer_result_convertToJSON(n2_information_transfer_result_1);
	printf("n2_information_transfer_result :\n%s\n", cJSON_Print(jsonn2_information_transfer_result_1));
	n2_information_transfer_result_t* n2_information_transfer_result_2 = n2_information_transfer_result_parseFromJSON(jsonn2_information_transfer_result_1);
	cJSON* jsonn2_information_transfer_result_2 = n2_information_transfer_result_convertToJSON(n2_information_transfer_result_2);
