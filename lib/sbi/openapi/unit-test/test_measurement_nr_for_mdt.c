...
measurement_nr_for_mdt_t* instantiate_measurement_nr_for_mdt(int include_optional);
...
void test_measurement_nr_for_mdt(int include_optional) {
    measurement_nr_for_mdt_t* measurement_nr_for_mdt_1 = instantiate_measurement_nr_for_mdt(include_optional);

	cJSON* jsonmeasurement_nr_for_mdt_1 = measurement_nr_for_mdt_convertToJSON(measurement_nr_for_mdt_1);
	printf("measurement_nr_for_mdt :\n%s\n", cJSON_Print(jsonmeasurement_nr_for_mdt_1));
	measurement_nr_for_mdt_t* measurement_nr_for_mdt_2 = measurement_nr_for_mdt_parseFromJSON(jsonmeasurement_nr_for_mdt_1);
	cJSON* jsonmeasurement_nr_for_mdt_2 = measurement_nr_for_mdt_convertToJSON(measurement_nr_for_mdt_2);
