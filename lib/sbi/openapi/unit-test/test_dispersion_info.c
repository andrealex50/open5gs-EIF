...
void test_dispersion_info(int include_optional) {
    dispersion_info_t* dispersion_info_1 = instantiate_dispersion_info(include_optional);

	cJSON* jsondispersion_info_1 = dispersion_info_convertToJSON(dispersion_info_1);
	printf("dispersion_info :\n%s\n", cJSON_Print(jsondispersion_info_1));
	dispersion_info_t* dispersion_info_2 = dispersion_info_parseFromJSON(jsondispersion_info_1);
	cJSON* jsondispersion_info_2 = dispersion_info_convertToJSON(dispersion_info_2);
