...
void test_domain_name_protocol(int include_optional) {
    domain_name_protocol_t* domain_name_protocol_1 = instantiate_domain_name_protocol(include_optional);

	cJSON* jsondomain_name_protocol_1 = domain_name_protocol_convertToJSON(domain_name_protocol_1);
	printf("domain_name_protocol :\n%s\n", cJSON_Print(jsondomain_name_protocol_1));
	domain_name_protocol_t* domain_name_protocol_2 = domain_name_protocol_parseFromJSON(jsondomain_name_protocol_1);
	cJSON* jsondomain_name_protocol_2 = domain_name_protocol_convertToJSON(domain_name_protocol_2);
