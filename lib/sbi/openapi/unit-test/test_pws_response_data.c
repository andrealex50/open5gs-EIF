...
void test_pws_response_data(int include_optional) {
    pws_response_data_t* pws_response_data_1 = instantiate_pws_response_data(include_optional);

	cJSON* jsonpws_response_data_1 = pws_response_data_convertToJSON(pws_response_data_1);
	printf("pws_response_data :\n%s\n", cJSON_Print(jsonpws_response_data_1));
	pws_response_data_t* pws_response_data_2 = pws_response_data_parseFromJSON(jsonpws_response_data_1);
	cJSON* jsonpws_response_data_2 = pws_response_data_convertToJSON(pws_response_data_2);
