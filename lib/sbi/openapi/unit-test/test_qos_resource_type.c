...
void test_qos_resource_type(int include_optional) {
    qos_resource_type_t* qos_resource_type_1 = instantiate_qos_resource_type(include_optional);

	cJSON* jsonqos_resource_type_1 = qos_resource_type_convertToJSON(qos_resource_type_1);
	printf("qos_resource_type :\n%s\n", cJSON_Print(jsonqos_resource_type_1));
	qos_resource_type_t* qos_resource_type_2 = qos_resource_type_parseFromJSON(jsonqos_resource_type_1);
	cJSON* jsonqos_resource_type_2 = qos_resource_type_convertToJSON(qos_resource_type_2);
