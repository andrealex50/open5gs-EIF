...
point_altitude_uncertainty_t* instantiate_point_altitude_uncertainty(int include_optional);
...
void test_point_altitude_uncertainty(int include_optional) {
    point_altitude_uncertainty_t* point_altitude_uncertainty_1 = instantiate_point_altitude_uncertainty(include_optional);

	cJSON* jsonpoint_altitude_uncertainty_1 = point_altitude_uncertainty_convertToJSON(point_altitude_uncertainty_1);
	printf("point_altitude_uncertainty :\n%s\n", cJSON_Print(jsonpoint_altitude_uncertainty_1));
	point_altitude_uncertainty_t* point_altitude_uncertainty_2 = point_altitude_uncertainty_parseFromJSON(jsonpoint_altitude_uncertainty_1);
	cJSON* jsonpoint_altitude_uncertainty_2 = point_altitude_uncertainty_convertToJSON(point_altitude_uncertainty_2);
