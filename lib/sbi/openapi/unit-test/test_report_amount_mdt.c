...
void test_report_amount_mdt(int include_optional) {
    report_amount_mdt_t* report_amount_mdt_1 = instantiate_report_amount_mdt(include_optional);

	cJSON* jsonreport_amount_mdt_1 = report_amount_mdt_convertToJSON(report_amount_mdt_1);
	printf("report_amount_mdt :\n%s\n", cJSON_Print(jsonreport_amount_mdt_1));
	report_amount_mdt_t* report_amount_mdt_2 = report_amount_mdt_parseFromJSON(jsonreport_amount_mdt_1);
	cJSON* jsonreport_amount_mdt_2 = report_amount_mdt_convertToJSON(report_amount_mdt_2);
