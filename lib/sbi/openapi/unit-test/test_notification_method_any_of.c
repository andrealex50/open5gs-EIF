...
notification_method_any_of_t* instantiate_notification_method_any_of(int include_optional);
...
void test_notification_method_any_of(int include_optional) {
    notification_method_any_of_t* notification_method_any_of_1 = instantiate_notification_method_any_of(include_optional);

	cJSON* jsonnotification_method_any_of_1 = notification_method_any_of_convertToJSON(notification_method_any_of_1);
	printf("notification_method_any_of :\n%s\n", cJSON_Print(jsonnotification_method_any_of_1));
	notification_method_any_of_t* notification_method_any_of_2 = notification_method_any_of_parseFromJSON(jsonnotification_method_any_of_1);
	cJSON* jsonnotification_method_any_of_2 = notification_method_any_of_convertToJSON(notification_method_any_of_2);
