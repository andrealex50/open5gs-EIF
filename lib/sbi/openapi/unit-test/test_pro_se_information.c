...
void test_pro_se_information(int include_optional) {
    pro_se_information_t* pro_se_information_1 = instantiate_pro_se_information(include_optional);

	cJSON* jsonpro_se_information_1 = pro_se_information_convertToJSON(pro_se_information_1);
	printf("pro_se_information :\n%s\n", cJSON_Print(jsonpro_se_information_1));
	pro_se_information_t* pro_se_information_2 = pro_se_information_parseFromJSON(jsonpro_se_information_1);
	cJSON* jsonpro_se_information_2 = pro_se_information_convertToJSON(pro_se_information_2);
