...
void test_bw_requirement(int include_optional) {
    bw_requirement_t* bw_requirement_1 = instantiate_bw_requirement(include_optional);

	cJSON* jsonbw_requirement_1 = bw_requirement_convertToJSON(bw_requirement_1);
	printf("bw_requirement :\n%s\n", cJSON_Print(jsonbw_requirement_1));
	bw_requirement_t* bw_requirement_2 = bw_requirement_parseFromJSON(jsonbw_requirement_1);
	cJSON* jsonbw_requirement_2 = bw_requirement_convertToJSON(bw_requirement_2);
