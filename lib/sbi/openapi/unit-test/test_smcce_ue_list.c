...
void test_smcce_ue_list(int include_optional) {
    smcce_ue_list_t* smcce_ue_list_1 = instantiate_smcce_ue_list(include_optional);

	cJSON* jsonsmcce_ue_list_1 = smcce_ue_list_convertToJSON(smcce_ue_list_1);
	printf("smcce_ue_list :\n%s\n", cJSON_Print(jsonsmcce_ue_list_1));
	smcce_ue_list_t* smcce_ue_list_2 = smcce_ue_list_parseFromJSON(jsonsmcce_ue_list_1);
	cJSON* jsonsmcce_ue_list_2 = smcce_ue_list_convertToJSON(smcce_ue_list_2);
	printf("repeating smcce_ue_list:\n%s\n", cJSON_Print(jsonsmcce_ue_list_2));
}
