...
void test_battery_indication(int include_optional) {
    battery_indication_t* battery_indication_1 = instantiate_battery_indication(include_optional);

	cJSON* jsonbattery_indication_1 = battery_indication_convertToJSON(battery_indication_1);
	printf("battery_indication :\n%s\n", cJSON_Print(jsonbattery_indication_1));
	battery_indication_t* battery_indication_2 = battery_indication_parseFromJSON(jsonbattery_indication_1);
	cJSON* jsonbattery_indication_2 = battery_indication_convertToJSON(battery_indication_2);
