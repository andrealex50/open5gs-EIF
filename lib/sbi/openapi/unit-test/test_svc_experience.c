...
void test_svc_experience(int include_optional) {
    svc_experience_t* svc_experience_1 = instantiate_svc_experience(include_optional);

	cJSON* jsonsvc_experience_1 = svc_experience_convertToJSON(svc_experience_1);
	printf("svc_experience :\n%s\n", cJSON_Print(jsonsvc_experience_1));
	svc_experience_t* svc_experience_2 = svc_experience_parseFromJSON(jsonsvc_experience_1);
	cJSON* jsonsvc_experience_2 = svc_experience_convertToJSON(svc_experience_2);
