...
void test_pc5_qo_s_para(int include_optional) {
    pc5_qo_s_para_t* pc5_qo_s_para_1 = instantiate_pc5_qo_s_para(include_optional);

	cJSON* jsonpc5_qo_s_para_1 = pc5_qo_s_para_convertToJSON(pc5_qo_s_para_1);
	printf("pc5_qo_s_para :\n%s\n", cJSON_Print(jsonpc5_qo_s_para_1));
	pc5_qo_s_para_t* pc5_qo_s_para_2 = pc5_qo_s_para_parseFromJSON(jsonpc5_qo_s_para_1);
	cJSON* jsonpc5_qo_s_para_2 = pc5_qo_s_para_convertToJSON(pc5_qo_s_para_2);
	printf("repeating pc5_qo_s_para:\n%s\n", cJSON_Print(jsonpc5_qo_s_para_2));
}
