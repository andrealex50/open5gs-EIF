...
void test_smf_change_info(int include_optional) {
    smf_change_info_t* smf_change_info_1 = instantiate_smf_change_info(include_optional);

	cJSON* jsonsmf_change_info_1 = smf_change_info_convertToJSON(smf_change_info_1);
	printf("smf_change_info :\n%s\n", cJSON_Print(jsonsmf_change_info_1));
	smf_change_info_t* smf_change_info_2 = smf_change_info_parseFromJSON(jsonsmf_change_info_1);
	cJSON* jsonsmf_change_info_2 = smf_change_info_convertToJSON(smf_change_info_2);
