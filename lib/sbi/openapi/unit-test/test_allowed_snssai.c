...
void test_allowed_snssai(int include_optional) {
    allowed_snssai_t* allowed_snssai_1 = instantiate_allowed_snssai(include_optional);

	cJSON* jsonallowed_snssai_1 = allowed_snssai_convertToJSON(allowed_snssai_1);
	printf("allowed_snssai :\n%s\n", cJSON_Print(jsonallowed_snssai_1));
	allowed_snssai_t* allowed_snssai_2 = allowed_snssai_parseFromJSON(jsonallowed_snssai_1);
	cJSON* jsonallowed_snssai_2 = allowed_snssai_convertToJSON(allowed_snssai_2);
