...
relocate_ue_context_request_t* instantiate_relocate_ue_context_request(int include_optional);
...
relocate_ue_context_request_t* instantiate_relocate_ue_context_request(int include_optional) {
  ...
  if (include_optional) {
    relocate_ue_context_request = relocate_ue_context_request_create(
...
void test_relocate_ue_context_request(int include_optional) {
    relocate_ue_context_request_t* relocate_ue_context_request_1 = instantiate_relocate_ue_context_request(include_optional);

	cJSON* jsonrelocate_ue_context_request_1 = relocate_ue_context_request_convertToJSON(relocate_ue_context_request_1);
	printf("relocate_ue_context_request :\n%s\n", cJSON_Print(jsonrelocate_ue_context_request_1));
	relocate_ue_context_request_t* relocate_ue_context_request_2 = relocate_ue_context_request_parseFromJSON(jsonrelocate_ue_context_request_1);
	cJSON* jsonrelocate_ue_context_request_2 = relocate_ue_context_request_convertToJSON(relocate_ue_context_request_2);
