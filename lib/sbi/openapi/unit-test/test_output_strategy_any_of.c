...
output_strategy_any_of_t* instantiate_output_strategy_any_of(int include_optional);
...
void test_output_strategy_any_of(int include_optional) {
    output_strategy_any_of_t* output_strategy_any_of_1 = instantiate_output_strategy_any_of(include_optional);

	cJSON* jsonoutput_strategy_any_of_1 = output_strategy_any_of_convertToJSON(output_strategy_any_of_1);
	printf("output_strategy_any_of :\n%s\n", cJSON_Print(jsonoutput_strategy_any_of_1));
	output_strategy_any_of_t* output_strategy_any_of_2 = output_strategy_any_of_parseFromJSON(jsonoutput_strategy_any_of_1);
	cJSON* jsonoutput_strategy_any_of_2 = output_strategy_any_of_convertToJSON(output_strategy_any_of_2);
