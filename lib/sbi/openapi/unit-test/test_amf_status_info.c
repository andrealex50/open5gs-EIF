...
void test_amf_status_info(int include_optional) {
    amf_status_info_t* amf_status_info_1 = instantiate_amf_status_info(include_optional);

	cJSON* jsonamf_status_info_1 = amf_status_info_convertToJSON(amf_status_info_1);
	printf("amf_status_info :\n%s\n", cJSON_Print(jsonamf_status_info_1));
	amf_status_info_t* amf_status_info_2 = amf_status_info_parseFromJSON(jsonamf_status_info_1);
	cJSON* jsonamf_status_info_2 = amf_status_info_convertToJSON(amf_status_info_2);
