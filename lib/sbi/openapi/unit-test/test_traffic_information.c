...
void test_traffic_information(int include_optional) {
    traffic_information_t* traffic_information_1 = instantiate_traffic_information(include_optional);

	cJSON* jsontraffic_information_1 = traffic_information_convertToJSON(traffic_information_1);
	printf("traffic_information :\n%s\n", cJSON_Print(jsontraffic_information_1));
	traffic_information_t* traffic_information_2 = traffic_information_parseFromJSON(jsontraffic_information_1);
	cJSON* jsontraffic_information_2 = traffic_information_convertToJSON(traffic_information_2);
