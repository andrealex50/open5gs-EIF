...
void test_n2_info_container(int include_optional) {
    n2_info_container_t* n2_info_container_1 = instantiate_n2_info_container(include_optional);

	cJSON* jsonn2_info_container_1 = n2_info_container_convertToJSON(n2_info_container_1);
	printf("n2_info_container :\n%s\n", cJSON_Print(jsonn2_info_container_1));
	n2_info_container_t* n2_info_container_2 = n2_info_container_parseFromJSON(jsonn2_info_container_1);
	cJSON* jsonn2_info_container_2 = n2_info_container_convertToJSON(n2_info_container_2);
