...
void test_time_unit_any_of(int include_optional) {
    time_unit_any_of_t* time_unit_any_of_1 = instantiate_time_unit_any_of(include_optional);

	cJSON* jsontime_unit_any_of_1 = time_unit_any_of_convertToJSON(time_unit_any_of_1);
	printf("time_unit_any_of :\n%s\n", cJSON_Print(jsontime_unit_any_of_1));
	time_unit_any_of_t* time_unit_any_of_2 = time_unit_any_of_parseFromJSON(jsontime_unit_any_of_1);
	cJSON* jsontime_unit_any_of_2 = time_unit_any_of_convertToJSON(time_unit_any_of_2);
