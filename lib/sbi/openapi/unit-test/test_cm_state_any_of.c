...
void test_cm_state_any_of(int include_optional) {
    cm_state_any_of_t* cm_state_any_of_1 = instantiate_cm_state_any_of(include_optional);

	cJSON* jsoncm_state_any_of_1 = cm_state_any_of_convertToJSON(cm_state_any_of_1);
	printf("cm_state_any_of :\n%s\n", cJSON_Print(jsoncm_state_any_of_1));
	cm_state_any_of_t* cm_state_any_of_2 = cm_state_any_of_parseFromJSON(jsoncm_state_any_of_1);
	cJSON* jsoncm_state_any_of_2 = cm_state_any_of_convertToJSON(cm_state_any_of_2);
