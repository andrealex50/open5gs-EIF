...
void test_failure_event_info(int include_optional) {
    failure_event_info_t* failure_event_info_1 = instantiate_failure_event_info(include_optional);

	cJSON* jsonfailure_event_info_1 = failure_event_info_convertToJSON(failure_event_info_1);
	printf("failure_event_info :\n%s\n", cJSON_Print(jsonfailure_event_info_1));
	failure_event_info_t* failure_event_info_2 = failure_event_info_parseFromJSON(jsonfailure_event_info_1);
	cJSON* jsonfailure_event_info_2 = failure_event_info_convertToJSON(failure_event_info_2);
