...
cn_assisted_ran_para_t* instantiate_cn_assisted_ran_para(int include_optional) {
  ...
  if (include_optional) {
    cn_assisted_ran_para = cn_assisted_ran_para_create(
      nsmf_pdusession_cn_assisted_ran_para__STATIONARY,
      56,
      56,
       // false, not to have infinite recursion
      instantiate_scheduled_communication_time(0),
      nsmf_pdusession_cn_assisted_ran_para__DOWNLINK_ONLY,
      nsmf_pdusession_cn_assisted_ran_para__SINGLE_TRANS_UL,
       // false, not to have infinite recursion
...
void test_cn_assisted_ran_para(int include_optional) {
    cn_assisted_ran_para_t* cn_assisted_ran_para_1 = instantiate_cn_assisted_ran_para(include_optional);

	cJSON* jsoncn_assisted_ran_para_1 = cn_assisted_ran_para_convertToJSON(cn_assisted_ran_para_1);
	printf("cn_assisted_ran_para :\n%s\n", cJSON_Print(jsoncn_assisted_ran_para_1));
	cn_assisted_ran_para_t* cn_assisted_ran_para_2 = cn_assisted_ran_para_parseFromJSON(jsoncn_assisted_ran_para_1);
	cJSON* jsoncn_assisted_ran_para_2 = cn_assisted_ran_para_convertToJSON(cn_assisted_ran_para_2);
