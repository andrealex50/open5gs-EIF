...
void test_nwdaf_failure_code(int include_optional) {
    nwdaf_failure_code_t* nwdaf_failure_code_1 = instantiate_nwdaf_failure_code(include_optional);

	cJSON* jsonnwdaf_failure_code_1 = nwdaf_failure_code_convertToJSON(nwdaf_failure_code_1);
	printf("nwdaf_failure_code :\n%s\n", cJSON_Print(jsonnwdaf_failure_code_1));
	nwdaf_failure_code_t* nwdaf_failure_code_2 = nwdaf_failure_code_parseFromJSON(jsonnwdaf_failure_code_1);
	cJSON* jsonnwdaf_failure_code_2 = nwdaf_failure_code_convertToJSON(nwdaf_failure_code_2);
