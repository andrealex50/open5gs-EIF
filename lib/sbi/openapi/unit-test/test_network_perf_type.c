...
void test_network_perf_type(int include_optional) {
    network_perf_type_t* network_perf_type_1 = instantiate_network_perf_type(include_optional);

	cJSON* jsonnetwork_perf_type_1 = network_perf_type_convertToJSON(network_perf_type_1);
	printf("network_perf_type :\n%s\n", cJSON_Print(jsonnetwork_perf_type_1));
	network_perf_type_t* network_perf_type_2 = network_perf_type_parseFromJSON(jsonnetwork_perf_type_1);
	cJSON* jsonnetwork_perf_type_2 = network_perf_type_convertToJSON(network_perf_type_2);
