...
void test_ue_in_area_filter(int include_optional) {
    ue_in_area_filter_t* ue_in_area_filter_1 = instantiate_ue_in_area_filter(include_optional);

	cJSON* jsonue_in_area_filter_1 = ue_in_area_filter_convertToJSON(ue_in_area_filter_1);
	printf("ue_in_area_filter :\n%s\n", cJSON_Print(jsonue_in_area_filter_1));
	ue_in_area_filter_t* ue_in_area_filter_2 = ue_in_area_filter_parseFromJSON(jsonue_in_area_filter_1);
	cJSON* jsonue_in_area_filter_2 = ue_in_area_filter_convertToJSON(ue_in_area_filter_2);
