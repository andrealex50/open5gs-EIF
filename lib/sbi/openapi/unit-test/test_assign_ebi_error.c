...
void test_assign_ebi_error(int include_optional) {
    assign_ebi_error_t* assign_ebi_error_1 = instantiate_assign_ebi_error(include_optional);

	cJSON* jsonassign_ebi_error_1 = assign_ebi_error_convertToJSON(assign_ebi_error_1);
	printf("assign_ebi_error :\n%s\n", cJSON_Print(jsonassign_ebi_error_1));
	assign_ebi_error_t* assign_ebi_error_2 = assign_ebi_error_parseFromJSON(jsonassign_ebi_error_1);
	cJSON* jsonassign_ebi_error_2 = assign_ebi_error_convertToJSON(assign_ebi_error_2);
