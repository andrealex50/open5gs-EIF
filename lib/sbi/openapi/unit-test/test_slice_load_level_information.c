...
slice_load_level_information_t* instantiate_slice_load_level_information(int include_optional);
...
slice_load_level_information_t* instantiate_slice_load_level_information(int include_optional) {
  ...
  if (include_optional) {
    slice_load_level_information = slice_load_level_information_create(
      56,
      list_createList()
    );
  } else {
...
void test_slice_load_level_information(int include_optional) {
    slice_load_level_information_t* slice_load_level_information_1 = instantiate_slice_load_level_information(include_optional);

	cJSON* jsonslice_load_level_information_1 = slice_load_level_information_convertToJSON(slice_load_level_information_1);
	printf("slice_load_level_information :\n%s\n", cJSON_Print(jsonslice_load_level_information_1));
	slice_load_level_information_t* slice_load_level_information_2 = slice_load_level_information_parseFromJSON(jsonslice_load_level_information_1);
	cJSON* jsonslice_load_level_information_2 = slice_load_level_information_convertToJSON(slice_load_level_information_2);
