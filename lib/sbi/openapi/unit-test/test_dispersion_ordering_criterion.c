...
dispersion_ordering_criterion_t* instantiate_dispersion_ordering_criterion(int include_optional);
...
dispersion_ordering_criterion_t* instantiate_dispersion_ordering_criterion(int include_optional) {
  ...
  if (include_optional) {
    dispersion_ordering_criterion = dispersion_ordering_criterion_create(
    );
  } else {
    dispersion_ordering_criterion = dispersion_ordering_criterion_create(
    );
...
void test_dispersion_ordering_criterion(int include_optional) {
    dispersion_ordering_criterion_t* dispersion_ordering_criterion_1 = instantiate_dispersion_ordering_criterion(include_optional);

	cJSON* jsondispersion_ordering_criterion_1 = dispersion_ordering_criterion_convertToJSON(dispersion_ordering_criterion_1);
	printf("dispersion_ordering_criterion :\n%s\n", cJSON_Print(jsondispersion_ordering_criterion_1));
	dispersion_ordering_criterion_t* dispersion_ordering_criterion_2 = dispersion_ordering_criterion_parseFromJSON(jsondispersion_ordering_criterion_1);
	cJSON* jsondispersion_ordering_criterion_2 = dispersion_ordering_criterion_convertToJSON(dispersion_ordering_criterion_2);
