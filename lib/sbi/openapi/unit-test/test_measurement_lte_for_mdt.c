...
measurement_lte_for_mdt_t* instantiate_measurement_lte_for_mdt(int include_optional);
...
void test_measurement_lte_for_mdt(int include_optional) {
    measurement_lte_for_mdt_t* measurement_lte_for_mdt_1 = instantiate_measurement_lte_for_mdt(include_optional);

	cJSON* jsonmeasurement_lte_for_mdt_1 = measurement_lte_for_mdt_convertToJSON(measurement_lte_for_mdt_1);
	printf("measurement_lte_for_mdt :\n%s\n", cJSON_Print(jsonmeasurement_lte_for_mdt_1));
	measurement_lte_for_mdt_t* measurement_lte_for_mdt_2 = measurement_lte_for_mdt_parseFromJSON(jsonmeasurement_lte_for_mdt_1);
	cJSON* jsonmeasurement_lte_for_mdt_2 = measurement_lte_for_mdt_convertToJSON(measurement_lte_for_mdt_2);
