...
void test_gera_location(int include_optional) {
    gera_location_t* gera_location_1 = instantiate_gera_location(include_optional);

	cJSON* jsongera_location_1 = gera_location_convertToJSON(gera_location_1);
	printf("gera_location :\n%s\n", cJSON_Print(jsongera_location_1));
	gera_location_t* gera_location_2 = gera_location_parseFromJSON(jsongera_location_1);
	cJSON* jsongera_location_2 = gera_location_convertToJSON(gera_location_2);
	printf("repeating gera_location:\n%s\n", cJSON_Print(jsongera_location_2));
}
