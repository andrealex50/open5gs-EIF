...
void test_release_cause(int include_optional) {
    release_cause_t* release_cause_1 = instantiate_release_cause(include_optional);

	cJSON* jsonrelease_cause_1 = release_cause_convertToJSON(release_cause_1);
	printf("release_cause :\n%s\n", cJSON_Print(jsonrelease_cause_1));
	release_cause_t* release_cause_2 = release_cause_parseFromJSON(jsonrelease_cause_1);
	cJSON* jsonrelease_cause_2 = release_cause_convertToJSON(release_cause_2);
	printf("repeating release_cause:\n%s\n", cJSON_Print(jsonrelease_cause_2));
}
