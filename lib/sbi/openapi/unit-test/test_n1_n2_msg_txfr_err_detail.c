...
n1_n2_msg_txfr_err_detail_t* instantiate_n1_n2_msg_txfr_err_detail(int include_optional);
...
void test_n1_n2_msg_txfr_err_detail(int include_optional) {
    n1_n2_msg_txfr_err_detail_t* n1_n2_msg_txfr_err_detail_1 = instantiate_n1_n2_msg_txfr_err_detail(include_optional);

	cJSON* jsonn1_n2_msg_txfr_err_detail_1 = n1_n2_msg_txfr_err_detail_convertToJSON(n1_n2_msg_txfr_err_detail_1);
	printf("n1_n2_msg_txfr_err_detail :\n%s\n", cJSON_Print(jsonn1_n2_msg_txfr_err_detail_1));
	n1_n2_msg_txfr_err_detail_t* n1_n2_msg_txfr_err_detail_2 = n1_n2_msg_txfr_err_detail_parseFromJSON(jsonn1_n2_msg_txfr_err_detail_1);
	cJSON* jsonn1_n2_msg_txfr_err_detail_2 = n1_n2_msg_txfr_err_detail_convertToJSON(n1_n2_msg_txfr_err_detail_2);
