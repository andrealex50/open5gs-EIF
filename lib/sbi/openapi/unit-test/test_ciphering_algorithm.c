...
void test_ciphering_algorithm(int include_optional) {
    ciphering_algorithm_t* ciphering_algorithm_1 = instantiate_ciphering_algorithm(include_optional);

	cJSON* jsonciphering_algorithm_1 = ciphering_algorithm_convertToJSON(ciphering_algorithm_1);
	printf("ciphering_algorithm :\n%s\n", cJSON_Print(jsonciphering_algorithm_1));
	ciphering_algorithm_t* ciphering_algorithm_2 = ciphering_algorithm_parseFromJSON(jsonciphering_algorithm_1);
	cJSON* jsonciphering_algorithm_2 = ciphering_algorithm_convertToJSON(ciphering_algorithm_2);
