...
collection_period_rmm_lte_mdt_t* instantiate_collection_period_rmm_lte_mdt(int include_optional);
...
collection_period_rmm_lte_mdt_t* instantiate_collection_period_rmm_lte_mdt(int include_optional) {
  ...
  if (include_optional) {
    collection_period_rmm_lte_mdt = collection_period_rmm_lte_mdt_create(
    );
  } else {
    collection_period_rmm_lte_mdt = collection_period_rmm_lte_mdt_create(
    );
...
void test_collection_period_rmm_lte_mdt(int include_optional) {
    collection_period_rmm_lte_mdt_t* collection_period_rmm_lte_mdt_1 = instantiate_collection_period_rmm_lte_mdt(include_optional);

	cJSON* jsoncollection_period_rmm_lte_mdt_1 = collection_period_rmm_lte_mdt_convertToJSON(collection_period_rmm_lte_mdt_1);
	printf("collection_period_rmm_lte_mdt :\n%s\n", cJSON_Print(jsoncollection_period_rmm_lte_mdt_1));
	collection_period_rmm_lte_mdt_t* collection_period_rmm_lte_mdt_2 = collection_period_rmm_lte_mdt_parseFromJSON(jsoncollection_period_rmm_lte_mdt_1);
	cJSON* jsoncollection_period_rmm_lte_mdt_2 = collection_period_rmm_lte_mdt_convertToJSON(collection_period_rmm_lte_mdt_2);
