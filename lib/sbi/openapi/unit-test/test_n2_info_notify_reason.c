...
void test_n2_info_notify_reason(int include_optional) {
    n2_info_notify_reason_t* n2_info_notify_reason_1 = instantiate_n2_info_notify_reason(include_optional);

	cJSON* jsonn2_info_notify_reason_1 = n2_info_notify_reason_convertToJSON(n2_info_notify_reason_1);
	printf("n2_info_notify_reason :\n%s\n", cJSON_Print(jsonn2_info_notify_reason_1));
	n2_info_notify_reason_t* n2_info_notify_reason_2 = n2_info_notify_reason_parseFromJSON(jsonn2_info_notify_reason_1);
	cJSON* jsonn2_info_notify_reason_2 = n2_info_notify_reason_convertToJSON(n2_info_notify_reason_2);
