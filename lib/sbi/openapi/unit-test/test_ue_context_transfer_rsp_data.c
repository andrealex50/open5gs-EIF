...
ue_context_transfer_rsp_data_t* instantiate_ue_context_transfer_rsp_data(int include_optional);
...
ue_context_transfer_rsp_data_t* instantiate_ue_context_transfer_rsp_data(int include_optional) {
  ...
  if (include_optional) {
    ue_context_transfer_rsp_data = ue_context_transfer_rsp_data_create(
...
void test_ue_context_transfer_rsp_data(int include_optional) {
    ue_context_transfer_rsp_data_t* ue_context_transfer_rsp_data_1 = instantiate_ue_context_transfer_rsp_data(include_optional);

	cJSON* jsonue_context_transfer_rsp_data_1 = ue_context_transfer_rsp_data_convertToJSON(ue_context_transfer_rsp_data_1);
	printf("ue_context_transfer_rsp_data :\n%s\n", cJSON_Print(jsonue_context_transfer_rsp_data_1));
	ue_context_transfer_rsp_data_t* ue_context_transfer_rsp_data_2 = ue_context_transfer_rsp_data_parseFromJSON(jsonue_context_transfer_rsp_data_1);
	cJSON* jsonue_context_transfer_rsp_data_2 = ue_context_transfer_rsp_data_convertToJSON(ue_context_transfer_rsp_data_2);
