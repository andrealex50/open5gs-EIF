...
service_experience_type_any_of_t* instantiate_service_experience_type_any_of(int include_optional);
...
service_experience_type_any_of_t* instantiate_service_experience_type_any_of(int include_optional) {
  ...
  if (include_optional) {
    service_experience_type_any_of = service_experience_type_any_of_create(
    );
  } else {
    service_experience_type_any_of = service_experience_type_any_of_create(
    );
...
void test_service_experience_type_any_of(int include_optional) {
    service_experience_type_any_of_t* service_experience_type_any_of_1 = instantiate_service_experience_type_any_of(include_optional);

	cJSON* jsonservice_experience_type_any_of_1 = service_experience_type_any_of_convertToJSON(service_experience_type_any_of_1);
	printf("service_experience_type_any_of :\n%s\n", cJSON_Print(jsonservice_experience_type_any_of_1));
	service_experience_type_any_of_t* service_experience_type_any_of_2 = service_experience_type_any_of_parseFromJSON(jsonservice_experience_type_any_of_1);
	cJSON* jsonservice_experience_type_any_of_2 = service_experience_type_any_of_convertToJSON(service_experience_type_any_of_2);
