...
void test_ue_context_release(int include_optional) {
    ue_context_release_t* ue_context_release_1 = instantiate_ue_context_release(include_optional);

	cJSON* jsonue_context_release_1 = ue_context_release_convertToJSON(ue_context_release_1);
	printf("ue_context_release :\n%s\n", cJSON_Print(jsonue_context_release_1));
	ue_context_release_t* ue_context_release_2 = ue_context_release_parseFromJSON(jsonue_context_release_1);
	cJSON* jsonue_context_release_2 = ue_context_release_convertToJSON(ue_context_release_2);
