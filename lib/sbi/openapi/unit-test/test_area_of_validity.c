...
void test_area_of_validity(int include_optional) {
    area_of_validity_t* area_of_validity_1 = instantiate_area_of_validity(include_optional);

	cJSON* jsonarea_of_validity_1 = area_of_validity_convertToJSON(area_of_validity_1);
	printf("area_of_validity :\n%s\n", cJSON_Print(jsonarea_of_validity_1));
	area_of_validity_t* area_of_validity_2 = area_of_validity_parseFromJSON(jsonarea_of_validity_1);
	cJSON* jsonarea_of_validity_2 = area_of_validity_convertToJSON(area_of_validity_2);
