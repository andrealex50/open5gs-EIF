...
void test_nas_security_mode(int include_optional) {
    nas_security_mode_t* nas_security_mode_1 = instantiate_nas_security_mode(include_optional);

	cJSON* jsonnas_security_mode_1 = nas_security_mode_convertToJSON(nas_security_mode_1);
	printf("nas_security_mode :\n%s\n", cJSON_Print(jsonnas_security_mode_1));
	nas_security_mode_t* nas_security_mode_2 = nas_security_mode_parseFromJSON(jsonnas_security_mode_1);
	cJSON* jsonnas_security_mode_2 = nas_security_mode_convertToJSON(nas_security_mode_2);
