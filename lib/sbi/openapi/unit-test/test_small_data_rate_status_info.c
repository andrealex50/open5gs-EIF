...
small_data_rate_status_info_t* instantiate_small_data_rate_status_info(int include_optional);
...
small_data_rate_status_info_t* instantiate_small_data_rate_status_info(int include_optional) {
  ...
  if (include_optional) {
    small_data_rate_status_info = small_data_rate_status_info_create(
...
void test_small_data_rate_status_info(int include_optional) {
    small_data_rate_status_info_t* small_data_rate_status_info_1 = instantiate_small_data_rate_status_info(include_optional);

	cJSON* jsonsmall_data_rate_status_info_1 = small_data_rate_status_info_convertToJSON(small_data_rate_status_info_1);
	printf("small_data_rate_status_info :\n%s\n", cJSON_Print(jsonsmall_data_rate_status_info_1));
	small_data_rate_status_info_t* small_data_rate_status_info_2 = small_data_rate_status_info_parseFromJSON(jsonsmall_data_rate_status_info_1);
	cJSON* jsonsmall_data_rate_status_info_2 = small_data_rate_status_info_convertToJSON(small_data_rate_status_info_2);
