...
void test_network_perf_info(int include_optional) {
    network_perf_info_t* network_perf_info_1 = instantiate_network_perf_info(include_optional);

	cJSON* jsonnetwork_perf_info_1 = network_perf_info_convertToJSON(network_perf_info_1);
	printf("network_perf_info :\n%s\n", cJSON_Print(jsonnetwork_perf_info_1));
	network_perf_info_t* network_perf_info_2 = network_perf_info_parseFromJSON(jsonnetwork_perf_info_1);
	cJSON* jsonnetwork_perf_info_2 = network_perf_info_convertToJSON(network_perf_info_2);
