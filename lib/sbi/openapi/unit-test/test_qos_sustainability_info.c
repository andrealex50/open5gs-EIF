...
qos_sustainability_info_t* instantiate_qos_sustainability_info(int include_optional);
...
void test_qos_sustainability_info(int include_optional) {
    qos_sustainability_info_t* qos_sustainability_info_1 = instantiate_qos_sustainability_info(include_optional);

	cJSON* jsonqos_sustainability_info_1 = qos_sustainability_info_convertToJSON(qos_sustainability_info_1);
	printf("qos_sustainability_info :\n%s\n", cJSON_Print(jsonqos_sustainability_info_1));
	qos_sustainability_info_t* qos_sustainability_info_2 = qos_sustainability_info_parseFromJSON(jsonqos_sustainability_info_1);
	cJSON* jsonqos_sustainability_info_2 = qos_sustainability_info_convertToJSON(qos_sustainability_info_2);
