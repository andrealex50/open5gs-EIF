...
void test_n1_message_class(int include_optional) {
    n1_message_class_t* n1_message_class_1 = instantiate_n1_message_class(include_optional);

	cJSON* jsonn1_message_class_1 = n1_message_class_convertToJSON(n1_message_class_1);
	printf("n1_message_class :\n%s\n", cJSON_Print(jsonn1_message_class_1));
	n1_message_class_t* n1_message_class_2 = n1_message_class_parseFromJSON(jsonn1_message_class_1);
	cJSON* jsonn1_message_class_2 = n1_message_class_convertToJSON(n1_message_class_2);
