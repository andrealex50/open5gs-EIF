...
void test_nsi_load_level_info(int include_optional) {
    nsi_load_level_info_t* nsi_load_level_info_1 = instantiate_nsi_load_level_info(include_optional);

	cJSON* jsonnsi_load_level_info_1 = nsi_load_level_info_convertToJSON(nsi_load_level_info_1);
	printf("nsi_load_level_info :\n%s\n", cJSON_Print(jsonnsi_load_level_info_1));
	nsi_load_level_info_t* nsi_load_level_info_2 = nsi_load_level_info_parseFromJSON(jsonnsi_load_level_info_1);
	cJSON* jsonnsi_load_level_info_2 = nsi_load_level_info_convertToJSON(nsi_load_level_info_2);
