...
amf_event_trigger_any_of_t* instantiate_amf_event_trigger_any_of(int include_optional);
...
void test_amf_event_trigger_any_of(int include_optional) {
    amf_event_trigger_any_of_t* amf_event_trigger_any_of_1 = instantiate_amf_event_trigger_any_of(include_optional);

	cJSON* jsonamf_event_trigger_any_of_1 = amf_event_trigger_any_of_convertToJSON(amf_event_trigger_any_of_1);
	printf("amf_event_trigger_any_of :\n%s\n", cJSON_Print(jsonamf_event_trigger_any_of_1));
	amf_event_trigger_any_of_t* amf_event_trigger_any_of_2 = amf_event_trigger_any_of_parseFromJSON(jsonamf_event_trigger_any_of_1);
	cJSON* jsonamf_event_trigger_any_of_2 = amf_event_trigger_any_of_convertToJSON(amf_event_trigger_any_of_2);
