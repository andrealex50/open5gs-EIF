...
void test_prev_sub_info(int include_optional) {
    prev_sub_info_t* prev_sub_info_1 = instantiate_prev_sub_info(include_optional);

	cJSON* jsonprev_sub_info_1 = prev_sub_info_convertToJSON(prev_sub_info_1);
	printf("prev_sub_info :\n%s\n", cJSON_Print(jsonprev_sub_info_1));
	prev_sub_info_t* prev_sub_info_2 = prev_sub_info_parseFromJSON(jsonprev_sub_info_1);
	cJSON* jsonprev_sub_info_2 = prev_sub_info_convertToJSON(prev_sub_info_2);
	printf("repeating prev_sub_info:\n%s\n", cJSON_Print(jsonprev_sub_info_2));
}
