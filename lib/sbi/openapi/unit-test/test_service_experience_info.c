...
service_experience_info_t* instantiate_service_experience_info(int include_optional);
...
void test_service_experience_info(int include_optional) {
    service_experience_info_t* service_experience_info_1 = instantiate_service_experience_info(include_optional);

	cJSON* jsonservice_experience_info_1 = service_experience_info_convertToJSON(service_experience_info_1);
	printf("service_experience_info :\n%s\n", cJSON_Print(jsonservice_experience_info_1));
	service_experience_info_t* service_experience_info_2 = service_experience_info_parseFromJSON(jsonservice_experience_info_1);
	cJSON* jsonservice_experience_info_2 = service_experience_info_convertToJSON(service_experience_info_2);
