...
void test_ng_ran_target_id(int include_optional) {
    ng_ran_target_id_t* ng_ran_target_id_1 = instantiate_ng_ran_target_id(include_optional);

	cJSON* jsonng_ran_target_id_1 = ng_ran_target_id_convertToJSON(ng_ran_target_id_1);
	printf("ng_ran_target_id :\n%s\n", cJSON_Print(jsonng_ran_target_id_1));
	ng_ran_target_id_t* ng_ran_target_id_2 = ng_ran_target_id_parseFromJSON(jsonng_ran_target_id_1);
	cJSON* jsonng_ran_target_id_2 = ng_ran_target_id_convertToJSON(ng_ran_target_id_2);
