...
nf_load_level_information_t* instantiate_nf_load_level_information(int include_optional);

#include "test_nnwdaf_nf_status.c"
...
nf_load_level_information_t* instantiate_nf_load_level_information(int include_optional) {
  ...
  if (include_optional) {
    nf_load_level_information = nf_load_level_information_create(
      namf_communication_nf_load_level_information__NRF,
      "0",
      "0",
       // false, not to have infinite recursion
      instantiate_nnwdaf_nf_status(0),
      56,
      56,
      56,
      56,
...
void test_nf_load_level_information(int include_optional) {
    nf_load_level_information_t* nf_load_level_information_1 = instantiate_nf_load_level_information(include_optional);

	cJSON* jsonnf_load_level_information_1 = nf_load_level_information_convertToJSON(nf_load_level_information_1);
	printf("nf_load_level_information :\n%s\n", cJSON_Print(jsonnf_load_level_information_1));
	nf_load_level_information_t* nf_load_level_information_2 = nf_load_level_information_parseFromJSON(jsonnf_load_level_information_1);
	cJSON* jsonnf_load_level_information_2 = nf_load_level_information_convertToJSON(nf_load_level_information_2);
