...
void test_pdu_session_info(int include_optional) {
    pdu_session_info_t* pdu_session_info_1 = instantiate_pdu_session_info(include_optional);

	cJSON* jsonpdu_session_info_1 = pdu_session_info_convertToJSON(pdu_session_info_1);
	printf("pdu_session_info :\n%s\n", cJSON_Print(jsonpdu_session_info_1));
	pdu_session_info_t* pdu_session_info_2 = pdu_session_info_parseFromJSON(jsonpdu_session_info_1);
	cJSON* jsonpdu_session_info_2 = pdu_session_info_convertToJSON(pdu_session_info_2);
