...
service_experience_type_t* instantiate_service_experience_type(int include_optional);
...
void test_service_experience_type(int include_optional) {
    service_experience_type_t* service_experience_type_1 = instantiate_service_experience_type(include_optional);

	cJSON* jsonservice_experience_type_1 = service_experience_type_convertToJSON(service_experience_type_1);
	printf("service_experience_type :\n%s\n", cJSON_Print(jsonservice_experience_type_1));
	service_experience_type_t* service_experience_type_2 = service_experience_type_parseFromJSON(jsonservice_experience_type_1);
	cJSON* jsonservice_experience_type_2 = service_experience_type_convertToJSON(service_experience_type_2);
