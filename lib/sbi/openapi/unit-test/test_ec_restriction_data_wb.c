...
ec_restriction_data_wb_t* instantiate_ec_restriction_data_wb(int include_optional);
...
void test_ec_restriction_data_wb(int include_optional) {
    ec_restriction_data_wb_t* ec_restriction_data_wb_1 = instantiate_ec_restriction_data_wb(include_optional);

	cJSON* jsonec_restriction_data_wb_1 = ec_restriction_data_wb_convertToJSON(ec_restriction_data_wb_1);
	printf("ec_restriction_data_wb :\n%s\n", cJSON_Print(jsonec_restriction_data_wb_1));
	ec_restriction_data_wb_t* ec_restriction_data_wb_2 = ec_restriction_data_wb_parseFromJSON(jsonec_restriction_data_wb_1);
	cJSON* jsonec_restriction_data_wb_2 = ec_restriction_data_wb_convertToJSON(ec_restriction_data_wb_2);
