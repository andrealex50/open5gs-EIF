...
void test_smf_change_indication(int include_optional) {
    smf_change_indication_t* smf_change_indication_1 = instantiate_smf_change_indication(include_optional);

	cJSON* jsonsmf_change_indication_1 = smf_change_indication_convertToJSON(smf_change_indication_1);
	printf("smf_change_indication :\n%s\n", cJSON_Print(jsonsmf_change_indication_1));
	smf_change_indication_t* smf_change_indication_2 = smf_change_indication_parseFromJSON(jsonsmf_change_indication_1);
	cJSON* jsonsmf_change_indication_2 = smf_change_indication_convertToJSON(smf_change_indication_2);
