...
exception_trend_any_of_t* instantiate_exception_trend_any_of(int include_optional);
...
void test_exception_trend_any_of(int include_optional) {
    exception_trend_any_of_t* exception_trend_any_of_1 = instantiate_exception_trend_any_of(include_optional);

	cJSON* jsonexception_trend_any_of_1 = exception_trend_any_of_convertToJSON(exception_trend_any_of_1);
	printf("exception_trend_any_of :\n%s\n", cJSON_Print(jsonexception_trend_any_of_1));
	exception_trend_any_of_t* exception_trend_any_of_2 = exception_trend_any_of_parseFromJSON(jsonexception_trend_any_of_1);
	cJSON* jsonexception_trend_any_of_2 = exception_trend_any_of_convertToJSON(exception_trend_any_of_2);
