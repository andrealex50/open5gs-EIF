...
void test_policy_req_trigger(int include_optional) {
    policy_req_trigger_t* policy_req_trigger_1 = instantiate_policy_req_trigger(include_optional);

	cJSON* jsonpolicy_req_trigger_1 = policy_req_trigger_convertToJSON(policy_req_trigger_1);
	printf("policy_req_trigger :\n%s\n", cJSON_Print(jsonpolicy_req_trigger_1));
	policy_req_trigger_t* policy_req_trigger_2 = policy_req_trigger_parseFromJSON(jsonpolicy_req_trigger_1);
	cJSON* jsonpolicy_req_trigger_2 = policy_req_trigger_convertToJSON(policy_req_trigger_2);
