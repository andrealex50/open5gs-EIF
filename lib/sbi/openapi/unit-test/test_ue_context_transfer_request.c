...
ue_context_transfer_request_t* instantiate_ue_context_transfer_request(int include_optional);
...
ue_context_transfer_request_t* instantiate_ue_context_transfer_request(int include_optional) {
  ...
  if (include_optional) {
    ue_context_transfer_request = ue_context_transfer_request_create(
...
void test_ue_context_transfer_request(int include_optional) {
    ue_context_transfer_request_t* ue_context_transfer_request_1 = instantiate_ue_context_transfer_request(include_optional);

	cJSON* jsonue_context_transfer_request_1 = ue_context_transfer_request_convertToJSON(ue_context_transfer_request_1);
	printf("ue_context_transfer_request :\n%s\n", cJSON_Print(jsonue_context_transfer_request_1));
	ue_context_transfer_request_t* ue_context_transfer_request_2 = ue_context_transfer_request_parseFromJSON(jsonue_context_transfer_request_1);
	cJSON* jsonue_context_transfer_request_2 = ue_context_transfer_request_convertToJSON(ue_context_transfer_request_2);
