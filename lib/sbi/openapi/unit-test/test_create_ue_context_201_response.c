...
create_ue_context_201_response_t* instantiate_create_ue_context_201_response(int include_optional);
...
create_ue_context_201_response_t* instantiate_create_ue_context_201_response(int include_optional) {
  ...
  if (include_optional) {
    create_ue_context_201_response = create_ue_context_201_response_create(
...
void test_create_ue_context_201_response(int include_optional) {
    create_ue_context_201_response_t* create_ue_context_201_response_1 = instantiate_create_ue_context_201_response(include_optional);

	cJSON* jsoncreate_ue_context_201_response_1 = create_ue_context_201_response_convertToJSON(create_ue_context_201_response_1);
	printf("create_ue_context_201_response :\n%s\n", cJSON_Print(jsoncreate_ue_context_201_response_1));
	create_ue_context_201_response_t* create_ue_context_201_response_2 = create_ue_context_201_response_parseFromJSON(jsoncreate_ue_context_201_response_1);
	cJSON* jsoncreate_ue_context_201_response_2 = create_ue_context_201_response_convertToJSON(create_ue_context_201_response_2);
