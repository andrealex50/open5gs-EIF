...
void test_smf_selection_data(int include_optional) {
    smf_selection_data_t* smf_selection_data_1 = instantiate_smf_selection_data(include_optional);

	cJSON* jsonsmf_selection_data_1 = smf_selection_data_convertToJSON(smf_selection_data_1);
	printf("smf_selection_data :\n%s\n", cJSON_Print(jsonsmf_selection_data_1));
	smf_selection_data_t* smf_selection_data_2 = smf_selection_data_parseFromJSON(jsonsmf_selection_data_1);
	cJSON* jsonsmf_selection_data_2 = smf_selection_data_convertToJSON(smf_selection_data_2);
