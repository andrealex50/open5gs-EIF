...
create_ue_context_request_t* instantiate_create_ue_context_request(int include_optional);
...
void test_create_ue_context_request(int include_optional) {
    create_ue_context_request_t* create_ue_context_request_1 = instantiate_create_ue_context_request(include_optional);

	cJSON* jsoncreate_ue_context_request_1 = create_ue_context_request_convertToJSON(create_ue_context_request_1);
	printf("create_ue_context_request :\n%s\n", cJSON_Print(jsoncreate_ue_context_request_1));
	create_ue_context_request_t* create_ue_context_request_2 = create_ue_context_request_parseFromJSON(jsoncreate_ue_context_request_1);
	cJSON* jsoncreate_ue_context_request_2 = create_ue_context_request_convertToJSON(create_ue_context_request_2);
