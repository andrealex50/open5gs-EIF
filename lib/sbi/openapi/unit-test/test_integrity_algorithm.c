...
void test_integrity_algorithm(int include_optional) {
    integrity_algorithm_t* integrity_algorithm_1 = instantiate_integrity_algorithm(include_optional);

	cJSON* jsonintegrity_algorithm_1 = integrity_algorithm_convertToJSON(integrity_algorithm_1);
	printf("integrity_algorithm :\n%s\n", cJSON_Print(jsonintegrity_algorithm_1));
	integrity_algorithm_t* integrity_algorithm_2 = integrity_algorithm_parseFromJSON(jsonintegrity_algorithm_1);
	cJSON* jsonintegrity_algorithm_2 = integrity_algorithm_convertToJSON(integrity_algorithm_2);
