...
small_data_rate_status_t* instantiate_small_data_rate_status(int include_optional);
...
void test_small_data_rate_status(int include_optional) {
    small_data_rate_status_t* small_data_rate_status_1 = instantiate_small_data_rate_status(include_optional);

	cJSON* jsonsmall_data_rate_status_1 = small_data_rate_status_convertToJSON(small_data_rate_status_1);
	printf("small_data_rate_status :\n%s\n", cJSON_Print(jsonsmall_data_rate_status_1));
	small_data_rate_status_t* small_data_rate_status_2 = small_data_rate_status_parseFromJSON(jsonsmall_data_rate_status_1);
	cJSON* jsonsmall_data_rate_status_2 = small_data_rate_status_convertToJSON(small_data_rate_status_2);
