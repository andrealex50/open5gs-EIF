...
void test_upf_information(int include_optional) {
    upf_information_t* upf_information_1 = instantiate_upf_information(include_optional);

	cJSON* jsonupf_information_1 = upf_information_convertToJSON(upf_information_1);
	printf("upf_information :\n%s\n", cJSON_Print(jsonupf_information_1));
	upf_information_t* upf_information_2 = upf_information_parseFromJSON(jsonupf_information_1);
	cJSON* jsonupf_information_2 = upf_information_convertToJSON(upf_information_2);
