...
void test_assign_ebi_failed(int include_optional) {
    assign_ebi_failed_t* assign_ebi_failed_1 = instantiate_assign_ebi_failed(include_optional);

	cJSON* jsonassign_ebi_failed_1 = assign_ebi_failed_convertToJSON(assign_ebi_failed_1);
	printf("assign_ebi_failed :\n%s\n", cJSON_Print(jsonassign_ebi_failed_1));
	assign_ebi_failed_t* assign_ebi_failed_2 = assign_ebi_failed_parseFromJSON(jsonassign_ebi_failed_1);
	cJSON* jsonassign_ebi_failed_2 = assign_ebi_failed_convertToJSON(assign_ebi_failed_2);
