...
wlan_ordering_criterion_any_of_t* instantiate_wlan_ordering_criterion_any_of(int include_optional);
...
wlan_ordering_criterion_any_of_t* instantiate_wlan_ordering_criterion_any_of(int include_optional) {
  ...
  if (include_optional) {
    wlan_ordering_criterion_any_of = wlan_ordering_criterion_any_of_create(
    );
  } else {
    wlan_ordering_criterion_any_of = wlan_ordering_criterion_any_of_create(
    );
...
void test_wlan_ordering_criterion_any_of(int include_optional) {
    wlan_ordering_criterion_any_of_t* wlan_ordering_criterion_any_of_1 = instantiate_wlan_ordering_criterion_any_of(include_optional);

	cJSON* jsonwlan_ordering_criterion_any_of_1 = wlan_ordering_criterion_any_of_convertToJSON(wlan_ordering_criterion_any_of_1);
	printf("wlan_ordering_criterion_any_of :\n%s\n", cJSON_Print(jsonwlan_ordering_criterion_any_of_1));
	wlan_ordering_criterion_any_of_t* wlan_ordering_criterion_any_of_2 = wlan_ordering_criterion_any_of_parseFromJSON(jsonwlan_ordering_criterion_any_of_1);
	cJSON* jsonwlan_ordering_criterion_any_of_2 = wlan_ordering_criterion_any_of_convertToJSON(wlan_ordering_criterion_any_of_2);
