...
wlan_ordering_criterion_t* instantiate_wlan_ordering_criterion(int include_optional);
...
void test_wlan_ordering_criterion(int include_optional) {
    wlan_ordering_criterion_t* wlan_ordering_criterion_1 = instantiate_wlan_ordering_criterion(include_optional);

	cJSON* jsonwlan_ordering_criterion_1 = wlan_ordering_criterion_convertToJSON(wlan_ordering_criterion_1);
	printf("wlan_ordering_criterion :\n%s\n", cJSON_Print(jsonwlan_ordering_criterion_1));
	wlan_ordering_criterion_t* wlan_ordering_criterion_2 = wlan_ordering_criterion_parseFromJSON(jsonwlan_ordering_criterion_1);
	cJSON* jsonwlan_ordering_criterion_2 = wlan_ordering_criterion_convertToJSON(wlan_ordering_criterion_2);
