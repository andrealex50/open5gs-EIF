...
eps_nas_integrity_algorithm_t* instantiate_eps_nas_integrity_algorithm(int include_optional);
...
eps_nas_integrity_algorithm_t* instantiate_eps_nas_integrity_algorithm(int include_optional) {
  ...
  if (include_optional) {
    eps_nas_integrity_algorithm = eps_nas_integrity_algorithm_create(
    );
  } else {
    eps_nas_integrity_algorithm = eps_nas_integrity_algorithm_create(
    );
...
void test_eps_nas_integrity_algorithm(int include_optional) {
    eps_nas_integrity_algorithm_t* eps_nas_integrity_algorithm_1 = instantiate_eps_nas_integrity_algorithm(include_optional);

	cJSON* jsoneps_nas_integrity_algorithm_1 = eps_nas_integrity_algorithm_convertToJSON(eps_nas_integrity_algorithm_1);
	printf("eps_nas_integrity_algorithm :\n%s\n", cJSON_Print(jsoneps_nas_integrity_algorithm_1));
	eps_nas_integrity_algorithm_t* eps_nas_integrity_algorithm_2 = eps_nas_integrity_algorithm_parseFromJSON(jsoneps_nas_integrity_algorithm_1);
	cJSON* jsoneps_nas_integrity_algorithm_2 = eps_nas_integrity_algorithm_convertToJSON(eps_nas_integrity_algorithm_2);
