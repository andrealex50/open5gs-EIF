...
event_reporting_requirement_t* instantiate_event_reporting_requirement(int include_optional);
...
event_reporting_requirement_t* instantiate_event_reporting_requirement(int include_optional) {
  ...
  if (include_optional) {
    event_reporting_requirement = event_reporting_requirement_create(
      null,
      list_createList(),
...
void test_event_reporting_requirement(int include_optional) {
    event_reporting_requirement_t* event_reporting_requirement_1 = instantiate_event_reporting_requirement(include_optional);

	cJSON* jsonevent_reporting_requirement_1 = event_reporting_requirement_convertToJSON(event_reporting_requirement_1);
	printf("event_reporting_requirement :\n%s\n", cJSON_Print(jsonevent_reporting_requirement_1));
	event_reporting_requirement_t* event_reporting_requirement_2 = event_reporting_requirement_parseFromJSON(jsonevent_reporting_requirement_1);
	cJSON* jsonevent_reporting_requirement_2 = event_reporting_requirement_convertToJSON(event_reporting_requirement_2);
