...
network_perf_type_any_of_t* instantiate_network_perf_type_any_of(int include_optional);
...
void test_network_perf_type_any_of(int include_optional) {
    network_perf_type_any_of_t* network_perf_type_any_of_1 = instantiate_network_perf_type_any_of(include_optional);

	cJSON* jsonnetwork_perf_type_any_of_1 = network_perf_type_any_of_convertToJSON(network_perf_type_any_of_1);
	printf("network_perf_type_any_of :\n%s\n", cJSON_Print(jsonnetwork_perf_type_any_of_1));
	network_perf_type_any_of_t* network_perf_type_any_of_2 = network_perf_type_any_of_parseFromJSON(jsonnetwork_perf_type_any_of_1);
	cJSON* jsonnetwork_perf_type_any_of_2 = network_perf_type_any_of_convertToJSON(network_perf_type_any_of_2);
