...
eth_flow_description_t* instantiate_eth_flow_description(int include_optional) {
  ...
  if (include_optional) {
    eth_flow_description = eth_flow_description_create(
      ...
      "0",
      "0",
      nudr_datarepository_api_openapi_file_eth_flow_description__DOWNLINK,
      "a",
      list_createList(),
      "a",
      "a"
...
void test_eth_flow_description(int include_optional) {
    eth_flow_description_t* eth_flow_description_1 = instantiate_eth_flow_description(include_optional);

	cJSON* jsoneth_flow_description_1 = eth_flow_description_convertToJSON(eth_flow_description_1);
	printf("eth_flow_description :\n%s\n", cJSON_Print(jsoneth_flow_description_1));
	eth_flow_description_t* eth_flow_description_2 = eth_flow_description_parseFromJSON(jsoneth_flow_description_1);
	cJSON* jsoneth_flow_description_2 = eth_flow_description_convertToJSON(eth_flow_description_2);
