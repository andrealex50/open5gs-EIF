...
void test_snssai_extension(int include_optional) {
    snssai_extension_t* snssai_extension_1 = instantiate_snssai_extension(include_optional);

	cJSON* jsonsnssai_extension_1 = snssai_extension_convertToJSON(snssai_extension_1);
	printf("snssai_extension :\n%s\n", cJSON_Print(jsonsnssai_extension_1));
	snssai_extension_t* snssai_extension_2 = snssai_extension_parseFromJSON(jsonsnssai_extension_1);
	cJSON* jsonsnssai_extension_2 = snssai_extension_convertToJSON(snssai_extension_2);
