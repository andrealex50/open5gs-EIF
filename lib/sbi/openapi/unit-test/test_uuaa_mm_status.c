...
void test_uuaa_mm_status(int include_optional) {
    uuaa_mm_status_t* uuaa_mm_status_1 = instantiate_uuaa_mm_status(include_optional);

	cJSON* jsonuuaa_mm_status_1 = uuaa_mm_status_convertToJSON(uuaa_mm_status_1);
	printf("uuaa_mm_status :\n%s\n", cJSON_Print(jsonuuaa_mm_status_1));
	uuaa_mm_status_t* uuaa_mm_status_2 = uuaa_mm_status_parseFromJSON(jsonuuaa_mm_status_1);
	cJSON* jsonuuaa_mm_status_2 = uuaa_mm_status_convertToJSON(uuaa_mm_status_2);
