...
reporting_information_t* instantiate_reporting_information(int include_optional) {
  ...
  if (include_optional) {
    reporting_information = reporting_information_create(
      ...
      list_createList(),
      56,
      namf_communication_reporting_information__ACTIVATE
    );
  } else {
    reporting_information = reporting_information_create(
      1,
...
void test_reporting_information(int include_optional) {
    reporting_information_t* reporting_information_1 = instantiate_reporting_information(include_optional);

	cJSON* jsonreporting_information_1 = reporting_information_convertToJSON(reporting_information_1);
	printf("reporting_information :\n%s\n", cJSON_Print(jsonreporting_information_1));
	reporting_information_t* reporting_information_2 = reporting_information_parseFromJSON(jsonreporting_information_1);
	cJSON* jsonreporting_information_2 = reporting_information_convertToJSON(reporting_information_2);
