...
ue_context_relocated_data_t* instantiate_ue_context_relocated_data(int include_optional);
...
void test_ue_context_relocated_data(int include_optional) {
    ue_context_relocated_data_t* ue_context_relocated_data_1 = instantiate_ue_context_relocated_data(include_optional);

	cJSON* jsonue_context_relocated_data_1 = ue_context_relocated_data_convertToJSON(ue_context_relocated_data_1);
	printf("ue_context_relocated_data :\n%s\n", cJSON_Print(jsonue_context_relocated_data_1));
	ue_context_relocated_data_t* ue_context_relocated_data_2 = ue_context_relocated_data_parseFromJSON(jsonue_context_relocated_data_1);
	cJSON* jsonue_context_relocated_data_2 = ue_context_relocated_data_convertToJSON(ue_context_relocated_data_2);
