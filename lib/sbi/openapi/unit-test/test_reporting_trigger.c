...
void test_reporting_trigger(int include_optional) {
    reporting_trigger_t* reporting_trigger_1 = instantiate_reporting_trigger(include_optional);

	cJSON* jsonreporting_trigger_1 = reporting_trigger_convertToJSON(reporting_trigger_1);
	printf("reporting_trigger :\n%s\n", cJSON_Print(jsonreporting_trigger_1));
	reporting_trigger_t* reporting_trigger_2 = reporting_trigger_parseFromJSON(jsonreporting_trigger_1);
	cJSON* jsonreporting_trigger_2 = reporting_trigger_convertToJSON(reporting_trigger_2);
