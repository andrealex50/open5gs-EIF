...
void test_dispersion_collection(int include_optional) {
    dispersion_collection_t* dispersion_collection_1 = instantiate_dispersion_collection(include_optional);

	cJSON* jsondispersion_collection_1 = dispersion_collection_convertToJSON(dispersion_collection_1);
	printf("dispersion_collection :\n%s\n", cJSON_Print(jsondispersion_collection_1));
	dispersion_collection_t* dispersion_collection_2 = dispersion_collection_parseFromJSON(jsondispersion_collection_1);
	cJSON* jsondispersion_collection_2 = dispersion_collection_convertToJSON(dispersion_collection_2);
