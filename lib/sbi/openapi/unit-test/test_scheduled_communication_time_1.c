...
scheduled_communication_time_1_t* instantiate_scheduled_communication_time_1(int include_optional);
...
scheduled_communication_time_1_t* instantiate_scheduled_communication_time_1(int include_optional) {
  ...
  if (include_optional) {
    scheduled_communication_time_1 = scheduled_communication_time_1_create(
      list_createList(),
      "0",
      "0"
    );
...
void test_scheduled_communication_time_1(int include_optional) {
    scheduled_communication_time_1_t* scheduled_communication_time_1_1 = instantiate_scheduled_communication_time_1(include_optional);

	cJSON* jsonscheduled_communication_time_1_1 = scheduled_communication_time_1_convertToJSON(scheduled_communication_time_1_1);
	printf("scheduled_communication_time_1 :\n%s\n", cJSON_Print(jsonscheduled_communication_time_1_1));
	scheduled_communication_time_1_t* scheduled_communication_time_1_2 = scheduled_communication_time_1_parseFromJSON(jsonscheduled_communication_time_1_1);
	cJSON* jsonscheduled_communication_time_1_2 = scheduled_communication_time_1_convertToJSON(scheduled_communication_time_1_2);
