...
matching_direction_any_of_t* instantiate_matching_direction_any_of(int include_optional);
...
void test_matching_direction_any_of(int include_optional) {
    matching_direction_any_of_t* matching_direction_any_of_1 = instantiate_matching_direction_any_of(include_optional);

	cJSON* jsonmatching_direction_any_of_1 = matching_direction_any_of_convertToJSON(matching_direction_any_of_1);
	printf("matching_direction_any_of :\n%s\n", cJSON_Print(jsonmatching_direction_any_of_1));
	matching_direction_any_of_t* matching_direction_any_of_2 = matching_direction_any_of_parseFromJSON(jsonmatching_direction_any_of_1);
	cJSON* jsonmatching_direction_any_of_2 = matching_direction_any_of_convertToJSON(matching_direction_any_of_2);
