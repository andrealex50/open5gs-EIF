...
void test_matching_direction(int include_optional) {
    matching_direction_t* matching_direction_1 = instantiate_matching_direction(include_optional);

	cJSON* jsonmatching_direction_1 = matching_direction_convertToJSON(matching_direction_1);
	printf("matching_direction :\n%s\n", cJSON_Print(jsonmatching_direction_1));
	matching_direction_t* matching_direction_2 = matching_direction_parseFromJSON(jsonmatching_direction_1);
	cJSON* jsonmatching_direction_2 = matching_direction_convertToJSON(matching_direction_2);
