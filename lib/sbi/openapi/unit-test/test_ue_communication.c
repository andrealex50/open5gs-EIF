...
void test_ue_communication(int include_optional) {
    ue_communication_t* ue_communication_1 = instantiate_ue_communication(include_optional);

	cJSON* jsonue_communication_1 = ue_communication_convertToJSON(ue_communication_1);
	printf("ue_communication :\n%s\n", cJSON_Print(jsonue_communication_1));
	ue_communication_t* ue_communication_2 = ue_communication_parseFromJSON(jsonue_communication_1);
	cJSON* jsonue_communication_2 = ue_communication_convertToJSON(ue_communication_2);
