...
void test_stationary_indication(int include_optional) {
    stationary_indication_t* stationary_indication_1 = instantiate_stationary_indication(include_optional);

	cJSON* jsonstationary_indication_1 = stationary_indication_convertToJSON(stationary_indication_1);
	printf("stationary_indication :\n%s\n", cJSON_Print(jsonstationary_indication_1));
	stationary_indication_t* stationary_indication_2 = stationary_indication_parseFromJSON(jsonstationary_indication_1);
	cJSON* jsonstationary_indication_2 = stationary_indication_convertToJSON(stationary_indication_2);
