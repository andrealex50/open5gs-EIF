...
void test_app_list_for_ue_comm(int include_optional) {
    app_list_for_ue_comm_t* app_list_for_ue_comm_1 = instantiate_app_list_for_ue_comm(include_optional);

	cJSON* jsonapp_list_for_ue_comm_1 = app_list_for_ue_comm_convertToJSON(app_list_for_ue_comm_1);
	printf("app_list_for_ue_comm :\n%s\n", cJSON_Print(jsonapp_list_for_ue_comm_1));
	app_list_for_ue_comm_t* app_list_for_ue_comm_2 = app_list_for_ue_comm_parseFromJSON(jsonapp_list_for_ue_comm_1);
	cJSON* jsonapp_list_for_ue_comm_2 = app_list_for_ue_comm_convertToJSON(app_list_for_ue_comm_2);
