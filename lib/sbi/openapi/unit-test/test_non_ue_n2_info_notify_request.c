...
non_ue_n2_info_notify_request_t* instantiate_non_ue_n2_info_notify_request(int include_optional);
...
non_ue_n2_info_notify_request_t* instantiate_non_ue_n2_info_notify_request(int include_optional) {
  ...
  if (include_optional) {
    non_ue_n2_info_notify_request = non_ue_n2_info_notify_request_create(
...
void test_non_ue_n2_info_notify_request(int include_optional) {
    non_ue_n2_info_notify_request_t* non_ue_n2_info_notify_request_1 = instantiate_non_ue_n2_info_notify_request(include_optional);

	cJSON* jsonnon_ue_n2_info_notify_request_1 = non_ue_n2_info_notify_request_convertToJSON(non_ue_n2_info_notify_request_1);
	printf("non_ue_n2_info_notify_request :\n%s\n", cJSON_Print(jsonnon_ue_n2_info_notify_request_1));
	non_ue_n2_info_notify_request_t* non_ue_n2_info_notify_request_2 = non_ue_n2_info_notify_request_parseFromJSON(jsonnon_ue_n2_info_notify_request_1);
	cJSON* jsonnon_ue_n2_info_notify_request_2 = non_ue_n2_info_notify_request_convertToJSON(non_ue_n2_info_notify_request_2);
