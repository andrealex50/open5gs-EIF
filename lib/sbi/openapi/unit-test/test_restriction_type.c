...
void test_restriction_type(int include_optional) {
    restriction_type_t* restriction_type_1 = instantiate_restriction_type(include_optional);

	cJSON* jsonrestriction_type_1 = restriction_type_convertToJSON(restriction_type_1);
	printf("restriction_type :\n%s\n", cJSON_Print(jsonrestriction_type_1));
	restriction_type_t* restriction_type_2 = restriction_type_parseFromJSON(jsonrestriction_type_1);
	cJSON* jsonrestriction_type_2 = restriction_type_convertToJSON(restriction_type_2);
