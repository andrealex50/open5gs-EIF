...
expected_analytics_type_t* instantiate_expected_analytics_type(int include_optional);
...
void test_expected_analytics_type(int include_optional) {
    expected_analytics_type_t* expected_analytics_type_1 = instantiate_expected_analytics_type(include_optional);

	cJSON* jsonexpected_analytics_type_1 = expected_analytics_type_convertToJSON(expected_analytics_type_1);
	printf("expected_analytics_type :\n%s\n", cJSON_Print(jsonexpected_analytics_type_1));
	expected_analytics_type_t* expected_analytics_type_2 = expected_analytics_type_parseFromJSON(jsonexpected_analytics_type_1);
	cJSON* jsonexpected_analytics_type_2 = expected_analytics_type_convertToJSON(expected_analytics_type_2);
