...
supported_gad_shapes_any_of_t* instantiate_supported_gad_shapes_any_of(int include_optional);
...
supported_gad_shapes_any_of_t* instantiate_supported_gad_shapes_any_of(int include_optional) {
  ...
  if (include_optional) {
    supported_gad_shapes_any_of = supported_gad_shapes_any_of_create(
    );
  } else {
    supported_gad_shapes_any_of = supported_gad_shapes_any_of_create(
    );
...
void test_supported_gad_shapes_any_of(int include_optional) {
    supported_gad_shapes_any_of_t* supported_gad_shapes_any_of_1 = instantiate_supported_gad_shapes_any_of(include_optional);

	cJSON* jsonsupported_gad_shapes_any_of_1 = supported_gad_shapes_any_of_convertToJSON(supported_gad_shapes_any_of_1);
	printf("supported_gad_shapes_any_of :\n%s\n", cJSON_Print(jsonsupported_gad_shapes_any_of_1));
	supported_gad_shapes_any_of_t* supported_gad_shapes_any_of_2 = supported_gad_shapes_any_of_parseFromJSON(jsonsupported_gad_shapes_any_of_1);
	cJSON* jsonsupported_gad_shapes_any_of_2 = supported_gad_shapes_any_of_convertToJSON(supported_gad_shapes_any_of_2);
