...
void test_eps_nas_security_mode(int include_optional) {
    eps_nas_security_mode_t* eps_nas_security_mode_1 = instantiate_eps_nas_security_mode(include_optional);

	cJSON* jsoneps_nas_security_mode_1 = eps_nas_security_mode_convertToJSON(eps_nas_security_mode_1);
	printf("eps_nas_security_mode :\n%s\n", cJSON_Print(jsoneps_nas_security_mode_1));
	eps_nas_security_mode_t* eps_nas_security_mode_2 = eps_nas_security_mode_parseFromJSON(jsoneps_nas_security_mode_1);
	cJSON* jsoneps_nas_security_mode_2 = eps_nas_security_mode_convertToJSON(eps_nas_security_mode_2);
