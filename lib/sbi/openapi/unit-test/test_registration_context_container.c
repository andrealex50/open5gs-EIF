...
registration_context_container_t* instantiate_registration_context_container(int include_optional);
...
registration_context_container_t* instantiate_registration_context_container(int include_optional) {
  ...
  if (include_optional) {
    registration_context_container = registration_context_container_create(
...
void test_registration_context_container(int include_optional) {
    registration_context_container_t* registration_context_container_1 = instantiate_registration_context_container(include_optional);

	cJSON* jsonregistration_context_container_1 = registration_context_container_convertToJSON(registration_context_container_1);
	printf("registration_context_container :\n%s\n", cJSON_Print(jsonregistration_context_container_1));
	registration_context_container_t* registration_context_container_2 = registration_context_container_parseFromJSON(jsonregistration_context_container_1);
	cJSON* jsonregistration_context_container_2 = registration_context_container_convertToJSON(registration_context_container_2);
