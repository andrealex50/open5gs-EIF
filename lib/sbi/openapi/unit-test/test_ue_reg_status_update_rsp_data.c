...
ue_reg_status_update_rsp_data_t* instantiate_ue_reg_status_update_rsp_data(int include_optional);
...
ue_reg_status_update_rsp_data_t* instantiate_ue_reg_status_update_rsp_data(int include_optional) {
  ...
  if (include_optional) {
    ue_reg_status_update_rsp_data = ue_reg_status_update_rsp_data_create(
      1
    );
  } else {
    ue_reg_status_update_rsp_data = ue_reg_status_update_rsp_data_create(
...
void test_ue_reg_status_update_rsp_data(int include_optional) {
    ue_reg_status_update_rsp_data_t* ue_reg_status_update_rsp_data_1 = instantiate_ue_reg_status_update_rsp_data(include_optional);

	cJSON* jsonue_reg_status_update_rsp_data_1 = ue_reg_status_update_rsp_data_convertToJSON(ue_reg_status_update_rsp_data_1);
	printf("ue_reg_status_update_rsp_data :\n%s\n", cJSON_Print(jsonue_reg_status_update_rsp_data_1));
	ue_reg_status_update_rsp_data_t* ue_reg_status_update_rsp_data_2 = ue_reg_status_update_rsp_data_parseFromJSON(jsonue_reg_status_update_rsp_data_1);
	cJSON* jsonue_reg_status_update_rsp_data_2 = ue_reg_status_update_rsp_data_convertToJSON(ue_reg_status_update_rsp_data_2);
