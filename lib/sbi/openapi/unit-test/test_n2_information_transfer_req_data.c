...
n2_information_transfer_req_data_t* instantiate_n2_information_transfer_req_data(int include_optional);

#include "test_n2_info_container.c"


n2_information_transfer_req_data_t* instantiate_n2_information_transfer_req_data(int include_optional) {
  n2_information_transfer_req_data_t* n2_information_transfer_req_data = NULL;
  if (include_optional) {
    n2_information_transfer_req_data = n2_information_transfer_req_data_create(
      list_createList(),
...
void test_n2_information_transfer_req_data(int include_optional) {
    n2_information_transfer_req_data_t* n2_information_transfer_req_data_1 = instantiate_n2_information_transfer_req_data(include_optional);

	cJSON* jsonn2_information_transfer_req_data_1 = n2_information_transfer_req_data_convertToJSON(n2_information_transfer_req_data_1);
	printf("n2_information_transfer_req_data :\n%s\n", cJSON_Print(jsonn2_information_transfer_req_data_1));
	n2_information_transfer_req_data_t* n2_information_transfer_req_data_2 = n2_information_transfer_req_data_parseFromJSON(jsonn2_information_transfer_req_data_1);
	cJSON* jsonn2_information_transfer_req_data_2 = n2_information_transfer_req_data_convertToJSON(n2_information_transfer_req_data_2);
