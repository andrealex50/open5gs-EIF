...
amf_event_subscription_t* instantiate_amf_event_subscription(int include_optional);
...
amf_event_subscription_t* instantiate_amf_event_subscription(int include_optional) {
  ...
  if (include_optional) {
    amf_event_subscription = amf_event_subscription_create(
      ...
      namf_communication_amf_event_subscription__NRF
    );
  } else {
    amf_event_subscription = amf_event_subscription_create(
      list_createList(),
...
void test_amf_event_subscription(int include_optional) {
    amf_event_subscription_t* amf_event_subscription_1 = instantiate_amf_event_subscription(include_optional);

	cJSON* jsonamf_event_subscription_1 = amf_event_subscription_convertToJSON(amf_event_subscription_1);
	printf("amf_event_subscription :\n%s\n", cJSON_Print(jsonamf_event_subscription_1));
	amf_event_subscription_t* amf_event_subscription_2 = amf_event_subscription_parseFromJSON(jsonamf_event_subscription_1);
	cJSON* jsonamf_event_subscription_2 = amf_event_subscription_convertToJSON(amf_event_subscription_2);
