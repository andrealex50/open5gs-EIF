...
void test_number_average(int include_optional) {
    number_average_t* number_average_1 = instantiate_number_average(include_optional);

	cJSON* jsonnumber_average_1 = number_average_convertToJSON(number_average_1);
	printf("number_average :\n%s\n", cJSON_Print(jsonnumber_average_1));
	number_average_t* number_average_2 = number_average_parseFromJSON(jsonnumber_average_1);
	cJSON* jsonnumber_average_2 = number_average_convertToJSON(number_average_2);
