...
ue_context_transfer_status_t* instantiate_ue_context_transfer_status(int include_optional);
...
void test_ue_context_transfer_status(int include_optional) {
    ue_context_transfer_status_t* ue_context_transfer_status_1 = instantiate_ue_context_transfer_status(include_optional);

	cJSON* jsonue_context_transfer_status_1 = ue_context_transfer_status_convertToJSON(ue_context_transfer_status_1);
	printf("ue_context_transfer_status :\n%s\n", cJSON_Print(jsonue_context_transfer_status_1));
	ue_context_transfer_status_t* ue_context_transfer_status_2 = ue_context_transfer_status_parseFromJSON(jsonue_context_transfer_status_1);
	cJSON* jsonue_context_transfer_status_2 = ue_context_transfer_status_convertToJSON(ue_context_transfer_status_2);
