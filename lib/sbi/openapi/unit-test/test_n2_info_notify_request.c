...
n2_info_notify_request_t* instantiate_n2_info_notify_request(int include_optional);
...
void test_n2_info_notify_request(int include_optional) {
    n2_info_notify_request_t* n2_info_notify_request_1 = instantiate_n2_info_notify_request(include_optional);

	cJSON* jsonn2_info_notify_request_1 = n2_info_notify_request_convertToJSON(n2_info_notify_request_1);
	printf("n2_info_notify_request :\n%s\n", cJSON_Print(jsonn2_info_notify_request_1));
	n2_info_notify_request_t* n2_info_notify_request_2 = n2_info_notify_request_parseFromJSON(jsonn2_info_notify_request_1);
	cJSON* jsonn2_info_notify_request_2 = n2_info_notify_request_convertToJSON(n2_info_notify_request_2);
