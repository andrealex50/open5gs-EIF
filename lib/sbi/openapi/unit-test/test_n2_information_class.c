...
void test_n2_information_class(int include_optional) {
    n2_information_class_t* n2_information_class_1 = instantiate_n2_information_class(include_optional);

	cJSON* jsonn2_information_class_1 = n2_information_class_convertToJSON(n2_information_class_1);
	printf("n2_information_class :\n%s\n", cJSON_Print(jsonn2_information_class_1));
	n2_information_class_t* n2_information_class_2 = n2_information_class_parseFromJSON(jsonn2_information_class_1);
	cJSON* jsonn2_information_class_2 = n2_information_class_convertToJSON(n2_information_class_2);
