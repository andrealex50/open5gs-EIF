...
measurement_period_lte_mdt_t* instantiate_measurement_period_lte_mdt(int include_optional);
...
void test_measurement_period_lte_mdt(int include_optional) {
    measurement_period_lte_mdt_t* measurement_period_lte_mdt_1 = instantiate_measurement_period_lte_mdt(include_optional);

	cJSON* jsonmeasurement_period_lte_mdt_1 = measurement_period_lte_mdt_convertToJSON(measurement_period_lte_mdt_1);
	printf("measurement_period_lte_mdt :\n%s\n", cJSON_Print(jsonmeasurement_period_lte_mdt_1));
	measurement_period_lte_mdt_t* measurement_period_lte_mdt_2 = measurement_period_lte_mdt_parseFromJSON(jsonmeasurement_period_lte_mdt_1);
	cJSON* jsonmeasurement_period_lte_mdt_2 = measurement_period_lte_mdt_convertToJSON(measurement_period_lte_mdt_2);
